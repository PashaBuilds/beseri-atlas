...
Üretilen: **232** | Onaylanan: **232** | Karantinada: **0**

Planlanan tam kapsam **288** makaledir; bu raporun yazıldığı anda
**%80.6**'i yayına girmiştir. Kalan iş `plan/kuyruk.yaml` içinde durumuyla
...
Geçiş 2 (kaynak denetimi): 1550 OK · 4 ISARET · 0 HATA · 1224 programatik olarak ölçülemedi
Kaynak doğrulama oranı: **0.9987**
Makale başına ortalama kaynak: **3.12**
Çürütücünün ürettiği itiraz adayı: **370**
...
Kuyrukta bekleyen iş: **19** · Karantinada: **0**
