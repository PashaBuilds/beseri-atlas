...
Üretilen: **243** | Onaylanan: **243** | Karantinada: **0**

Planlanan tam kapsam **288** makaledir; bu raporun yazıldığı anda
**%84.4**'i yayına girmiştir. Kalan iş `plan/kuyruk.yaml` içinde durumuyla
...
Geçiş 2 (kaynak denetimi): 1568 OK · 4 ISARET · 0 HATA · 1302 programatik olarak ölçülemedi
...
Kuyrukta bekleyen iş: **8** · Karantinada: **0**
