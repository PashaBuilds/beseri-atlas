...
Üretilen: **305** | Onaylanan: **305** | Karantinada: **0**

Planlanan tam kapsam **358** makaledir; bu raporun yazıldığı anda
**%85.2**'i yayına girmiştir. Kalan iş `plan/kuyruk.yaml` içinde durumuyla
...
Geçiş 2 (kaynak denetimi): 1752 OK · 4 ISARET · 0 HATA · 1703 programatik olarak ölçülemedi
Kaynak doğrulama oranı: **0.9989**
Makale başına ortalama kaynak: **3.09**
Çürütücünün ürettiği itiraz adayı: **428**
...
Kuyrukta bekleyen iş: **48** · Karantinada: **0**
