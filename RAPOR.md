...
Üretilen: **59** | Onaylanan: **59** | Karantinada: **0**

Planlanan tam kapsam **227** makaledir; bu raporun yazıldığı anda
**%26.0**'i yayına girmiştir. Kalan iş `plan/kuyruk.yaml` içinde durumuyla
...
Geçiş 2 (kaynak denetimi): 593 OK · 5 ISARET · 0 HATA · 308 programatik olarak ölçülemedi
Kaynak doğrulama oranı: **0.9958**
Makale başına ortalama kaynak: **3.24**
Çürütücünün ürettiği itiraz adayı: **145**
...
Kuyrukta bekleyen iş: **57** · Karantinada: **0**
