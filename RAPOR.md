...
Üretilen: **143** | Onaylanan: **143** | Karantinada: **0**

Planlanan tam kapsam **287** makaledir; bu raporun yazıldığı anda
**%49.8**'i yayına girmiştir. Kalan iş `plan/kuyruk.yaml` içinde durumuyla
...
Geçiş 2 (kaynak denetimi): 1198 OK · 4 ISARET · 0 HATA · 570 programatik olarak ölçülemedi
Kaynak doğrulama oranı: **0.9983**
Makale başına ortalama kaynak: **3.19**
Çürütücünün ürettiği itiraz adayı: **253**
...
Kuyrukta bekleyen iş: **34** · Karantinada: **0**
