...
Üretilen: **260** | Onaylanan: **260** | Karantinada: **0**

Planlanan tam kapsam **312** makaledir; bu raporun yazıldığı anda
**%83.3**'i yayına girmiştir. Kalan iş `plan/kuyruk.yaml` içinde durumuyla
...
Geçiş 2 (kaynak denetimi): 1628 OK · 4 ISARET · 0 HATA · 1389 programatik olarak ölçülemedi
Kaynak doğrulama oranı: **0.9988**
Makale başına ortalama kaynak: **3.11**
Çürütücünün ürettiği itiraz adayı: **388**
...
Kuyrukta bekleyen iş: **15** · Karantinada: **0**
