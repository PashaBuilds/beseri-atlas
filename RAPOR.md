...
Üretilen: **342** | Onaylanan: **342** | Karantinada: **0**

Planlanan tam kapsam **358** makaledir; bu raporun yazıldığı anda
**%95.5**'i yayına girmiştir. Kalan iş `plan/kuyruk.yaml` içinde durumuyla
...
Geçiş 2 (kaynak denetimi): 1851 OK · 4 ISARET · 0 HATA · 1930 programatik olarak ölçülemedi
Kaynak doğrulama oranı: **0.9989**
Makale başına ortalama kaynak: **3.08**
Çürütücünün ürettiği itiraz adayı: **456**
...
Kuyrukta bekleyen iş: **14** · Karantinada: **0**
