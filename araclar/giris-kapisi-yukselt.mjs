...
const YUKSELTMELER = new Map([
  ...
  ['https://en.wikipedia.org/wiki/M%C4%81ori_people', akademik('Bunbury, Petchey ve Bickler — A new chronology for the Māori settlement of Aotearoa (NZ), JCU ResearchOnline', 'https://researchonline.jcu.edu.au/76732/', 'A new chronology for the Māori settlement of Aotearoa (NZ)', 'Hakemli makalenin kurumsal arşiv kaydı ve özeti; deniz ve kara radyokarbon yaşlarıyla yerleşimi 13. yüzyıl ortası-sonuna tarihler, seyir yöntemini açıklamaz.')],
