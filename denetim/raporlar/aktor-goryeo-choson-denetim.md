## aktor-goryeo-choson
_Geçiş 2 — kaynak denetimi · 2026-08-29T04:48:05.374Z_
...
- [ATOMSUZ] k1 → "Bir devletin bağımsızlığının iki ayrı aralık halinde kaydedilmesi, atlasın "bağımsız / bağımlı" ikiliğine nede…" — denetlenebilir atom yok (yorum/bağlantı cümlesi)
...
- [ATOMSUZ] k1 → "Savaşlar, Moğol istilaları, kültür ve teknoloji burada ayrı başlıklar altında ele alınmamıştır; kaynaklar bunl…" — programatik olarak ölçülemedi (ad karşılığı yok): Moğol
- [ATOMSUZ] k2 → "Savaşlar, Moğol istilaları, kültür ve teknoloji burada ayrı başlıklar altında ele alınmamıştır; kaynaklar bunl…" — programatik olarak ölçülemedi (ad karşılığı yok): Moğol
