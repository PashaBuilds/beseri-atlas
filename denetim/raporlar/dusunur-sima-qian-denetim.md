## dusunur-sima-qian
_Geçiş 2 — kaynak denetimi · 2026-08-28T18:13:45.019Z_
...
- [ATOMSUZ] k1 → "Bir eserin fikrinin bir kuşağa, yazımının bir başkasına atfedilmesi, atlasın yazar alanını neden tek bir ad ol…" — denetlenebilir atom yok (yorum/bağlantı cümlesi)
- [OK]      k1 → "Kaynak, tamamlanmış eserin sonsözünde altı felsefi okul üzerine kısa bir denemenin açıkça Sima Tan'a atfedildi…"
- [ATOMSUZ] k1 → "Bir metnin içindeki tek bir bölümün başka bir yazara açıkça atfedilmiş olması, bu atlasın dipnot birimini nede…" — denetlenebilir atom yok (yorum/bağlantı cümlesi)
- [ATOMSUZ] k1 → "Kaynak eserin MÖ 91'den önce, muhtemelen MÖ 94 dolaylarında tamamlandığını yazar." — denetlenebilir atom yok (yorum/bağlantı cümlesi)
- [ATOMSUZ] k1 → "Bir üst sınır ile bir tahmin yılının birlikte verilmesi, tarihlemenin kesinlik derecesini de kaydeden bir biçi…" — denetlenebilir atom yok (yorum/bağlantı cümlesi)
