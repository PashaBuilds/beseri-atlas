...
- [OK]      k9 → "Weber 21 Nisan 1864'te Prusya'nın Erfurt kentinde doğdu; Berlin, Göttingen ve Heidelberg'de hukuk ve tarih oku…" — 5 atom doğrulandı; 2 ad ölçülemedi
...
- [ATOMSUZ] k4 → "Püriten yazında zenginlik kendi başına büyük bir tehlikedir; ayartıları bitmez ve peşine düşülmesi ahlaken kuş…" — denetlenebilir atom yok (yorum/bağlantı cümlesi)
- [OK]      k4 → "Weber, Baxter'ın dünyevi mallara duyulan kaygıyı her an omuzdan atılabilecek hafif bir pelerine benzetmesini a…" — 1 atom doğrulandı; 2 ad ölçülemedi
- [OK]      k4 → "Aynı sayfalarda, akılcılaşmanın son durağı için uzmanlıkta ruhsuz, hazda kalpsiz bir insan tipini tarif eden a…"
- [OK]      k6 → "Almanca metinde geçen ifade stahlhartes Gehäuse'dir; Peter Baehr, Parsons'ın kanonik çevirisinin statüsünü, im…"
- [ATOMSUZ] k6 → "Fark maddidir: kafes insanı kapatır ama güçlerini olduğu gibi bırakır; kabuk ise bürokratik kapitalizmin insan…" — denetlenebilir atom yok (yorum/bağlantı cümlesi)
...
- [OK]      k4 → "Kitabın son paragrafı tam bunu reddeder: Weber'in amacı tek yanlı bir maddeci yorumun yerine aynı ölçüde tek y…"
- [OK]      k6 → "İkincisi, demir kafesi Weber'in imgesi sanmaktır; imge çeviriden gelir ve kendi tarihini yaşamıştır."
- [OK]      k1 → "Üçüncüsü, ideal tipi bir betimleme sanmaktır: tip gerçekliğin yerine geçmez, gerçekliğin ondan sapmasını ölçer…"
- [ATOMSUZ] k5 → "Dördüncüsü, değerden bağımsızlığı değersizlik sanmaktır; oysa ilke, araştırmacının değerlerinin sorusunu seçti…" — denetlenebilir atom yok (yorum/bağlantı cümlesi)
- [OK]      k5 → "Suçlamalar ciddiye alınmalıdır; ama kaynak bunları metnin kanıtlanmış içeriği olarak değil, bugün de sürdürüle…"
- [ATOMSUZ] k1 → "Metnin kendisinde ise kavramlar hüküm değil ölçüdür: aynı olgu bir yanıyla feodal, bir yanıyla karizmatik sayı…" — denetlenebilir atom yok (yorum/bağlantı cümlesi)
- [ATOMSUZ] k1 → "Yöntem tartışmasında, toplumbilimi yorumlayıcı anlama ile nedensel açıklamayı aynı anda üstlenen bir bilim diy…" — denetlenebilir atom yok (yorum/bağlantı cümlesi)
