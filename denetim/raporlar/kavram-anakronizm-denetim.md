...
- [OK]      k1 → "Tarih disiplini Yunanlardan bu yana konu seçiminde, çerçeve varsayımlarında ve yönteminde Avrupa merkezli olma…" — 3 atom doğrulandı; 1 ad ölçülemedi
- [OK]      k3 → "Marx 1852'de şunu gözlemler: devrimci bunalım dönemlerinde insanlar, daha önce var olmayan bir şey yarattıklar…"
- [OK]      k3 → "Örnekleri sıralar: Luther Havari Pavlus'un maskesini takar, 1789-1814 Devrimi kendini kâh Roma Cumhuriyeti kâh…" — 6 atom doğrulandı; 3 ad ölçülemedi
- [ATOMSUZ] k6 → "sayfalarını kaplar ve terimi "bir kurgunun tiranlığı" diye adlandırır." — denetlenebilir atom yok (yorum/bağlantı cümlesi)
- [OK]      k4 → "dosyasında ise geriye dönüklüğü kavramın kurucusu işaretler: Marx süreci "sözde ilkel birikim" diye adlandırır…"
- [OK]      k2 → "Valla'nın belgeyi tarihten düşüren hamlesi ile Marx'ın kendi terimine sözde ön ekini takması aynı yükümlülüğün…"
- [OK]      k4 → "Valla'nın belgeyi tarihten düşüren hamlesi ile Marx'ın kendi terimine sözde ön ekini takması aynı yükümlülüğün…"

**Özet:** 15 OK · 0 ISARET · 0 HATA · 3 ATOMSUZ
