## kavram-merkantilizm
_Geçiş 2 — kaynak denetimi · 2026-08-28T18:13:46.224Z_
...
- [ATOMSUZ] k1 → "Aynı politikanın ülke ülke ayrı ayrı işlenmesi, tek bir merkantilizm tanımının bütün örnekleri kapsamayabilece…" — denetlenebilir atom yok (yorum/bağlantı cümlesi)
- [ATOMSUZ] k1 → "Kaynak, miras başlığı altında neo-merkantilizmi ayrı bir alt başlık olarak tutar ve altında güncel bir örneği …" — denetlenebilir atom yok (yorum/bağlantı cümlesi)
- [ATOMSUZ] k1 → "Bir kavramın hem sonunun hem devamının aynı maddede kaydedilmesi, atlasın kavram dosyalarında neden bitiş tari…" — denetlenebilir atom yok (yorum/bağlantı cümlesi)
