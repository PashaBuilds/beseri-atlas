...
_Geçiş 2 — kaynak denetimi · 2026-08-28T18:13:46.435Z_
...
- [ATOMSUZ] k2 → "Bir şehirler birliğinin ayrı bir kategori olarak kaydedilmesi, şehrin siyasi birim olmasının tek bir biçime ba…" — denetlenebilir atom yok (yorum/bağlantı cümlesi)
- [OK]      k3 → "- 347 arasına yerleştirir ve siyaset konusunda fikrini değiştirip değiştirmediğini ayrı bir bölüm başlığı yapa…"
- [ATOMSUZ] k1 → "İtalyan şehir devletleri, çağdaş örnekler ve kavramın hukuki tanımı burada ayrı başlıklar altında ele alınmamı…" — denetlenebilir atom yok (yorum/bağlantı cümlesi)
- [OK]      k4 → "Bu kavramın formüle edildiği eser Aristoteles, Politika'dir; dosya o eserin kamu malı tam metnine bağlanır."
