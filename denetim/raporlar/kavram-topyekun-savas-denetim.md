...
_Geçiş 2 — kaynak denetimi · 2026-08-29T09:10:38.356Z_
...
- [ATOMSUZ] k1 → "Kavramın üç ayrı uygulama alanıyla tanımlanması, onun tek bir askerî ölçüt değil bir toplumsal seferberlik dem…" — denetlenebilir atom yok (yorum/bağlantı cümlesi)
- [OK]      k1 → "Tarih bölümünün Orta Çağ ile başlaması, atlasın şu kuralının dayanağıdır: bu kavram bir dönem sınırı olarak ku…" — 1 atom doğrulandı; 1 ad ölçülemedi
- [ATOMSUZ] k2 → "Savaş kuramı yazarı için tutulan kayıt, onun savaş yapmanın moral ve siyasi yönlerini vurguladığını yazar." — denetlenebilir atom yok (yorum/bağlantı cümlesi)
- [ATOMSUZ] k3 → "O yazar dosyasında, savaş ilkeleri üzerine önceki yazar ise dosyasında ele alınıyor." — denetlenebilir atom yok (yorum/bağlantı cümlesi)
