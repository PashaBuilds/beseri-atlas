...
_Geçiş 2 — kaynak denetimi · 2026-08-28T18:13:49.444Z_
...
- [ATOMSUZ] k1 → "Bir kavramın bir ilim adı olarak kaydedilmesi, atlasın kavram katmanında o kavrama ayrı bir dosya açmasının da…" — denetlenebilir atom yok (yorum/bağlantı cümlesi)
- [OK]      k1 → "Kaynak, maddenin dört bölümden oluştuğunu ve bölümlerin ayrı müellifler tarafından yazıldığını kaydeder; Ekono…"
- [ATOMSUZ] k1 → "Tek bir maddenin dört imza taşıması, atlasın kaynak alanında neden müellif notu tuttuğunun dayanağıdır." — denetlenebilir atom yok (yorum/bağlantı cümlesi)
- [ATOMSUZ] k2 → "Bağımsız bir akademik kaynak, ortaçağ siyaset felsefesi maddesinde müellife ayrı bir bölüm ayırır." — denetlenebilir atom yok (yorum/bağlantı cümlesi)
