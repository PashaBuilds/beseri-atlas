...
_Geçiş 2 — kaynak denetimi · 2026-08-29T09:10:26.613Z_
...
- [ATOMSUZ] k1 → "İki programın aynı kayıtta ayrı ayrı izlenmesi, "reform" sözcüğünün tek bir yön göstermediğini gösterir: aynı …" — denetlenebilir atom yok (yorum/bağlantı cümlesi)
...
- [ATOMSUZ] k1 → "Bir iktisadi dönüşümün başlangıcının bir parti toplantısıyla tarihlenmesi, kararın hangi kurumda alındığını da…" — denetlenebilir atom yok (yorum/bağlantı cümlesi)
- [ATOMSUZ] k1 → "Kaynak programı "reform ve dışa açılım" adıyla kaydeder; ayrıca Çin iktisadi reformu ya da Çin iktisadi mucize…" — programatik olarak ölçülemedi (ad karşılığı yok): Çin
