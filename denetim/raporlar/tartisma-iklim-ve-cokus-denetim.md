...
_Geçiş 2 — kaynak denetimi · 2026-08-29T04:21:09.366Z_
...
- [OK]      k8 → "Ellsworth Huntington 1915'te yayımladığı Civilization and Climate'ta uygarlığın ancak belirli bir iklim kuşağı…"
- [OK]      k8 → "Kitap, Yucatan ve Guatemala'daki Maya kalıntılarını ve Kaliforniya'daki dev ağaçların büyüme ölçümlerini iklim…" — 3 atom doğrulandı; 1 ad ölçülemedi
- [OK]      k8 → "Huntington, Kropotkin'in Orta Asya'nın kuruması üzerine gözlemlerini de aynı çerçeveye bağlamıştı: bozkırın ya…" — 3 atom doğrulandı; 1 ad ölçülemedi
...
- [OK]      k1 → "Yine de dikkatle okunduğunda kaynakların dili çekingendir: aynı ansiklopedik özet, olayın Akkad'ın çöküşüyle ç…"
- [OK]      k7 → "Maya örneği bunun öğretici olanıdır, çünkü kuraklık kayıtları geldiğinde tartışma çoktan kurulmuştu: Yoffee il…" — 4 atom doğrulandı; 1 ad ölçülemedi
- [OK]      k5 → "Jared Diamond'ın 2005 tarihli Collapse kitabı, Klasik Maya bölümünü savaşlar ve kuraklıklar ekseninde kurar; k…" — 4 atom doğrulandı; 1 ad ölçülemedi
- [OK]      k3 → "Geoffrey Parker'ın 2013'te yayımlanan Global Crisis'i ise savı en geniş ölçeğe taşıdı: kitap, on yedinci yüzyı…"
- [OK]      k1 → "Bu okumanın ansiklopedik özeti de nettir: Otuz Yıl Savaşı'nın 1618 ile 1648 arasında Avrupa'yı kırıp geçirdiği…" — 3 atom doğrulandı; 3 ad ölçülemedi
- [ATOMSUZ] k1 → "Orta Çağ Sıcak Dönemi'nin sona erişi de aynı çerçevede kullanılır: on üçüncü ve on dördüncü yüzyıl soğuması Mo…" — programatik olarak ölçülemedi (ad karşılığı yok): Çağ, Sıcak, Dönemi, Moğol
...
- [OK]      k6 → "Joseph Tainter 1988'de yayımlanan The Collapse of Complex Societies'te çöküşü siyasi bir süreç olarak tanımlad…"
- [OK]      k7 → "Aynı yıl Norman Yoffee ile George Cowgill'in derlediği The Collapse of Ancient States and Civilizations, Mezop…"
- [ATOMSUZ] k1 → "Eisenstadt'ın sonraki tartışmalarda sık anılan savı daha da ileri gider: çöküş, siyasi sistemlerin eksiksiz so…" — denetlenebilir atom yok (yorum/bağlantı cümlesi)
- [OK]      k1 → "Karl Butzer'in 2012'de Amerikan Ulusal Bilimler Akademisi bülteninde çıkan Collapse, environment, and society …" — 3 atom doğrulandı; 2 ad ölçülemedi
- [ATOMSUZ] k1 → "Aynı bakış Tunç Çağı çöküşü tartışmasına da sızmıştır: Deniz Kavimleri'nin, Doğu Akdeniz'i vuran çevresel deği…" — programatik olarak ölçülemedi (ad karşılığı yok): Tunç, Çağı, Deniz, Kavimleri
- [OK]      k4 → "Patricia McAnany ile Norman Yoffee'nin 2010'da yayımlanan derlemesi Questioning Collapse ise bu çizginin vaka …"
- [OK]      k1 → "Bu itiraz ansiklopedik düzeye de geçmiştir: Diamond'ın popüler Collapse'ine cevaben, çöküş diye anlatılan vaka…"
- [OK]      k1 → "Diamond'ın anlatısında ada toplumu ormanını tüketti ve yaklaşık 1600'e gelindiğinde savaş, yamyamlık ve nüfus …"
- [OK]      k5 → "Diamond'ın anlatısında ada toplumu ormanını tüketti ve yaklaşık 1600'e gelindiğinde savaş, yamyamlık ve nüfus …"
- [OK]      k4 → "Karşı okuma aynı adadan yazıldı: Terry Hunt ile Carl Lipo'nun Questioning Collapse'teki bölümü, ekokırım söyle…"
