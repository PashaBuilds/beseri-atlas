...
- [OK]      k1 → "Kitabın bölüm planı da bu programı izler: The Neolithic Revolution başlıklı bölümü, ikinci devrimin hazırlığın…"
- [ATOMSUZ] k1 → "Avcılık ve toplayıcılıkta kaynak kendiliğinden sınırlıdır; ona göre ekim bu sınırı kaldırır, çünkü yiyeceği ar…" — denetlenebilir atom yok (yorum/bağlantı cümlesi)
...
- [ATOMSUZ] k6 → "Aynı tanıtıma göre erken devletlerin tamamı tahıla ve özgür olmayan emeğe dayanır; bitki, hayvan ve tahılın bi…" — denetlenebilir atom yok (yorum/bağlantı cümlesi)
- [OK]      k6 → "Kitabın bölüm listesi de aynı yönü gösterir: New Haven'daki Yale University Press baskısında Zoonoses: a perfe…"
- [OK]      k7 → "Jared Diamond'ın 1991 tarihli The Rise and Fall of the Third Chimpanzee kitabında tarıma ayrılan bölümün adı, …"
- [OK]      k8 → "Katalog kaydındaki bölüm listesine göre tarım devrimine ayrılan kısım History's biggest fraud adını taşır; ayn…"
- [OK]      k12 → "Uzun dönemli seride dünya nüfusu MÖ 10000'de yaklaşık 4,5 milyon, MÖ 3000'de yaklaşık 44,6 milyondur."
- [OK]      k1 → "Yedi bin yılda yaklaşık on katlık bir artış; Childe'ın beyan ettiği ölçüte göre bu seri onun konumunu doğrular…"
...
- [OK]      k5 → "Childe'ın ölçüt beyanı 1936'ya, iskelet kanıtının toplu dökümü 1984'e, yöntemsel itiraz 1992'ye, karamsar okum…"
- [OK]      k7 → "Childe'ın ölçüt beyanı 1936'ya, iskelet kanıtının toplu dökümü 1984'e, yöntemsel itiraz 1992'ye, karamsar okum…"
- [OK]      k8 → "Childe'ın ölçüt beyanı 1936'ya, iskelet kanıtının toplu dökümü 1984'e, yöntemsel itiraz 1992'ye, karamsar okum…"
- [OK]      k12 → "Childe'ın ölçütü açıkça beyan edildiği için sınanabilir kaldı; uzun dönemli seride World kaydı, MÖ 10000 ile M…" — 1 atom doğrulandı; 1 ad ölçülemedi
- [ATOMSUZ] k2 → "Sağlık tarafındaki iddia ise dünyanın farklı bölgelerinden gelen iskelet örneklemleriyle sınanabilir hâle geld…" — denetlenebilir atom yok (yorum/bağlantı cümlesi)
- [OK]      k5 → "Wood, Milner, Harpending ve Weiss'in ortaya attığı paradoks itirazı bu birikimi geçersiz kılmıyor; onu okumanı…"

**Özet:** 29 OK · 0 ISARET · 0 HATA · 10 ATOMSUZ
