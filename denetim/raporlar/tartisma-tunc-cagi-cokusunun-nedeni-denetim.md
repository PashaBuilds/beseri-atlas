...
- [OK]      k4 → "İç çözülme ile dış saldırı arasındaki ayrım, kaynakların kendi düzeyinde bile bulanıktır; yayıncı tanıtımına g…"
- [OK]      k6 → "Bölümün başlığı savı özetler: "Systems Collapse as Social Transformation" — çöküş, erken devlet toplumlarında …"
- [OK]      k2 → "Saray düzeninin çözülmesi yazının, merkezî depolamanın ve uzun mesafeli ticaretin birlikte gerilemesi demekti;…" — 3 atom doğrulandı; 1 ad ölçülemedi
- [OK]      k3 → "başlıklı kitabı aynı çerçeveyi geniş bir okur kitlesine taşır; MÖ 1177'yi bir olay tarihi olarak değil bir kır…"
- [OK]      k4 → "Yayıncı tanıtımına göre Cline'ın savı, çöküşün istiladan isyana, depremden kuraklığa uzanan çok sayıda bağlant…"
- [OK]      k5 → "Drews, 1993 tarihli kitabında depremi, göçü, demir işçiliğini, kuraklığı, sistem çöküşünü ve akıncıları ayrı a…"
- [OK]      k7 → "Kaniewski ve ekibinin 2013'te yayımladığı çalışma, Kıbrıs'tan alınan paleoiklim verisini radyokarbon temelli b…" — 2 atom doğrulandı; 2 ad ölçülemedi
- [OK]      k2 → "Levant ile Anadolu'da düzenler dağılırken Mezopotamya'daki Orta Asur Devleti ve Mısır'ın Yeni Krallığı zayıfla…" — 2 atom doğrulandı; 2 ad ölçülemedi
...
- [OK]      k11 → "Schachner'in 2024'te Anatolian Studies'te yayımladığı inceleme, son otuz yılda biriken bilimsel tarihleme ile …" — 3 atom doğrulandı; 2 ad ölçülemedi
- [OK]      k11 → "Aynı inceleme, Schachner'in kurduğu tarihleme dizisine göre kentin ders kitaplarına giren genel planının moder…" — 1 atom doğrulandı; 1 ad ölçülemedi
- [OK]      k2 → "Yirminci yüzyıl sonu ile yirmi birinci yüzyıl başındaki araştırma, çöküşün ölçeğinin ve kapsamının sanıldığınd…"
- [OK]      k12 → "Uzun dönemli seride dünya nüfusu MÖ 1000 için yaklaşık 110,5 milyon verilir ve seri bu aralıkta bin yıllık adı…"

**Özet:** 31 OK · 0 ISARET · 0 HATA · 0 ATOMSUZ
