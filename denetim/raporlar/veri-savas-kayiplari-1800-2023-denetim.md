...
_Geçiş 2 — kaynak denetimi · 2026-08-29T14:39:59.977Z_
...
- [ATOMSUZ] k1 → "Bir serideki sıfırın iki farklı okuması olması, atlasın şu kuralının dayanağıdır: sıfır değeri, veri kümesinin…" — denetlenebilir atom yok (yorum/bağlantı cümlesi)
...
- [ATOMSUZ] k1 → "Dört yılın birbirine bu kadar yakın olması, "en ölümcül yıl" ifadesinin bu seride ayırt edici olmadığını göste…" — denetlenebilir atom yok (yorum/bağlantı cümlesi)
