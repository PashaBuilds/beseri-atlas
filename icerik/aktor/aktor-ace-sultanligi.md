---
id: aktor-ace-sultanligi
tip: aktor
baslik: Açe Sultanlığı
ozet: >-
  Avrupa donanmalarının Hint Okyanusu'nu kapatma girişimine karşı alternatif
  bir güzergâh kurarak dört yüzyıl direnen sultanlık; atlasta bir ablukanın
  nasıl aşıldığının en açık örneği.
donem: "09"
tarih_baslangic: "1496"
tarih_bitis: "1903"
bolge: [dogu-asya, islam-dunyasi]
eksen: [siyasi, ekonomik, dini, askeri]
guven_geneli: yaygin
etiketler: [ace, sumatra, biber, abluka, deniz-gucu, sultanlik]
ilgili:
  - donem-09
...
kaynaklar:
  - anahtar: k1
    tur: ansiklopedi
    ad: "TDV Islam Ansiklopedisi - ACE"
    url: https://islamansiklopedisi.org.tr/ace
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "AÇE"
    not: "Turkce akademik ansiklopedi maddesi"
  - anahtar: k2
    tur: ansiklopedi
    ad: "TDV Islam Ansiklopedisi - SUMATRA"
    url: https://islamansiklopedisi.org.tr/sumatra
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "SUMATRA"
    not: "Adanin butunu; sultanligin cevresi ve rakipleri"
  - anahtar: k3
    tur: birincil
    birincil_tur: tanik
    ...
    not: "Sultanliktan yaklasik yuz elli yil once ayni adanin kuzeyinin tanik kaydi"
...
girmeden önceki son noktada kurulmuştur.[^k1][^k2] Bu konum, dosyanın bütün
mantığını belirler.

Boğazın denetimi bir başka güce geçtiğinde, buradaki liman boğaza girmeden
...
Boğazın Avrupa donanmalarınca denetim altına alınması, bölgedeki ticaretin
...
Sonuç, denetim kuran tarafın beklediğinden farklı oldu.[^k2] Ticaret hacmi
korundu; değişen şey, gelirin hangi limana gittiğiydi.
...
Sultanlık, kendisinden çok uzaktaki büyük bir devletten askerî destek
...
Böyle bir ittifakın sınırı da kaydedilmelidir. Destek, mesafenin izin
...
## Deniz gücünün yerel kurulması

Sultanlık kendi gemi yapımını ve donanmasını geliştirdi.[^k1][^k2] Bu,
bölgedeki liman devletlerinin çoğunda görülmeyen bir tercihtir; çoğu,
savunmayı kiralık güce ya da tarafsızlığa bırakır.

Kendi donanmasını kuran bir liman devleti, tarafsızlık sermayesinden
vazgeçmiş olur.[^k2] Silahlanan bir liman, artık herkesin güvenle
uğrayabileceği bir yer değil, bir tarafın limanıdır.

Bu tercihin bedeli ve kazancı birlikte okunmalıdır.[^k1] Sultanlık,
tarafsızlıktan vazgeçerek bağımsızlığını korudu; aynı tercih onu sürekli bir
askerî yük altına soktu.

## Hukuk ve idari düzen

Sultanlıkta hukuk düzeni, dinî hukukun yerel örf ile birlikte
uygulanmasına dayanıyordu.[^k1][^k2] İki kaynağın birlikte işlemesi, bölgedeki
başka sultanlıklarda da görülür.

Böyle karma bir düzende, hangi konunun hangi kaynağa göre çözüleceği bir
...
Sultanlık döneminde bölgede yoğun bir dinî metin üretimi ve çeviri
faaliyeti yürüdü.[^k1][^k2] Yerel dil, bu dönemde bölgesel bir yazı dili
hâline geldi.

Bir liman devletinin metin üretim merkezi olması tesadüf
...
boşluğa değil, mevcut bir düzenin üzerine kurulmuştur.

Bu, sultanlığın kuruluşunu bir başlangıç değil bir yeniden düzenleme olarak
okumayı mümkün kılar.[^k1][^k3] Künyedeki başlangıç tarihi bir siyasi
kuruluşu gösterir, bölgedeki düzenin başlangıcını değil.
...
Sultanlığın nüfusuna, ordu ve donanma büyüklüğüne dair sayılar rakip
kayıtlarından ve sonraki derlemelerden gelir.[^k1][^k2] Bağımsız bir sayım
elde bulunmamaktadır.

Rakip kayıtlarındaki sayıların yönü bellidir.[^k2] Direnişin büyüklüğü,
...
Sultanlık, adanın öteki liman şehirleriyle sürekli bir rekabet
...
Uzun süren direniş, sultanlık hakkındaki kayıtların bileşimini de
...
Uzak müttefik için [Osmanlı İmparatorluğu](/aktor/osmanli-imparatorlugu/),
limanlardaki yabancı topluluklar için
[Ticaret diasporası](/kavram/ticaret-diasporasi/) dosyaları uygundur.

Bölgeyi yüz elli yıl önce görmüş tanık için
[İbn Battûta](/dusunur/ibn-battuta/),[^k3] sömürge döneminin bilançosunun nasıl
tartışıldığı için
