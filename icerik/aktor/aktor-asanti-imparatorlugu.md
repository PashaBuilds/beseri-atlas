---
id: aktor-asanti-imparatorlugu
tip: aktor
baslik: Aşanti İmparatorluğu
ozet: >-
  Yazıya değil ezberlenmiş bir hukuk ve protokol düzenine dayanan,
  altın ve köle ticaretiyle büyüyen ve dört savaş sonunda ilhak edilen
  imparatorluk; atlasta yazısız bir devlet aygıtının örneği.
donem: "10"
tarih_baslangic: "1701"
tarih_bitis: "1901"
bolge: [afrika, avrupa]
eksen: [siyasi, ekonomik, askeri, kulturel]
guven_geneli: yaygin
etiketler: [asanti, altin, kole-ticareti, sozlu-hukuk, bati-afrika, ilhak]
ilgili:
  - donem-10
  - donem-12
...
kaynaklar:
  - anahtar: k1
    tur: ansiklopedi
    ad: "Wikipedia (EN) - Ashanti Empire"
    url: https://en.wikipedia.org/wiki/Ashanti_Empire
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Ashanti"
    not: "Giris kapisi; havuz kurali geregi makalede en fazla bir tane"
  - anahtar: k2
    tur: birincil
    birincil_tur: tanik
    ad: "1911 Encyclopaedia Britannica — Ashanti maddesi, Wikisource"
    url: https://en.wikisource.org/wiki/1911_Encyclop%C3%A6dia_Britannica/Ashanti
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Ashanti"
    not: "Ilhaktan on yil sonra yazilmis kayit; olgu kaynagi degil donem tanikligi olarak kullanilir"
  - anahtar: k3
    tur: birincil
    birincil_tur: tanik
    ad: "Richard F. Burton, To the Gold Coast for Gold (1883), archive.org"
    url: https://archive.org/details/togoldcoastforgo02burt
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Gold Coast"
    not: "Donem gozlemcisinin anlatisi; cercevesi acikca kendi doneminindir"
...
orman kuşağında kurulan ve yirminci yüzyıl başında ilhak edilen
devlettir.[^k1] Merkezi, kıyıdan birkaç yüz kilometre içeride, orman kuşağının
içinde yer alıyordu.

Devlet, çok sayıda ayrı topluluğun bir çatı altında birleşmesiyle
...
Kaydın tutulma biçimi farklıydı.[^k3] Hukuk kuralları, protokol ve
hanedan tarihi ezberleyicilerin sorumluluğundaydı.

## Ezberlemenin kurumsallaşması

Ezberleme rastgele bir uygulama değil, bir görevdi.[^k1] Belirli
kişiler belirli bilgi kümelerinden sorumluydu.
...
Birliğin merkezinde, hükümdarlığı temsil eden bir nesne
bulunuyordu.[^k1] Nesne, kişiye değil birliğin kendisine aitti.
...
Bölge, altın üretimiyle biliniyordu.[^k1] Kıyıya verilen ad da bu
üretimden gelir.

Altın, hem ihracat kalemi hem iç ödeme aracıydı.[^k3] Altın tozu ölçmek
için standart ağırlık takımları kullanılıyordu.

Standart ağırlıkların varlığı, ölçü birliğinin sağlandığını
gösterir.[^k2] Bu, yazıya gerek duymadan işleyen bir standardizasyon
örneğidir.

## Ölçü birliğinin anlamı

Ölçü birliği, geniş bir alanda güvenle alışveriş yapılabildiğini
...
Bölge, Atlantik ticaretinin en yoğun alanlarından birine
komşuydu.[^k1] Esir ihracatı, devletin gelir kalemlerindendi.
...
On dokuzuncu yüzyılda Atlantik köle ticareti yasaklandı ve
azaldı.[^k1] Bu, bölgenin gelir yapısını doğrudan etkiledi.
...
Devletin merkezi kıyıdan uzaktı ve kıyı doğrudan denetiminde
değildi.[^k1] Kıyıdaki topluluklarla ilişki aracılı yürüyordu.

Kıyıya doğrudan erişim, dönem boyunca sürekli bir hedefti.[^k3] Aracıyı
kaldırmak, ticaret gelirini artırmak demekti.

Bu hedef, kıyıdaki Avrupa varlığıyla doğrudan çatışma üretti.[^k2]
Çatışmanın konusu ideolojik değil lojistikti.

## Dört savaş

On dokuzuncu yüzyıl boyunca devlet ile kıyıdaki güç arasında dört ayrı
savaş yaşandı.[^k1] Savaşların sonuçları farklı oldu.
...
Fark, tek bir silahtan değil bir bileşimden doğdu.[^k1] Ateşli silah
menzili, tıbbi önlemler ve deniz üzerinden ikmal birlikte işledi.
...
Devlet, yüzyıl sonunda ilhak edildi.[^k1] Hükümdar sürgüne gönderildi
ve bölge doğrudan yönetime bağlandı.
...
## Birliğin kuruluş biçimi

Devletin kuruluşu, birden çok ayrı topluluğun ortak bir çatı altında
toplanmasıyla oldu.[^k1] Toplulukların her biri kendi iç yönetimini
korudu ve merkeze belirli yükümlülüklerle bağlandı; bu, bir fetih değil
bir federasyon kurma işlemidir.

Yapı, merkezin gücünü baştan sınırlıyordu.[^k2] Merkez, savaş ve dış
...
Federatif yapı, seferlerde geniş bir kuvvet toplamayı mümkün
kılıyordu.[^k1] Aynı yapı, uzun süreli savaşlarda dağılma riski
taşıyordu; toplulukların katılımı her seferde yeniden sağlanmak
zorundaydı.

Devletin karşılaştığı dört savaştan sonrakilerde bu risk
...
Devlette bir yargı düzeni işliyordu ve kararlar ezberlenmiş kural
kümesine dayanıyordu.[^k1] Davalar kademeli olarak yükseliyor, en üst
merci hükümdarın huzuruydu.

Kuralların yazılı olmaması, keyfîlik anlamına gelmiyordu.[^k2] Kuralın
...
Bölge orman kuşağındaydı ve bu, tarımın ve ulaşımın biçimini
belirliyordu.[^k1] Tekerlekli taşıma kullanılmıyor, yükler insan
sırtında taşınıyordu; bu, ticaretin birim maliyetini yükseltiyor ve
taşınabilecek malların bileşimini daraltıyordu.

Altın ve esir bu kısıtın dışındaydı.[^k3] İkisi de birim ağırlık başına
...
Devletin kendi kayıtları yazılı değildi.[^k1] Bugün bilinenlerin önemli
bölümü ya sözlü aktarımdan ya dışarıdan gelen gözlemcilerden gelir.
...
dönemin çerçevesini taşır.

Sözlü aktarımdan gelen bilginin doğrudan künyelenmesi
yapılamamıştır.[^k1] Bu eksik borç defterine yazılmıştır.
...
birlikte okunduğunda aynı ticaretin üç farklı sonucu görünür.[^k1]

Ticaretin genel çerçevesi için
[Atlantik köle ticareti](/olay/atlantik-kole-ticareti/) ve
[Silahlı ticaret](/kavram/silahli-ticaret/) dosyaları uygundur.[^k3]
