---
id: aktor-benin-kralligi
tip: aktor
baslik: Benin Krallığı
ozet: >-
  Batı Afrika orman kuşağında yedi yüzyıl süren krallık; bıraktığı maden
  döküm eserleri, yazılı kaynak azlığında bir düzenin nasıl belgelenebileceğinin
  atlastaki en açık örneği.
donem: "08"
tarih_baslangic: "1180"
tarih_bitis: "1897"
bolge: [afrika]
eksen: [siyasi, kulturel, ekonomik]
guven_geneli: tartismali
etiketler: [benin, edo, pirinc-dokum, orman-kusagi, saray, yagma]
ilgili:
  - donem-08
...
kaynaklar:
  ...
  - anahtar: k2
    ...
    not: "Kralligin bulundugu bolgenin sonraki siyasi cercevesi"
  - anahtar: k3
    tur: ansiklopedi
    ad: "Wikipedia (EN) - Kingdom of Benin"
...
Krallık hakkındaki bilgi üç ayrı kaynaktan gelir ve üçü farklı şeyler
söyler.[^k3] Birincisi saray sözlü geleneği, ikincisi kıyıya gelen Avrupalı
...
Krallığın bıraktığı maden döküm levhalar ve heykeller, saray hayatını,
...
Kanıtın sınırı da bellidir.[^k3] Levhalar kimin kimin üstünde durduğunu
gösterir; hangi kararın ne zaman alındığını göstermez. Görsel kayıt yapı
verir, olay sırası vermez.

## Döküm tekniğinin kendisi bir bilgi

Eserlerin yapım tekniği, bölgede yüksek düzeyde uzmanlaşmış bir zanaat
örgütlenmesinin bulunduğunu gösterir.[^k3] Bu teknik, sürekli bir atölye,
usta-çırak zinciri ve düzenli hammadde tedariki gerektirir.

Üçü de bir siyasi düzenin varlığına işaret eder.[^k1] Böyle bir üretim,
...
Dökümde kullanılan madenin bir bölümü uzak bölgelerden geliyordu.[^k3] Bu,
krallığın ticaret ağlarına bağlı olduğunun doğrudan kanıtıdır.

Bağlantının yönü zamanla değişti.[^k1] Erken dönemde kuzeyden gelen kara
...
Krallık, Atlantik ticaretine katıldı ve bu katılım köle ticaretini de
içerdi.[^k3] Olgu dosyada gizlenmez.

Katılımın biçimi ve ölçeği tartışmalıdır.[^k1] Kaynaklarda krallığın belirli
...
ve burada kaynaklar tek bir cevap vermez.

İkisini karıştırmak, iki yönde de hataya yol açar.[^k3] Katılımı inkâr etmek
kaydı bozar; katılımı ticaretin bütün sorumluluğunu paylaştırmakta kullanmak
ise ölçeği ve talebin yönünü görmezden gelir.

## Saray düzeni

Kaynaklarda krallığın merkezinde geniş bir saray teşkilatı, unvan hiyerarşisi
ve tören düzeni bulunduğu kaydedilir.[^k3] Bu bilgi hem sözlü gelenekten hem
döküm levhalardan gelir.

İki kaynağın aynı yapıyı göstermesi, güvenilirliği artırır.[^k1] Sözlü
...
Kıyıya gelen ziyaretçilerin kayıtlarında başkentin genişliği, sokak düzeni
ve surları ayrıntılı biçimde tarif edilir.[^k3] Tarifler, gözlemcilerin
kendi şehirleriyle karşılaştırma yaparak yazılmıştır.
...
Krallığın sonu, on dokuzuncu yüzyıl sonunda bir askerî seferle
...
Süreklilik, hanedan listesine ve saray geleneğine dayanır.[^k3] İki kaynak da
...
geçmez ve hangi sorunun cevaplanabildiği, araştırmacının tercihinden çok
kanıtın türünden gelir.

Sonuç, bölgeler arası karşılaştırmalarda dikkate alınmalıdır.[^k2] Bir bölge
...
[Arkeolojik kanıt](/kavram/arkeolojik-kanit/) dosyaları okunmalıdır.[^k1]

Sözlü geleneğin kaynak değeri için
[Sözlü tarih](/kavram/sozlu-tarih/) ve
[Sözlü gelenek kaynak sayılır mı](/tartisma/sozlu-gelenek-kaynak-mi/)
dosyaları uygundur.[^k3]

Kıyı ticaretinin bağlamı için
[Atlantik köle ticareti](/olay/atlantik-kole-ticareti/), kıtanın
paylaşılması için [Berlin Konferansı](/olay/berlin-konferansi/) dosyaları
okunabilir.[^k2]
