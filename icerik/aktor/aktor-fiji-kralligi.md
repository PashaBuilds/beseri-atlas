---
id: aktor-fiji-kralligi
tip: aktor
baslik: Fiji Krallığı
ozet: >-
  Üç yıl süren, borç yüzünden egemenliğini devreden ve devrettikten
  sonra nüfus bileşimi kalıcı olarak değişen krallık; atlasta ilhakın
  mali yoldan gerçekleştiği örnek.
donem: "12"
tarih_baslangic: "1871"
tarih_bitis: "1874"
bolge: [okyanusya, avrupa]
eksen: [siyasi, ekonomik, demografik]
etiketler: [fiji, ilhak, borc, plantasyon, isci-gocu, okyanusya]
guven_geneli: yaygin
ilgili:
  - donem-12
...
kaynaklar:
  - anahtar: k1
    tur: ansiklopedi
    ad: "Wikipedia (EN) - Fiji"
    url: https://en.wikipedia.org/wiki/Fiji
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Fiji"
    not: "Giris kapisi; havuz kurali geregi makalede en fazla bir tane"
  - anahtar: k2
    tur: birincil
    birincil_tur: tanik
    ad: "1911 Encyclopaedia Britannica — Fiji maddesi, Wikisource"
    url: https://en.wikisource.org/wiki/1911_Encyclop%C3%A6dia_Britannica/Fiji
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Fiji"
    not: "Devirden yaklasik kirk yil sonra yazilmis kayit; donem tanikligi"
  - anahtar: k3
    tur: birincil
    birincil_tur: belge
...
Krallıktan önce, aynı şefin adına yabancı bir devletten tazminat
talebi yöneltilmişti.[^k2] Talep, adalardaki bir yangında zarar gören
bir vatandaşın kaybına dayandırılıyordu.
...
Ödenemeyen borç, iki seçenek üretir.[^k1] Ya alacaklı devlet zorla tahsil
eder ya da borçlu, borcu üstlenecek bir tarafa egemenlik devreder.
...
Krallık döneminde en yakıcı iç mesele toprak satışlarıydı.[^k2]
Yerleşimciler pamuk plantasyonları için toprak satın alıyordu ve
satışların geçerliliği tartışmalıydı.

Yerel toprak düzeni, bireysel satışa uygun değildi.[^k1] Toprak
...
Adalarda, krallıktan önce tek bir merkezî otorite yoktu.[^k2] Birden çok
...
gelişmeyle dış etkenin ayrıştırılmasını zorlaştırır.

## Misyoner temasının rolü

Adalarda misyoner faaliyeti, krallıktan önce yerleşmişti.[^k2] Yazı
düzeni oluşturuldu ve okuryazarlık yaygınlaştı.
...
Krallık dönemindeki plantasyonlar pamuk üretiyordu.[^k2] Talep, uzak bir
kıtadaki iç savaşın pamuk arzını kesmesinden doğmuştu.
...
Devir, iki tarafın imzaladığı bir belgeyle yapıldı.[^k1] Belge, adaların
yönetimini karşı tarafa bırakıyordu.

Belgenin gönüllü olup olmadığı tartışmalıdır.[^k2] Bir okumada
...
Bu ara biçim ayrıca kaydedilmelidir.[^k3] Doğrudan yönetim ile himaye
arasında da dereceler vardır ve ikili ayrım her örneği kapsamaz.

## İşçi göçü

Devirden sonra adalarda şeker plantasyonları kuruldu.[^k2] Emek ihtiyacı,
yerel nüfustan karşılanmadı.

Yeni yönetim, yerel nüfusun plantasyonlarda çalıştırılmasını
sınırlandırdı ve bunun yerine sözleşmeli işçi getirtti.[^k1] İşçiler,
aynı imparatorluğun güney Asya'daki topraklarından geldi.

Elli yıl süren bu göç, adaların nüfus bileşimini kalıcı olarak
değiştirdi.[^k2] Yirminci yüzyılda iki büyük nüfus grubu neredeyse eşit
büyüklükteydi.

## Kararın sonuçları

Yerel nüfusu plantasyon emeğinden koruyan karar, iki sonuç
üretti.[^k1] Yerel toplumsal yapı büyük ölçüde korundu; buna karşılık
adalarda ikinci bir büyük nüfus grubu oluştu.

İkinci sonuç, sonraki yüzyılın siyasi gerilimlerinin zeminini
...
Zincir dört halkalıdır.[^k1] Borç egemenlik devrine, devir plantasyon
ekonomisine, plantasyon emek ithaline, emek ithali kalıcı nüfus
değişimine yol açtı.
...
Adalarda, devirden önce de sonra da işleyen bir şeflik hiyerarşisi
vardı.[^k2] Yapı, akrabalık ve toprak hakkı üzerinden kuruluyordu.

Yeni yönetim bu yapıyı ortadan kaldırmadı.[^k1] Yerel yönetimi şefler
...
Yeni yönetim, yerel toprak mülkiyetini kaydetti ve satışını
kısıtladı.[^k2] Kayıt, o anki durumu sabitledi.
...
Devrin gönüllü olup olmadığı belirlenmez.[^k2] İki okuma da kaydedilir.

Üç Okyanusya örneğinden bir kural çıkarılmaz.[^k3] Toprak
