...
ama kendi donanmasını kurmamıştır.[^k1][^k3] incelenen liman
...
Bu genel bir gözlemi doğrular.[^k1] Ticarete dayalı
...
Dağınık üretim, küçük ölçek demek
değildir; dağınıklık bir örgütlenme biçimidir, bir kapasite sınırı değil.[^k1]
...
İnanç çeşitliliğine izin vermenin ilkesel bir
tercih mi yoksa ekonomik bir hesap mı olduğu, kaynaklardan ayrıştırılamaz ve ikisi de
savunulabilir.[^k3]
...
İki gelişmenin ağırlığı ayrı ayrı
