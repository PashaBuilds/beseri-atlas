---
id: aktor-haudenosaunee
tip: aktor
baslik: Haudenosaunee Konfederasyonu
ozet: >-
  Anayasası yüzyıllarca boncuk dizileri ve sözlü aktarımla taşınmış,
  merkezî bir zor aygıtı bulunmayan ve bugün de varlığını sürdüren
  konfederasyon; atlasta "devlet" biriminin sınırını gösteren dosya.
donem: "08"
...
etiketler: [haudenosaunee, konfederasyon, sozlu-anayasa, wampum, kuzey-amerika]
ilgili:
  - donem-08
  - donem-10
  - kavram-sozlu-tarih
...
kaynaklar:
  - anahtar: k1
    tur: ansiklopedi
    ad: "Wikipedia (EN) - Haudenosaunee"
    url: https://en.wikipedia.org/wiki/Haudenosaunee
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Haudenosaunee"
    not: "Giris kapisi; havuz kurali geregi makalede en fazla bir tane"
  - anahtar: k2
    tur: birincil
    birincil_tur: belge
    ad: "Great Law of Peace — Wikisource"
    url: https://en.wikisource.org/wiki/Great_Law_of_Peace
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Great Binding Law"
    not: "Konfederasyonun kurucu metninin yaziya gecirilmis hali"
  - anahtar: k3
    tur: birincil
    birincil_tur: belge
    ad: "Arthur C. Parker & Seth Newhouse, The Constitution of the Five Nations (1916), archive.org"
    url: https://archive.org/details/constitutionoffi00parkuoft
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Five nations"
    not: "Metnin yayimlanmis baskisi; katalogda yaratici alaninda Parker ve Newhouse, 1916, erisim kisiti yok"
...
ve bugün de varlığını sürdüren bir siyasi birliktir.[^k1] Başlangıçta beş
ulusu kapsıyordu; on sekizinci yüzyıl başında güneyden gelen altıncı bir
ulusun katılmasıyla kapsam genişledi ve birlik bugün bu adla anılır.

Birlik, ortak bir hukuk metni etrafında kuruldu.[^k2] Metin, üye
ulusların iç işlerinde bağımsız kalmasını, ortak meselelerde ise bir
...
aracı, boncuk dizilerinden oluşan kayıtlar ve bunları okumakla görevli
kişilerdi.

Boncuk dizileri bir alfabe değildir.[^k1] Desenler, metnin bölümlerine
...
Metin, on dokuzuncu yüzyıl sonu ile yirminci yüzyıl başı arasında
...
müdür sorusu açık kalır.

## Sürüm sorunu

Yazıya geçirilmiş birden çok sürüm vardır ve aralarında farklar
bulunur.[^k2] Farklar, madde sıralamasında ve bazı hükümlerin
ayrıntısındadır.

Hangi sürümün bağlayıcı olduğu konfederasyon içinde de tartışılır.[^k1]
...
çeviri arasındaki ilişkiden farklıdır.

Ortak yan şudur.[^k3] Bir belgenin ne söylediği, hangi sürümünün
okunduğuna bağlı olabilir ve bu bağlılık belgenin kendisinden okunmaz.

## Birliğin yapısı

Konfederasyon, merkezî bir zor aygıtı içermez.[^k2] Ortak konseyin
kararları, üye ulusların katılımıyla uygulanır ve zorla uygulatacak bir
merci yoktur.
...
Kurucu metinde, konsey üyelerinin belirlenmesi ve görevden alınması
...
farklı dönemlerde farklı yanıtlar alır.

## Anlaşmazlığın çözümü

Metin, uluslar arası anlaşmazlıklar için ayrıntılı bir usul
öngörür.[^k2] Usulün merkezinde, kan davasının tazminatla
karşılanması yer alır.

Amaç, misilleme zincirini kesmektir.[^k1] Bir öldürme olayının karşılığı
belirlenmiş bir ödemeyle kapatılır ve karşı taraf misilleme hakkını
kullanmaz.

Bu, birliğin kuruluş gerekçesiyle doğrudan ilgilidir.[^k3] Kuruluş
anlatısı, uluslar arasındaki sürekli çatışmanın sona erdirilmesi
üzerine kuruludur.

## Kuruluş tarihi tartışması

Birliğin ne zaman kurulduğu tartışmalıdır.[^k1] Öne sürülen tarihler
arasında birkaç yüzyıllık fark vardır.

Erken tarih, sözlü geleneğe ve bir güneş tutulması kaydına
...
Konfederasyon, on yedinci ve on sekizinci yüzyıllarda Avrupa devletleriyle
antlaşmalar yaptı.[^k1] Antlaşmalar, ticaret, ittifak ve toprak
...
On sekizinci yüzyıl sonundaki savaşta konfederasyon üyeleri farklı
taraflarda yer aldı.[^k1] Bu, birliğin kuruluşundan sonraki en derin
bölünmesidir.

Savaş sonunda topraklar bölündü ve nüfusun bir bölümü kuzeye
...
Kurucu metnin, sonraki bir anayasa üzerinde etkili olduğu ileri
sürülmüştür.[^k1] İddia, yirminci yüzyılda geniş biçimde tartışıldı.
...
Konfederasyon bugün de varlığını sürdürmektedir.[^k1] Konsey toplanmakta,
...
Sömürge dönemi savaşlarının ayrıntısı kapsam dışıdır.[^k3] Dosya
yalnızca birliğin yapısına ve metnin taşınma biçimine ilişkin olanı
