...
baslik: Karluklar
ozet: >-
  Bir savaşın sonucunu taraf değiştirerek belirlediği söylenen ve
  hakkındaki bu tek cümleyle anılan boy birliği; atlasta bir topluluğun
  kendi tarihinin bir başkasının dipnotuna sıkıştığı örnek.
donem: "06"
tarih_baslangic: "650"
tarih_bitis: "1050"
...
guven_geneli: yaygin
etiketler: [karluk, bozkir, talas, karahanli, kaynak-sorunu, orta-asya]
ilgili:
  - donem-06
  - donem-07
  - olay-talas-savasi
...
kaynaklar:
  - anahtar: k1
    tur: ansiklopedi
    ad: "TDV Islam Ansiklopedisi - KARLUKLAR"
    url: https://islamansiklopedisi.org.tr/karluklar
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "KARLUKLAR"
  ...
  - anahtar: k2
    ...
    not: "Ayni bolgede kurulan sonraki duzenin ayri maddesi"
  - anahtar: k3
    tur: ansiklopedi
    ad: "Wikipedia (EN) - Karluks"
...
kaydedilen ve sonraki dört yüzyıl boyunca bölgenin siyasi denklemlerinde
yer alan bir boy birliğidir.[^k1] Birlik, adından da anlaşılacağı üzere birden çok boydan oluşuyordu.
...
Karluklar en çok, bir savaşın ortasında taraf değiştirdikleri
iddiasıyla anılır.[^k3] İddia, o savaşın sonucunu açıklayan standart
cümledir.
...
Taraf değiştirme iddiası, olaydan sonra ve olayın taraflarından biri
...
Karluklar tek bir boy değil, birden çok boyun oluşturduğu bir
...
güvenilmez olarak kaydeder.

## Tutarsızlık yakıştırmasının kaynağı

Taraf değiştirme iddiasının bir bölümü bu yapıdan doğmuş
...
dayanaklarını sorgulanamaz kılar.

## Bölgedeki komşular

Topluluk, aynı yüzyıllarda bölgede bulunan birden çok düzenle temas
hâlindeydi.[^k1] Kuzeyde, doğuda ve güneyde ayrı ayrı güçler
bulunuyordu.

Bu çokluk, ittifak seçeneklerini artırıyordu.[^k2] Tek bir komşusu olan
...
Aynı konum bir kırılganlık da üretir.[^k1] İki gücün doğrudan
karşılaştığı yerde, tarafsız kalmak seçenek olmaktan çıkar.
...
Onuncu yüzyılda bölgede kurulan hanedanın, bu boy birliğinden çıktığı
ileri sürülür.[^k2] İddia yaygındır ve tartışmalıdır.
...
Kaynaklarda geçen ad, tek bir topluluğu mu yoksa bir siyasi çatı
...
Topluluğun bulunduğu bölge, doğu-batı ticaret hatlarının
üzerindeydi.[^k2] Geçiş güvenliği, hatların işlemesi için gerekliydi.
...
Topluluk on birinci yüzyıldan sonra ayrı bir siyasi birim olarak
anılmaz.[^k1] Bölgedeki yeni düzenlerin içinde erimiş görünür.
...
Boy adlarının tek tek listesi verilmez.[^k1] Kaynaklar bu konuda
örtüşmez ve bir liste vermek, örtüşme varmış izlenimi yaratır.

Savaşın askerî ayrıntısı kapsam dışıdır.[^k3] Ayrı bir dosya
bulunmaktadır.
...
Sonraki hanedanla köken bağı da belirlenmez.[^k1] İki ihtimal
kaydedilir.

Topluluğun toplumsal yapısı işlenmez.[^k2] Kaynaklar bu konuda ayrıntı
...
Aynı kaynak sorununun ölçüldüğü dosya için
[Kanıt türü](/kavram/kanit-turu/), kendi dilinde uzun yazıt bırakmış
komşu düzen için [Orhon Yazıtları](/kaynak/orhon-yazitlari/) ve
[Göktürk Kağanlığı](/aktor/gokturk-kaganligi/) dosyaları uygundur.[^k1]
