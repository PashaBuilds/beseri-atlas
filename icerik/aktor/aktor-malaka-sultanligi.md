---
id: aktor-malaka-sultanligi
tip: aktor
baslik: Malaka Sultanlığı
ozet: >-
  Bir boğazı denetleyerek yüz yıl içinde bölgenin en büyük limanı hâline gelen
  ve kendi kuruluş anlatısını kendi yazdıran sultanlık; toprak değil geçit
  üzerine kurulmuş bir devletin en açık örneği.
donem: "08"
tarih_baslangic: "1400"
tarih_bitis: "1511"
bolge: [dogu-asya, islam-dunyasi]
eksen: [ekonomik, siyasi, dini, kulturel]
guven_geneli: yaygin
etiketler: [malaka, bogaz, liman, sultanlik, malay, ticaret]
ilgili:
  - donem-08
...
kaynaklar:
  - anahtar: k1
    tur: ansiklopedi
    ad: "TDV Islam Ansiklopedisi - MALAKA"
    url: https://islamansiklopedisi.org.tr/malaka
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "MALAKA"
    not: "Turkce akademik ansiklopedi maddesi"
  - anahtar: k2
    tur: birincil
    birincil_tur: eser
    ad: "The Malay Annals (Sejarah Melayu) — Raffles MS 18, C. C. Brown cevirisi (1952)"
    url: https://archive.org/details/malay-annals-C.-C.-Brown
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Malay Annals"
    not: "Sultanligin kendi saray anlatisi; hanedanin kendi kalemiyle"
  - anahtar: k3
    tur: birincil
    birincil_tur: tanik
    ...
    not: "Sultanliktan once ayni sularin disaridan kaydi; karsilastirma icin"
  - anahtar: k4
    tur: ansiklopedi
    ad: "Wikipedia (EN) - Malacca Sultanate"
    url: https://en.wikipedia.org/wiki/Malacca_Sultanate
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Malacca Sultanate"
...
Mevsim rüzgârlarının belirlediği takvim, bu boğazı zorunlu bir durak hâline
getirir.[^k1] Batıdan gelen gemiler ile doğudan gelen gemiler, rüzgârın yön
değiştirmesini burada bekler.

Beklemenin kendisi bir ekonomik olaydır. Aylarca aynı limanda kalan
tüccarlar, malını satar, karşılığında yeni mal alır ve geri dönüş için
yüklenir;[^k1][^k4] liman böylece taşıma noktası değil değişim noktası olur.

Sultanlığın geliri bu değişimden alınan paydır. Kendi ürettiği bir mal
yoktur; sattığı şey güvenlik, depolama ve tarafsızlıktır.[^k4]

## Tarafsızlık bir siyasi tercihtir

Bir liman devletinin en değerli sermayesi, tüccarların ayrım gözetilmeden
korunduğuna dair güvendir.[^k1] Bu güven, hangi tüccarın hangi ülkeden geldiği
sorulmadan sağlandığında oluşur.

Kaynaklarda limanda farklı kökenlerden tüccar topluluklarının kendi
temsilcileriyle örgütlendiği kaydedilir.[^k1][^k4] Her topluluk kendi iç
...
## Din değişiminin ticari boyutu

Sultanlığın kurucu hanedanının İslam'ı benimsemesi, kaynaklarda bölgedeki
ticaret ağına katılmayla birlikte anlatılır.[^k1][^k2] İki olayın aynı
anlatıda geçmesi, bir nedensellik iddiası olarak okunmamalıdır.

Yine de bağlantı kaydedilmelidir. Okyanus ticaretinin baskın tüccar
...
Sultanlık, bölgedeki daha büyük siyasi birimlerle doğrudan çatışmaktan çok
...
Tâbiiyetin sembolik göstergeleri ile fiilî bağımsızlık ayrı ayrı
işler.[^k1] Bir liman devletinin uzaktaki bir imparatorluğa bağlılık
bildirmesi, o imparatorluğun limanı yönettiği anlamına gelmez.

## Sonun biçimi

Sultanlığın sonu, bölge içi bir çatışmayla değil dışarıdan gelen bir donanma
...
dosyada karşılaştırma amacıyla kullanılmıştır.[^k3] Bu sınır burada
belirtilir; kaynağın kapsamı dışındaki bir dönem için tanıklık olarak
okunmamalıdır.

Saray anlatısının kullanılan çevirisi yirminci yüzyıl ortasına aittir ve
...
Limanda yaşayan nüfusun büyük bölümü, sultanlığın kendi tebaası
değildi.[^k1][^k4] Kaynaklarda uzak bölgelerden gelmiş yerleşik tüccar
topluluklarının sayısı ve çeşitliliği kaydedilir.

Böyle bir nüfus yapısı, devletin işleyişini doğrudan belirler. Askerî güç
büyük ölçüde dışarıdan kiralanır, vergi tabanı yabancı tüccarlara dayanır ve
sadakat toprak bağıyla değil karşılıklı çıkarla kurulur.[^k1]

Bunun kırılganlığı da açıktır. Çıkara dayanan bir bağ, çıkar ortadan
kalktığında ya da başka bir liman daha uygun şartlar sunduğunda
çözülür;[^k4] liman devletlerinin hızlı yükselip hızlı düşmesinin sebebi
budur.

## Ölçek sorunu

Bu sultanlığın nüfusuna ve ticaret hacmine dair sayılar, çoğunlukla dışarıdan
gelen gözlemcilerin verdiği izlenimlerdir.[^k3][^k4] Liman kayıtları
korunmuş değildir.

Bir limanın büyüklüğüne dair izlenim, gözlemcinin daha önce hangi limanları
...
Aynı düzenin batı ucunda, Doğu Afrika kıyısında benzer bir liman devletleri
kuşağı bulunur.[^k3] İki uç, birbirinden habersiz değildir; aynı ağın iki
tarafıdır ve aynı rüzgâr takvimine bağlıdır.

Karşılaştırmanın gösterdiği şey, benzer coğrafi konumların benzer siyasi
...
Düzenin bağlı olduğu ağ için
[Hint Okyanusu ticareti](/kavram/hint-okyanusu-ticareti/), bölgedeki egemenlik
biçimi için [Mandala devleti](/kavram/mandala-devleti/) dosyaları uygundur.

Aynı yüzyılda bölgeye gelen bir donanma için
[Cheng Ho seferleri](/olay/cheng-ho-seferleri/), limanın düşüşünün nasıl
adlandırılacağı için [Keşif mi istila mı](/tartisma/kesif-mi-istila-mi/)
