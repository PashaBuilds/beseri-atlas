---
id: aktor-maldiv-sultanligi
tip: aktor
baslik: Maldiv Sultanlığı
ozet: >-
  Toprağı, madeni ve tarımı olmayan ama iki kıtada para olarak kullanılan bir
  deniz kabuğunu üreten takımada devleti; atlasta bir paranın nereden geldiği
  sorusunun cevabını taşıyan dosya.
donem: "07"
tarih_baslangic: "1153"
tarih_bitis: "1573"
bolge: [guney-asya, islam-dunyasi, afrika]
eksen: [ekonomik, siyasi, dini, kulturel]
guven_geneli: tartismali
etiketler: [maldivler, kauri, para, takimada, halat, hint-okyanusu]
ilgili:
  - donem-07
...
kaynaklar:
  - anahtar: k1
    tur: ansiklopedi
    ad: "TDV Islam Ansiklopedisi - MALDIVLER"
    url: https://islamansiklopedisi.org.tr/maldivler
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "MALDİVLER"
    not: "Turkce akademik ansiklopedi maddesi"
  - anahtar: k2
    tur: ansiklopedi
    ad: "TDV Islam Ansiklopedisi - SRI LANKA"
    url: https://islamansiklopedisi.org.tr/sri-lanka
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "SRİ LANKA"
    not: "En yakin buyuk komsu; ayni sularin oteki adasi"
  - anahtar: k3
    tur: birincil
    birincil_tur: tanik
    ...
    not: "Adalarda kadilik yapmis bir gozlemcinin iceriden kaydi"
...
Adalarda toplanan bir deniz kabuğu, uzak bölgelerde küçük değerli ödeme
aracı olarak kullanılıyordu.[^k1][^k3] Bu kabuk adalarda bol, uzakta ise
seyrekti.

Bir malın para olarak iş görmesi için üç şart gerekir: bölünebilir olması,
...
Arzı elinde tutmak, fiyatı belirlemek anlamına gelmiyordu.[^k1] Adalar,
kabuğu kendileri uzak pazarlara taşımıyor, gelen tüccarlara satıyordu.

Aradaki fark önemlidir. Üretici, malının uzaktaki değerini bilmediği sürece,
...
Adaların ikinci ihraç ürünü, hindistancevizi lifinden yapılan halattı.[^k3]
Bu halat, bölgedeki gemi yapımında yaygın olarak kullanılıyordu.

Halatın önemi kolayca gözden kaçar. Çivi kullanmadan, tahtaları birbirine
dikerek yapılan gemiler bu bölgede yaygındı ve bu teknik büyük miktarda
halat gerektiriyordu.[^k3]

İki ürün birlikte okunduğunda adaların konumu netleşir.[^k1] Adalar hem
okyanus ticaretinin para birimini hem de gemilerinin bir yapı malzemesini
sağlıyordu.
...
kaydı, ziyaret eden bir gözlemcininkinden farklıdır.

Kaydın taraflılığı da bu görevden gelir.[^k3] Gözlemci, uygulamaya
çalıştığı hukuk düzeni ile yerel örf arasındaki farkları eleştirel bir
gözle kaydeder; anlattığı gerginlikler kendi konumundan görünen
gerginliklerdir.
...
Kaynaklarda adaların bir dönem kadın hükümdar tarafından yönetildiği
kaydedilir.[^k1][^k3] Gözlemci bu durumu ayrıntılı biçimde anlatır ve kendi
beklentisiyle çeliştiğini belirtir.

Bir kaydın, gözlemcinin beklentisiyle çelişen bir olguyu yine de kaydetmiş
olması, kaydın güvenilirliğini artıran bir işarettir.[^k3] Kişinin
...
Takımada, yüzlerce mercan adasından ve aralarındaki sığ geçitlerden
oluşur.[^k1] Bu yapı, yerel kılavuz olmadan gemiyle girmeyi tehlikeli hâle
getirir.

Savunma böylece surla değil bilgiyle sağlanır.[^k3] Geçitlerin bilgisi
...
Aynı coğrafya, savunmayı kolaylaştırırken yönetimi zorlaştırır.[^k1]
Yüzlerce ada arasında haberleşme yavaştır ve merkezî denetim ancak
seyrek aralıklarla kurulabilir.

Kaynaklarda adaların bölgelere ayrıldığı ve her bölgenin kendi görevlisi
...
Adalarda toplanan kabuk, Batı Afrika'daki pazarlarda da ödeme aracı olarak
...
Sonraki yüzyıllarda Avrupa gemilerinin kabuğu büyük miktarlarda taşımaya
...
Adaların İslam'ı benimsemesi, kaynaklarda belirli bir tarihe ve bir olaya
...
En yakın büyük komşu, kuzeydoğudaki adadır ve iki düzen arasında sürekli
...
varlığı bilinmektedir; erişim sorunu ayrıdır.

Tek bir tanığa bu kadar dayanmanın riski açıkça beyan edilmelidir.[^k3]
Gözlemcinin adalarda bulunduğu süre sınırlıdır ve gördükleri o dönemin
kesitidir; künyedeki tarih aralığının tamamı için tanıklık etmez.

## Ölçek sorunu

Adaların nüfusuna ve kabuk ihracatının hacmine dair sayılar, gözlemci
kayıtlarından ve çok sonraki dönemin kayıtlarından gelir.[^k1][^k3] Çağdaş
bir sayım elde bulunmamaktadır.

Ada nüfusları özel bir güçlük taşır. Yerleşim yüzlerce ada arasında
...
Adalarda görev yapmış tanık için [İbn Battûta](/dusunur/ibn-battuta/), aynı
ağın Afrika ucu için [Svahili kıyısı](/kavram/svahili-kiyisi/) dosyaları[^k1]
uygundur.

Kabuğun para olarak kullanıldığı uzak pazar için
[Gana İmparatorluğu](/aktor/gana-imparatorlugu/) dosyası okunabilir.
