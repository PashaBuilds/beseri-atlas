...
Yöntem bir sıralama verir; mutlak tarih
vermez ve mutlak tarih için bağımsız bir kanıt gerekir.[^k1]
...
Nesnelerin bulunduğu yer ile ait olduğu yer
arasındaki fark, süregelen bir tartışmanın konusudur.[^k1]
...
Bu hızlı benimsemelerden biridir.[^k1] Bir kayıt
...
Fark, [Anakronizm](/kavram/anakronizm/) incelemesinde ele alınan sorunun
hukuki bir biçimidir.[^k1] Bir dildeki egemenlik terimi, öteki dilde tam
karşılığı olmayan bir kavrama çevrilmiştir.

Farkın sonuçları süregelen bir tartışmanın konusudur
ve ayrı bir dosya gerektirir.[^k4]
...
Yerleşim alanlarının dağılımı ise
arkeolojik olarak ölçülebilir ve karşılaştırma için kullanılabilir.[^k1]
...
Bu bir uyum örneğidir.[^k3] Bir yerleşim programının
...
Örüntünün kendisi, insan yerleşiminin ada ekosistemleri üzerindeki etkisinin genel bir
kaydıdır.[^k3]
