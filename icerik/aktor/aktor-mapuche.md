...
baslik: Mapuçe
ozet: >-
  Kuzeydeki imparatorluğu da sonradan gelen Avrupa gücünü de aynı hatta
  durduran ve üç yüzyıl boyunca antlaşmayla tanınan halk; atlasta merkezî
  bir devlet kurmadan direnmenin örneği.
donem: "09"
tarih_baslangic: "1450"
tarih_bitis: "1883"
bolge: [amerika]
eksen: [siyasi, askeri, kulturel, ekonomik]
guven_geneli: tartismali
etiketler: [mapuce, arauko, direnis, sinir, ispanyol, guney-amerika]
ilgili:
  - donem-09
  - donem-12
...
kaynaklar:
  - anahtar: k1
    tur: ansiklopedi
    ad: "Wikipedia (EN) - Mapuche"
    url: https://en.wikipedia.org/wiki/Mapuche
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Mapuche"
    not: "Giris kapisi; havuz kurali geregi makalede en fazla bir tane"
  - anahtar: k2
    tur: birincil
    birincil_tur: tanik
    ad: "Alonso de Ercilla, La Araucana (1911 baskisi), archive.org"
    url: https://archive.org/details/laaraucanapoema01erciuoft
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Araucana"
    not: "Savasa katilmis bir askerin 16. yuzyilda yazdigi manzum anlati; taraf metnidir"
  - anahtar: k3
    tur: birincil
    birincil_tur: tanik
    ad: "1911 Encyclopaedia Britannica — Chile maddesi, Wikisource"
    url: https://en.wikisource.org/wiki/1911_Encyclop%C3%A6dia_Britannica/Chile
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Chile"
    not: "Ilhaktan yaklasik otuz yil sonra yazilmis kayit; donem tanikligi olarak kullanilir"
...
bağımsız olarak aynı sınıra çarptı ve orada kaldı.

Dosyanın sorusu bu tekrardır.[^k2] Aynı hattın birbirinden bağımsız iki
olayda sınır olması, tesadüf sayılamayacak kadar belirgindir ve
nedenleri ayrı ayrı sorulabilir.

## Merkezî devlet olmadan direnmek

Direnişin dikkat çeken yanı, karşısındaki güçlerin sahip olduğu
merkezî yapıyı taşımamasıdır.[^k1] Bölgede tek bir hükümdar, tek bir
başkent ve tek bir ordu yoktu.

Örgütlenme, yerel birimlerin savaş zamanında geçici olarak
...
Merkezî bir düzeni yenmenin olağan yolu merkezi ele geçirmektir.[^k1]
Başkent alınır, hükümdar esir edilir ve aygıt el değiştirir.

Bu yöntem, kuzeydeki imparatorlukta işlemişti.[^k3] Aynı yöntem burada
uygulanacak bir hedef bulamadı.

Ölçüm şudur.[^k2] **Merkezî bir aygıtın bulunmaması, o düzeni merkezine
vurarak yenme yöntemini de ortadan kaldırır.**

## Ölçümün sınırı

Gözlem, merkezsizliğin genel bir üstünlük olduğu anlamına
gelmez.[^k1] Aynı yapı, saldırı ve uzun süreli seferler için elverişsizdir.
...
Sınır hattının kuzeyi ile güneyi farklı iklim ve bitki örtüsüne
sahiptir.[^k3] Güneye doğru ormanlık alan yoğunlaşır ve yağış artar.

Bu, kuzeyden gelen ordular için lojistik güçlük demekti.[^k1] Sürekli
...
On altıncı yüzyılda bölgeye giren at, kısa sürede yerel savaş düzenine
katıldı.[^k1] Uyum hızlıydı ve kalıcı oldu.

At, hareket kabiliyetini ve baskın menzilini artırdı.[^k2] Bu, sınır
...
Ateşli silahlar bölgede uzun süre belirleyici olmadı.[^k2] Nem, yeniden
doldurma süresi ve arazi, silahın üstünlüğünü sınırlıyordu.
...
Antlaşmalar düzenli aralıklarla yenileniyordu.[^k1] Yenileme, büyük
toplantılarla ve karşılıklı hediyeleşmeyle yapılıyordu.

Bu tören yapısı bir formalite değildi.[^k2] Merkezî bir muhatabın
...
Bölgedeki Avrupa yönetimi sona erdikten sonra kurulan yeni devletler,
sınırı devralmadı.[^k3] Yeni devletler, bölgeyi kendi toprakları
saydılar.
...
Sınır, zamanla kendi kurumlarını üretti.[^k1] İki tarafın da tanıdığı
aracılar, tercümanlar ve pazar yerleri ortaya çıktı; bu kişiler ve
mekânlar, çatışma dönemlerinde bile işlevlerini sürdürdü.

Aracılık bir meslek hâline geldi.[^k3] Sınırın iki yanında da dil bilen,
...
Sınırın iki yanında da karma nüfus oluştu.[^k1] Esir alma, kaçış,
evlilik ve ticaret, iki taraf arasında sürekli bir insan geçişi
üretiyordu; bu geçiş tek yönlü değildi ve her iki tarafta da karma
haneler ortaya çıktı.
...
Üç yüzyıllık sınır düzeni, direnen taraf için de maliyetliydi.[^k1]
Sürekli seferberlik, yerleşim düzenini ve üretim biçimini
belirliyordu.
...
## Manzum kaynağın niteliği

Künyelenen manzum anlatı, karşı tarafın bir askerinin kaleminden
çıkmıştır.[^k2] Metin, düşmanını olumlayan pasajlar da içerir.
...
dayandığı için [Egemenlik](/kavram/egemenlik/) dosyaları
okunabilir.[^k2]
