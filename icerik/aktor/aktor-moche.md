...
baslik: Moche
ozet: >-
  Yazı bırakmamış, hakkında bilinen her şeyi nesnelerinden öğrendiğimiz And
  kıyısı düzeni; atlasta bir siyasi düzenin tümüyle nesne kanıtından
  okunduğu ilk dosya.
donem: "05"
...
etiketler: [moche, and, seramik, sulama, portre-kap, nesne-kaniti]
ilgili:
  - donem-05
...
kaynaklar:
  - anahtar: k1
    tur: ansiklopedi
    ad: "Wikipedia (EN) - Moche culture"
    url: https://en.wikipedia.org/wiki/Moche_culture
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Moche"
    not: "Giris kapisi; havuz kurali geregi makalede en fazla bir tane"
  - anahtar: k2
    tur: birincil
    birincil_tur: nesne
    ad: "Uzengi emzikli kap, oturan figurlu (Moche, 200-500) — MET 307474"
    url: https://collectionapi.metmuseum.org/public/collection/v1/objects/307474
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Moche"
    not: "Muze katalog kaydi; kultur, tarih ve malzeme makine okunur"
  - anahtar: k3
    tur: birincil
    birincil_tur: nesne
    ad: "Portre basli kap (Moche, 5.-6. yy) — MET 308527"
    url: https://collectionapi.metmuseum.org/public/collection/v1/objects/308527
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Moche"
    not: "Ikinci nesne kaydi; portre gelenegini gostermek icin"
...
üslubunun yüzyıllarca sürmesi, atölye örgütlenmesinin sürekliliğini
gösterir.

Cevaplayamadığı sorular da bellidir.[^k3] Hangi kararın ne zaman alındığı,
yöneticilerin adları ve düzenin kendini nasıl adlandırdığı bilinmez ve bu
dosyada bilinmiyor olarak kalır.

## Sulamanın kurduğu düzen

Kıyı vadilerinde tarım, uzun kanallarla ve düzenli bakımla yürütülüyordu.[^k1]
...
Düzenin bıraktığı seramik kaplar, sahneler, figürler ve portreler
taşır.[^k2][^k3] Kaplar üzerindeki tasvirler avcılık, savaş, tören, hastalık
ve gündelik işleri gösterir.

Bu tasvirler bir kayıt işlevi görür ama yazının işlevini görmez.[^k3] Bir
...
Çıkarımın sınırı yazılmalıdır.[^k1] Portrelerin gerçek kişileri mi yoksa
tipleri mi gösterdiği tartışmalıdır; aynı yüzün tekrarı bir kişiyi de bir
kalıbı da işaret edebilir.

## Tasvirlerin okunması sorunu

Sahnelerin ne anlattığı, onları yorumlayanın elindeki çerçeveye
...
Yerleşimlerde yapılan kazılar, seramiğin tek başına vermediği bilgiyi
sağlar.[^k1] Mezarların içeriği, gömü biçimlerindeki farklar ve yapıların
büyüklüğü toplumsal katmanlaşmayı gösterir.
...
Düzenin tek bir merkezî devlet mi yoksa ortak bir kültürü paylaşan birden
çok siyasi birim mi olduğu tartışmalıdır.[^k1] Kanıt her iki okumaya da
açıktır.

Ortak seramik üslubu ve ortak dinî tasvirler, birlik lehine
...
Düzenin bıraktığı metal eserler, yüksek düzeyde uzmanlaşmış bir teknik
birikimi gösterir.[^k3] Altın, gümüş ve bakır alaşımları yüzey kaplama
teknikleriyle işlenmiştir.

Bu teknik, sürekli bir atölye ve uzun bir öğrenme zinciri gerektirir.[^k2]
...
Düzenin sona erişi, kaynaklarda birden çok etkenle açıklanır.[^k1] İklim
...
Düzenin nüfusuna dair sayılar, yerleşim alanı ve tarım kapasitesi
tahminlerinden hesaplanır.[^k1] Doğrudan bir sayım kaydı yoktur ve
olamaz.

Hesaplama bir varsayım zinciri gerektirir: alan başına verim, kişi başına
...
Bölgede sonraki yüzyıllarda kurulan düzenler, bu düzenin kanal
sistemlerini ve bazı teknik geleneklerini devraldı.[^k1] Devralma, siyasi
bir süreklilik kanıtı değildir.

Ayrım korunmalıdır.[^k2] Bir altyapının kullanılmaya devam etmesi, onu
...
Bunun yerine, düğümlü ip kayıt sistemleri ve tasvir gelenekleri
...
Aynı kanıt durumunun başka bir kıtadaki örneği için
[Benin Krallığı](/aktor/benin-kralligi/), bölgenin çok sonraki büyük düzeni
için [İnka İmparatorluğu](/aktor/inka-imparatorlugu/) dosyaları
uygundur.[^k2]

Yazısız kaydın kaynak sayılıp sayılamayacağı için
[Sözlü gelenek kaynak sayılır mı](/tartisma/sozlu-gelenek-kaynak-mi/)
dosyası okunmalıdır.[^k3]
