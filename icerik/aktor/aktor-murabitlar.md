...
baslik: Murâbıtlar
ozet: >-
  Çölün güney kıyısından çıkıp hem bir çölün hem bir denizin iki yakasını
  aynı yönetim altında birleştiren hanedan; atlasta çölün ayıran değil
  bağlayan bir yüzey olduğunun örneği.
donem: "07"
tarih_baslangic: "1040"
tarih_bitis: "1147"
bolge: [afrika, islam-dunyasi, avrupa]
eksen: [siyasi, askeri, dini, ekonomik]
guven_geneli: yaygin
etiketler: [murabitlar, sahra, magrib, endulus, altin, ticaret]
ilgili:
  - donem-07
...
kaynaklar:
  ...
  - anahtar: k2
    tur: ansiklopedi
    ad: "TDV Islam Ansiklopedisi - MAGRIB"
    url: https://islamansiklopedisi.org.tr/magrib
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "MAĞRİB"
    not: "Kuzey yakasinin cografi ve tarihi cercevesi"
  - anahtar: k3
    tur: ansiklopedi
  ...
  - anahtar: k4
    tur: ansiklopedi
    ad: "Wikipedia (EN) - Almoravid dynasty"
...
ve bir yüzyıl içinde çölün kuzey ve güney kıyılarını, ardından bir
denizin öteki yakasını aynı yönetim altında toplayan hanedandır.[^k1]
...
kısa aralıklarla iki kez işledi.

## Çölün bağlayan yüzey olması

Bir çöl, haritada bir ayırıcı gibi görünür.[^k2] Bu görüntü, çölü
geçilemez varsaymaktan doğar.

Bu hanedanın tarihi bunun tersini gösterir.[^k1] Çölün iki kıyısı,
...
Aynı ölçüt denizler için de geçerlidir.[^k3] Bir deniz, gemi düzeni
kurulduğunda kara parçalarından daha hızlı bir bağdır.
...
Çölün güneyindeki bölgelerden gelen altın, kuzeye bu güzergâhlarla
taşınıyordu.[^k2] Hanedanın gelirinin önemli bölümü bu hatta
dayanıyordu.
...
Altın, çölün güneyindeki maden bölgelerinden geliyordu.[^k2] Bu
bölgelerin denetimi hanedanın elinde değildi.

Hanedan, altını üretmiyor taşıma ve güvenlik hattını
denetliyordu.[^k1] Gelir, üretimden değil geçişten alınıyordu.

Bu, geçiş gelirine dayanan düzenlerin ortak zaafını doğurur.[^k4]
Güzergâh değişirse ya da denetim kaybedilirse gelir bir anda kesilir.

## Güneydeki düzenle ilişki

Çölün güneyinde, aynı yüzyıllarda büyük bir siyasi düzen
bulunuyordu.[^k1] İki düzen arasındaki ilişki hem ticari hem
çatışmalıydı.

İlişkinin niteliği kaynaklarda farklı biçimlerde aktarılır.[^k2] Bazı
...
Hanedan, askerî bir hareket olarak değil dinî bir öğretim hareketi
olarak başladı.[^k1] Askerî örgütlenme sonradan eklendi.
...
Öğretiye dayanan meşruiyet, aynı öğreti alanından gelen bir itiraza
açıktır.[^k1] Soy iddiası sınanamaz; öğreti iddiası sınanabilir.

Bu hanedanın sonu tam olarak bu yoldan geldi.[^k2] Aynı bölgeden çıkan
...
Hanedan, denizin kuzeyindeki bölgeye yerel yöneticilerin daveti üzerine
geçti.[^k3] Bölge o sırada çok sayıda küçük birime bölünmüştü.
...
Denizin iki yakası aynı yönetim altına girdi ama aynı biçimde
yönetilmedi.[^k3] Kuzey yakası yerleşik, kentli ve yazılı geleneği güçlü
bir bölgeydi.

Güney yakasında göçebe örgütlenme ağırlıktaydı.[^k2] İki bölgenin vergi
ve askerlik düzenleri farklı kaldı.

Bu fark, birliğin kalıcı olmasını zorlaştırdı.[^k1] Tek bir yönetim
altında olmak, tek bir düzen içinde olmak anlamına gelmez.

## Kültürel etki

Birlik dönemi, iki yaka arasındaki insan ve metin hareketini
...
Hanedan, on ikinci yüzyıl ortasında ortadan kaldırıldı.[^k1] Yerini alan
hareket, aynı çöl kenarı bölgesinden çıktı.
...
Çöl kenarı kuşağının bu özelliği rastlantı değildir.[^k2] Kuşak, iki
farklı üretim düzeninin temas ettiği yerdir.
...
Çölü geçen kervanlar, kuyu ve vaha zincirlerine bağlıydı.[^k2] Zincirin
tek bir halkasının denetimi, bütün güzergâhı denetlemeye yeter.
...
Hanedanın askerî gücü, çöl topluluklarının kendi örgütlenmesine
dayanıyordu.[^k1] Bu örgütlenme, uzun mesafeli hareket için elverişliydi.
...
Hanedan, kuzey yakada yeni bir merkez kurdu.[^k2] Merkez, çöl
güzergâhının kuzey ucu ile kıyı arasında konumlandı.
...
Hanedan, tek bir hukuk ekolünü öne çıkardı ve öğretimini
destekledi.[^k1] Bu, geniş bir alanda tek tip hukuk uygulaması anlamına
geliyordu.
...
Hanedanın adı, sınır boylarındaki müstahkem yerleşmelere verilen
addan gelir.[^k1] Ad, bir soyu değil bir kurumu işaret eder.
...
Güneydeki düzenle ilişkinin niteliği de belirlenmez.[^k2] Kaynaklar
örtüşmez ve dosya bir sonuca bağlanmaz.
...
[İbn Haldûn](/dusunur/ibn-haldun/) dosyaları uygundur; aynı kuşağı aynı
soruyla ele alır.[^k1]

Dış ticaretin siyasi üstünlüğe dönüşmesi için
[Silahlı ticaret](/kavram/silahli-ticaret/), yetkinin neye dayandığı
için [Meşruiyet](/kavram/mesruiyet/) dosyaları okunabilir.[^k4]
