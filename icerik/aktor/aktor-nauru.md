...
baslik: Nauru
ozet: >-
  Toprağının dörtte üçü ihraç edilen ve elde edilen gelirin yönetimi
  bir kuşakta tükenen ada devleti; atlasta bir kaynağın hem gelir hem
  yaşam alanı olduğu tek örnek.
donem: "13"
tarih_baslangic: "1888"
tarih_bitis: "2026"
bolge: [okyanusya]
eksen: [ekonomik, siyasi, demografik]
guven_geneli: yaygin
etiketler: [nauru, fosfat, vesayet, kaynak-laneti, ada, okyanusya]
ilgili:
  - donem-13
  - donem-14
...
kaynaklar:
  - anahtar: k1
    tur: ansiklopedi
    ad: "Wikipedia (EN) - Nauru"
    url: https://en.wikipedia.org/wiki/Nauru
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Nauru"
  ...
  - anahtar: k2
    ...
    not: "Adanin bagli oldugu vesayet duzenini kuran metin; 22. madde"
  - anahtar: k3
    tur: birincil
    birincil_tur: belge
    ...
    not: "Karsilastirma icin; ayni okyanusta toprak devrini yasaklayan metin"
...
adadan oluşan devlettir.[^k1] Ada, on dokuzuncu yüzyıl sonunda bir Avrupa
devletince ilhak edildi ve o tarihten sonra yönetimi birkaç kez el
değiştirdi.

Yirminci yüzyıl başında adada yüksek kaliteli fosfat yatağı
...
Madencilik olağan olarak bir alanı kullanır ve geri kalanı bırakır.[^k1]
Burada çıkarılacak malzeme, adanın yüzeyinin kendisiydi.

Çıkarım ilerledikçe kullanılabilir alan daraldı.[^k1] Bugün adanın iç
bölgesinin büyük bölümü, kayalık sütunlar hâlinde kalmış ve yerleşime
elverişsiz durumdadır.

Ölçüm şudur.[^k3] **Bir kaynak, çıkarıldığı yerin kendisiyse, gelir ile
yaşam alanı arasında doğrudan bir değiş tokuş kurulur ve bu değiş tokuş
geri alınamaz.**

## Vesayet dönemi

Ada, Birinci Dünya Savaşı'ndan sonra vesayet düzenine bağlandı.[^k2]
Metnin öngördüğü üç dereceden en alttakine yerleştirildi.

Bu derece, emanetçinin kendi toprağının parçası gibi yönetmesini
öngörüyordu.[^k2] Uygulamada yönetim üç devlet arasında paylaşıldı.

Fosfat işletmesi de aynı üç devletin ortak şirketine bırakıldı.[^k1]
Emanetçi ile işletmeci aynı taraflardı.
...
Ada 1968'de bağımsız oldu.[^k1] Bağımsızlık, fosfat işletmesinin de
devralınmasıyla birlikte gerçekleşti.
...
Bağımsızlık sonrası gelir hızla arttı.[^k1] Kişi başına gelir, kısa bir
dönem için dünyanın en yüksekleri arasında ölçüldü.

Gelirin bir bölümü, yatak tükendiğinde kullanılmak üzere bir fona
ayrıldı.[^k1] Fon, yurt dışında gayrimenkul ve yatırım araçlarına
yönlendirildi.

Fon bir kuşak içinde büyük ölçüde eridi.[^k1] Kötü yatırım kararları,
yönetim zaafı ve dış danışmanlık ilişkileri nedenler arasında
sayılır.
...
Uyumsuzluk tek cümleyle ifade edilebilir.[^k3] **Bir gelir kaynağı, onu
...
Adadaki fosfat, deniz kuşlarının uzun dönemli birikiminden
oluşmuştu.[^k1] Oluşum süresi jeolojik ölçektedir.
...
Fosfat geliri azaldıktan sonra ada birden çok gelir modeli denedi.[^k1]
Bunlar arasında çevrimdışı mali hizmetler ve dış politikada tanıma
kararlarının pazarlık konusu edilmesi sayılır.
...
Çıkarılmış alanların onarılması gündeme geldi ve kısmen
başlatıldı.[^k1] Onarım maliyeti, elde edilen gelirle
karşılaştırılabilir büyüklüktedir.

Bu, bir hesaplama sorusu doğurur.[^k3] Bir kaynaktan elde edilen gelir,
...
Adada, ilhaktan önce akrabalık gruplarına dayanan bir toplumsal yapı
bulunuyordu.[^k1] Toprak, bu gruplar arasında paylaşılmıştı ve mülkiyet
kayıtları sözlü aktarımla sürdürülüyordu.

Fosfat çıkarımı bu düzeni doğrudan etkiledi.[^k3] Çıkarılacak alanın
...
Kaydedilen mülkiyet düzeni, önceki düzenle birebir örtüşmedi.[^k1]
Kolektif haklar bireysel paylara çevrildi ve paylar kayıt altına
alındı.
...
Ada savaş sırasında işgal edildi ve nüfusun büyük bölümü başka bir
adaya zorla nakledildi.[^k1] Nakledilenlerin önemli bir bölümü geri
dönemedi.
...
Kaynak geliri ile kurumsal kapasite arasındaki uyumsuzluk bir kural
olarak sunulmaz.[^k3] Karşı örnekler bulunduğu ve incelenmediği
yazılır.
...
[Samoa Krallığı](/aktor/samoa-kralligi/) okunabilir.[^k3]
