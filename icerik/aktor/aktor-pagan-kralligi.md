---
id: aktor-pagan-kralligi
tip: aktor
baslik: Pagan Krallığı
ozet: >-
  İki yüz yılda binlerce tapınak yaptıran ve bu yapı programının kendisiyle
  çöken krallık; atlasta dinî bağışın maliye üzerindeki etkisinin en açık
  ölçülebildiği örnek.
donem: "07"
tarih_baslangic: "1044"
tarih_bitis: "1287"
bolge: [dogu-asya, guney-asya]
eksen: [siyasi, dini, ekonomik, kulturel]
guven_geneli: tartismali
etiketler: [pagan, bagan, tapinak, vakif, budizm, sulama]
ilgili:
  - donem-07
...
kaynaklar:
  - anahtar: k1
    tur: ansiklopedi
    ad: "TDV Islam Ansiklopedisi - BURMA"
    url: https://islamansiklopedisi.org.tr/burma
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "BURMA"
    not: "Turkce akademik ansiklopedi maddesi"
  - anahtar: k2
    tur: birincil
    birincil_tur: eser
    ad: "The Glass Palace Chronicle of the Kings of Burma — Pe Maung Tin ve G. H. Luce cevirisi (1923)"
    url: https://archive.org/details/in.gov.ignca.9481
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Glass palace chronicle"
    not: "Kralligin saray anlatisi; sonraki bir hanedanin derlemesi"
  - anahtar: k3
    tur: ansiklopedi
    ad: "Wikipedia (EN) - Pagan Kingdom"
    url: https://en.wikipedia.org/wiki/Pagan_Kingdom
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Pagan Kingdom"
...
Krallığın gücü, nehir havzasında kurulan sulama düzenine dayanıyordu.[^k3]
Sulama, kuru mevsimde de ürün alınmasını sağlar ve böylece tek bir bölgeden
büyük bir fazla çıkarılabilir hale gelir.

Sulama düzeni sürekli bakım ister ve bakım merkezî bir örgütlenme
...
Krallığın en görünür özelliği, iki yüzyıl boyunca sürdürülen yoğun tapınak
yapımıdır.[^k2][^k3] Ova bugün hâlâ binlerce yapı kalıntısı taşır.

Bu ölçekte bir yapı programı, sürekli bir işgücü ve sürekli bir gelir
gerektirir.[^k3] Yapıların kendisi, krallığın maliyesinin bir dönem ne kadar
...
Tapınaklara yapılan bağışlar yalnızca yapı değil, toprak ve o toprağa bağlı
emeği de kapsıyordu.[^k3] Bağışlanan toprak vergi dışı kalıyordu.

Mekanizma birikimlidir. Her bağış, devletin vergi tabanını kalıcı olarak
küçültür; bağış geri alınamadığı için küçülme geri döndürülemez.[^k1][^k3]
...
## Meşruiyet ile maliye arasındaki gerilim

Bağış, hükümdarın dinî meşruiyetini doğrudan artırıyordu.[^k2] Bir hükümdarın
ne kadar çok yapı yaptırdığı, ne kadar iyi bir hükümdar sayıldığının
ölçütüydü.

Ölçütün kendisi tuzağı kuruyordu. Meşruiyet için gereken davranış, maliyeyi
...
Krallığın sonu genellikle dışarıdan gelen bir askerî baskıyla
...
Krallığın çevre bölgelerle ilişkisi doğrudan yönetim değil, katmanlı
...
Böyle bir düzenin zayıflığı da açıktır. Merkez zayıfladığında çevre
birimler bağlılığı yenilemez ve düzen sessizce dağılır;[^k1] tek bir yenilgi
gerekmez.

## Dilin ve yazının durumu

Krallık döneminde bölgenin yazı düzeni kurumsallaştı ve bağış kayıtları
taşa yazıldı.[^k3] Bu kayıtlar, saray anlatısından bağımsız bir kanıt
katmanı oluşturur.

Taş kayıtların değeri, saray anlatısıyla karşılaştırılabilir
...
bulunuyordu.[^k1][^k3] İki düzen de sulamaya dayanıyor, ikisi de büyük dinî
yapı programları yürütüyordu.

Benzerlik tesadüf değildir ama doğrudan bir alışverişin kanıtı da
...
Krallığın nüfusuna dair sayılar, saray anlatısından ve sonraki
...
Dönemin taş kayıtlarının doğrulanabilir bir tam metin derlemesi
bulunamamıştır ve bu, dosyanın en önemli kısıtıdır.[^k3] Okur, buradaki
...
Bağış ile meşruiyet arasındaki bağ için [Meşruiyet](/kavram/mesruiyet/),
yapı kalıntılarının kanıt değeri için
[Arkeolojik kanıt](/kavram/arkeolojik-kanit/) dosyaları uygundur.

Çöküşün dış sebebi için [Moğol fetihleri](/olay/mogol-fetihleri/), çöküş
açıklamalarının nasıl tartıldığı için
[İklim ve çöküş](/tartisma/iklim-ve-cokus/) dosyaları okunabilir.
