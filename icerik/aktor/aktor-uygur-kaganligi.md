---
id: aktor-uygur-kaganligi
tip: aktor
baslik: Uygur Kağanlığı
ozet: >-
  Bozkır düzenini kurup sonra yerleşikliğe geçen, kendi taş kaydını bırakan ve
  bir din değişimini devlet kararıyla yapan kağanlık; atlasta bozkır ile
  yerleşiklik arasındaki geçişin en açık örneği.
donem: "06"
tarih_baslangic: "744"
tarih_bitis: "0840"
...
guven_geneli: yaygin
etiketler: [uygur, kaganlik, ordu-balik, manihaizm, turfan, bozkir]
ilgili:
  - donem-06
...
kaynaklar:
  ...
  - anahtar: k2
    tur: birincil
    birincil_tur: kitabe
    ad: "The Orkhon Inscriptions - Thomsen okumasindan ceviri, E. D. Ross (1930)"
    url: https://archive.org/details/orkhoninscriptions
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Orkhon"
    not: "Ayni vadideki onceki duzenin kendi kaydi; gecisin karsi tarafi"
  - anahtar: k3
    tur: birincil
    birincil_tur: eser
    ad: "F.W.K. Müller, Uigurica (1908)"
    url: https://archive.org/details/Muller_uigurica
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Uigurica"
    not: "Turfan elyazmalarindan Uygurca metinler; katalogda yazar alani bos, baslik yazari tasiyor"
  - anahtar: k4
    tur: ansiklopedi
    ad: "Wikipedia (EN) - Uyghur Khaganate"
    url: https://en.wikipedia.org/wiki/Uyghur_Khaganate
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Uyghur Khaganate"
...
anlatır.[^k1][^k4] Üç dosya birlikte okunduğunda, bozkır ile yerleşik düzenin
birbirini nasıl beslediği görünür.
...
Kağanlığın kurduğu merkez, bozkır düzenlerinde seyrek görülen bir şeydi:
sürekli ve surlu bir başkent.[^k1][^k4] Bir bozkır düzeninin sabit bir merkeze
bağlanması, hareket kabiliyetini azaltır ve savunma yükümlülüğü yaratır.

Bu tercihin iki sonucu birlikte okunmalıdır. Sabit merkez, vergi toplamayı ve
ticaret gelirini düzenli hâle getirir; aynı merkez, düşmanın nereye
saldıracağını da belirler.[^k1] Hareketliliğini bırakan bir düzen,
hareketliliğin verdiği korumayı da bırakır.

Kağanlığın sonu bu ikinci sonucun kaydıdır. Kuzeyden gelen bir baskı
karşısında merkez düşmüş ve düzen dağılmıştır;[^k1][^k4] dağılan nüfusun bir
bölümü güneybatıya, vahalar kuşağına yerleşmiştir.
...
Kağanlığın ve ardından vahalar kuşağına yerleşen topluluğun bıraktığı
elyazmaları, bölgenin en zengin metin külliyatlarından birini
oluşturur.[^k3] Bu külliyat çeviri metinler, dinî eserler ve idari kayıtlar
içerir.

Metin bırakmanın kendisi bir yerleşiklik göstergesidir. Elyazması üretimi
...
Kağanlığın güneydeki yerleşik komşuyla ilişkisi askerî olduğu kadar
...
gösterir.[^k4] Bir tarafın ötekine bağımlı olması ile iki tarafın birbirine
bağımlı olması ayrı şeylerdir ve kaynaklar burada ikincisini kaydeder.
...
Bu düzenin nüfusuna ve ordu büyüklüğüne dair sayılar komşu kayıtlarından
gelir.[^k1][^k4] Bir düzenin büyüklüğünün yalnızca rakiplerinin kaydından
bilinmesi, sayıların yönünü de belirler.

Rakip kaydında bir düzen iki yönde çarpıtılabilir. Tehdidin büyüklüğü,
...
Kağanlığın denetlediği kuşak, doğu ile batı arasındaki kara ticaretinin
...
geçer;[^k4] savaşlar ve elçilikler ayrıntılı, iç düzen ise belirsiz kalır.

Bölgenin kendi kayıtlarına bağlanmak bu dengeyi değiştirir ama tek başına
düzeltmez. Kendi kaydı da bir yönetimin kaydıdır ve kendi taraflılığını
...
Güneydeki yerleşik komşu için [Tang Hanedanı](/aktor/tang-hanedani/), düzenin
biçimi için [Bozkır imparatorluğu](/kavram/bozkir-imparatorlugu/) dosyaları
uygundur.

Bölgedeki ticaret ağının kendisi için
[İpek Yolu'nun kuruluşu](/olay/ipek-yolu-kurulusu/), aynı yüzyıldaki askerî
karşılaşma için [Talas Savaşı](/olay/talas-savasi/) dosyaları okunabilir.
