---
id: aktor-vijayanagara
tip: aktor
baslik: Vijayanagara
ozet: >-
  Kendi taş yazıtlarını binlerce sayıda bırakan ama gündelik hayatı
  yalnızca yabancı ziyaretçilerin anlattığı imparatorluk; atlasta iki
  kanıt türünün birbirini tamamladığı örnek.
donem: "08"
tarih_baslangic: "1336"
tarih_bitis: "1646"
bolge: [guney-asya]
eksen: [siyasi, ekonomik, askeri, dini]
guven_geneli: yaygin
etiketler: [vijayanagara, kitabe, hindistan, ticaret, at, kanit]
ilgili:
  - donem-08
  - donem-09
...
kaynaklar:
  - anahtar: k1
    tur: ansiklopedi
    ad: "Wikipedia (EN) - Vijayanagara Empire"
    url: https://en.wikipedia.org/wiki/Vijayanagara_Empire
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Vijayanagara"
    not: "Giris kapisi; havuz kurali geregi makalede en fazla bir tane"
  - anahtar: k2
    tur: birincil
    birincil_tur: tanik
    ad: "Robert Sewell, A Forgotten Empire (Vijayanagar) (1900), archive.org"
    url: https://archive.org/details/aforgottenempir00paesgoog
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Vijayanagar"
    not: "Portekizli ziyaretcilerin 16. yuzyil anlatilarinin cevirisini icerir; taniklik olarak kullanilir"
  - anahtar: k3
    tur: birincil
    birincil_tur: tanik
    ad: "1911 Encyclopaedia Britannica — Vijayanagar maddesi, Wikisource"
    url: https://en.wikisource.org/wiki/1911_Encyclop%C3%A6dia_Britannica/Vijayanagar
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Vijayanagar"
...
güneyinde kurulan ve on yedinci yüzyıl ortasına kadar adı süren
imparatorluktur.[^k1] Merkezi, bir nehir kıvrımındaki kayalık arazide
kurulmuş ve imparatorluğa adını veren şehirdi; bugün o alan büyük
ölçüde harabe hâlindedir.

Devlet, kuzeyden gelen askerî baskının yoğunlaştığı bir dönemde
...
Yazıtlar taş ve bakır levhalar üzerindedir ve sayıları binlercedir.[^k1]
İçerikleri büyük ölçüde bağış, vakıf ve toprak tahsisi kayıtlarıdır.

Bu, belirli soruları cevaplar.[^k3] Hangi tapınağa ne verildi, hangi
köyün geliri kime tahsis edildi, hangi hükümdar hangi yılda tahttaydı —
bunlar yazıtlardan okunur.

Başka soruları hiç cevaplamaz.[^k2] Şehirde nasıl yaşandığı, pazarın
nasıl işlediği, ordunun nasıl göründüğü yazıtlarda yoktur; bu bilgiler
yalnızca ziyaretçi anlatılarından gelir.

## Bölünmenin nedeni

Bölünme rastlantı değildir.[^k1] Yazıt, kalıcı olması istenen bir kaydı
taşa geçirmek içindir; kalıcılık istenen şey ise mülkiyet ve bağıştır.
...
On altıncı yüzyılda şehri ziyaret eden yabancıların bıraktığı iki uzun
anlatı vardır.[^k2] Anlatılar pazarı, sarayı, orduyu ve törenleri
ayrıntılı olarak betimler.
...
Yazıtlar ile anlatılar birbirini denetleyebilir.[^k3] Bir yazıtta adı
...
İmparatorluğun en çok anılan ithalat kalemi attı.[^k2] Atlar deniz
yoluyla batıdan getiriliyordu.

Nedeni iklimdir.[^k1] Yarımadanın güneyinde savaş atı yetiştirmek
zordur ve yetiştirilen atlar aynı dayanıklılıkta değildir.

Bu, siyasi bir bağımlılık üretir.[^k3] Askerî gücün temel unsuru
ithal edilen bir maldı ve o malın geldiği hattı denetleyenler siyasi
etki kazanıyordu.

## Bağımlılığın sonucu

At tedarikinin denetimi, kıyı limanlarını stratejik hâle
...
Başkent, kayalık ve savunulabilir bir arazide kuruldu.[^k2] Ziyaretçi
anlatıları şehrin büyüklüğünü ve pazar yoğunluğunu vurgular.
...
Şehrin çevresinde geniş bir su toplama ve dağıtım sistemi
kuruldu.[^k1] Kanallar, havuzlar ve barajlar arazinin eğimine göre
düzenlenmişti.
...
Yazıtların büyük bölümü tapınaklara yapılan bağışları
kaydeder.[^k1] Tapınaklar toprak sahibiydi, kredi veriyordu ve emek
örgütlüyordu.

Bu, tapınakları dinî kurum olduğu kadar iktisadi kurum yapar.[^k3]
...
İmparatorluk, merkeze bağlı bölgesel valilikler biçiminde
örgütlenmişti.[^k1] Valiler asker beslemek ve gelir göndermekle
yükümlüydü.
...
İmparatorluk, on altıncı yüzyıl ortasında kuzeydeki devletlerin
...
Devlet 1565'te sona ermedi.[^k1] Hanedan güneye çekildi ve adı seksen
yıl daha sürdü.
...
Yenilgiye yol açan ittifak, kuzeydeki beş sultanlığın birleşmesiyle
kuruldu.[^k1] Bu devletler o güne kadar birbirleriyle de savaşmıştı.

İttifakın kurulması, yaygın bir çerçeveyi zorlaştırır.[^k3] Çatışma
...
İmparatorluk kendi kayıtlarında tek bir adla anılmaz.[^k1] Bugün
kullanılan ad, başkentin adından türetilmiştir.
...
Taş yazıtların yanında bakır levha üzerine yazılmış belgeler de
vardır.[^k1] Bunlar genellikle toprak bağışlarının resmî kaydıdır ve
bağış yapılan kişide kalırdı.

İki taşıyıcı farklı işlev görür.[^k3] Taş yazıt kamuya açık ve
...
Yazıtlar tek bir dilde değildir.[^k1] Bölgenin başlıca dilleri ve
klasik dil, aynı imparatorluk içinde ve çoğu zaman aynı bölgede birlikte
kullanılmıştır.
...
Hükümdarların listesi ve saltanat süreleri verilmez.[^k1] Yazıtlar bu
