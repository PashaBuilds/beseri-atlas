---
id: aktor-yeni-hebridler-ortak-yonetimi
tip: aktor
baslik: Yeni Hebridler ortak yönetimi
ozet: >-
  İki imparatorluğun aynı adaları paralel iki idareyle birlikte
  yönettiği düzen; atlasta ikili yönetimin adada yaşayanları hangi
  hukukun dışına attığının örneği.
donem: "14"
tarih_baslangic: "1906"
tarih_bitis: "1980"
bolge: [okyanusya, avrupa]
eksen: [siyasi, ekonomik, kulturel, demografik]
guven_geneli: yaygin
etiketler: [yeni-hebridler, vanuatu, ortak-yonetim, melanezya, somurge-idaresi]
ilgili:
  - donem-14
  - donem-15
...
kaynaklar:
  - anahtar: k1
    tur: ansiklopedi
    ad: "Wikipedia (EN) - New Hebrides"
    url: https://en.wikipedia.org/wiki/New_Hebrides
    erisim_tarihi: 2026-08-26
    dogrulama_dizesi: "New Hebrides"
    not: "Giris kapisi; havuz kurali geregi makalede en fazla bir tane"
  - anahtar: k2
    tur: birincil
    birincil_tur: tanik
    ad: "James Cook - A Voyage towards the South Pole, and Round the World (1777, John Carter Brown Library taramasi)"
    url: https://archive.org/details/voyagetowardssou02cook
    erisim_tarihi: 2026-08-26
    dogrulama_dizesi: "Voyage"
    not: "Adalarin haritalandigi seferin anlatisi"
  - anahtar: k3
    tur: birincil
    birincil_tur: tanik
    ad: "William T. Wawn - The South Sea Islanders and the Queensland Labour Trade (1893)"
    url: https://archive.org/details/southseaislander00wawnuoft
    erisim_tarihi: 2026-08-26
    dogrulama_dizesi: "Queensland"
    not: "Adalardan isci toplayan tarafin anlatisi"
...
tarafından birlikte yönetilmesidir.[^k1] İki devlet toprağı
paylaşmadı; ikisi de bütünü yönetti.
...
İki devletin adalarda yerleşimcileri ve ticari çıkarları vardı.[^k1]
Hiçbiri diğerinin tek başına yönetmesini kabul etmedi.

Önce ortak bir deniz komisyonu kuruldu.[^k2] Bu geçici düzen
...
Yönetim ikiye bölünmedi, ikiye katlandı.[^k1] İki ayrı yüksek görevli,
iki ayrı polis gücü, iki ayrı okul düzeni ve iki ayrı sağlık hizmeti
vardı.

Yerleşimciler kendi devletlerinin idaresine bağlıydı.[^k2] Hangi
...
Asıl mesele buradadır.[^k1] Adaların kendi halkı, iki devletten
hiçbirinin vatandaşı sayılmadı.
...
Ortak mahkeme iki devletin birer yargıcından oluşuyordu.[^k1] Başkan,
iki tarafın da olmadığı üçüncü bir ülkeden atanıyordu.
...
Düzenin en yoğun işi toprakla ilgiliydi.[^k1] Yerleşimciler adalarda
geniş araziler edinmişti.
...
Adalar, bölgedeki işçi toplama düzeninin başlıca kaynaklarındandı.[^k3]
Ortak yönetimden önceki dönemde çok sayıda kişi buradan taşındı.

Bu geçmiş, ortak yönetimin kurulmasının nedenlerinden biridir.[^k1]
...
İki idare iki farklı dilde çalıştı.[^k1] Okullar, mahkemeler ve
kayıtlar buna göre ayrıştı.
...
Dönem hakkındaki arşiv iki ayrı yerde ve iki ayrı dildedir.[^k1] Her
idare kendi kaydını tuttu.
...
Adalar, on sekizinci yüzyılın sonunda bir sefer sırasında ölçülüp
adlandırıldı.[^k2] Verilen ad, uzaktaki bir ada grubuna benzetmeden
türetilmişti.
...
Haritalanma ile yerleşim arasında yaklaşık bir yüzyıl vardır.[^k2]
Aradaki dönemde adalara gelenler tüccarlar ve misyonerlerdi.
...
On dokuzuncu yüzyılda ada nüfusu belirgin biçimde azaldı.[^k1]
Azalmanın başlıca nedeni, dışarıdan gelen hastalıklardı.

İşçi toplama düzeni ikinci bir etkendi.[^k3] İki etki birbirini
...
Misyoner örgütleri adalarda okul ve sağlık hizmeti kurdu.[^k1] Bu
hizmetler, iki idarenin sağladıklarından çoğu yerde önce geldi.
...
İki idare kendi para birimini kullandı.[^k1] Adada iki para birden
dolaşıyordu.
...
İkinci büyük savaş sırasında adalar büyük bir askerî üsse
dönüştü.[^k1] Çok sayıda asker ve büyük miktarda malzeme geldi.

Adalıların bu dönemde gördüğü, önceki kırk yılda gördüklerinden
...
Yirminci yüzyılın ortasından itibaren toprak temelli yerel hareketler
güçlendi.[^k1] Talep, atalardan kalan toprakların iadesiydi.
...
Düzen yirminci yüzyılın sonunda bağımsızlıkla sona erdi.[^k1] Yeni
devlet kurulurken ada topluluğu adını değiştirdi.
...
Yeni devletin ilk kararlarından biri toprakla ilgiliydi.[^k1] Sömürge
döneminde edinilen topraklar üzerinde geleneksel sahiplerin hakkı
tanındı.

Bu karar, ikili yönetimin çözemediği sorunu bir hamlede
...
Bu yönetim biçimi tek örnek değildir.[^k1] Başka bölgelerde de iki
devletin aynı toprağı birlikte yönettiği düzenler kuruldu.
...
Düzen yetmiş yılı aşkın süre devam etti.[^k1] Verimsiz sayılmasına
rağmen değiştirilmedi.
...
Adalardaki toplulukların kendi iç düzenleri ayrıntılı ele
alınmaz.[^k2] Adaların her birinde farklı diller ve farklı yetki
biçimleri bulunması, bunu tek bir dosyada toplanamaz hâle getirir.

Ada topluluklarının kendi kaydından bir birincil metin
...
İşçi toplama düzeni için
[Pasifik işçi toplama düzeni](/kavram/pasifik-isci-toplama/), yönetim
biçimleri için [Himaye düzeni](/kavram/himaye-duzeni/) ve
[Vesayet yönetimi](/kavram/vesayet-yonetimi/) dosyaları uygundur.[^k3]
