...
id: donem-06
tip: donem
baslik: 650–1000 — İslam'ın yayılışı, Abbasi, Karolenj, Tang
ozet: >-
  Üç büyük siyasi merkezin — Abbasi, Karolenj ve Tang — aynı yüzyıllarda kurulup
  birbirinden habersiz benzer yönetim sorunlarını çözmeye çalıştığı dönem.
donem: "06"
tarih_baslangic: "650"
tarih_bitis: "1000"
eksen_cumlesi: >-
  Geç antik düellonun bıraktığı boşluğu yeni bir evrensel dinin ve onun kurduğu
  imparatorluğun doldurduğu, Avrupa ile Çin'in kendi merkezlerini yeniden kurduğu dönem.
bolge: [avrupa, islam-dunyasi, dogu-asya, guney-asya, afrika, kuresel]
eksen: [siyasi, dini, ekonomik, askeri, kulturel]
guven_geneli: yaygin
etiketler: [abbasi, karolenj, tang, hilafet, erken-ortacag]
ilgili:
  - donem-05
  - donem-07
...
serit:
  - bolge: islam-dunyasi
    ...
    satir: >-
      Hz. Peygamber'in amcası Abbas'ın soyundan gelen hanedan 750-1258 arasında
      hüküm sürdü; Râşidîn ve Emevî fetihleri Roma'nın güney topraklarını almıştı.
    anahtar: k1
  - bolge: avrupa
    baslik: Karolenj ve Makedon
    satir: >-
      800'de imparator unvanı Şarlman ile Batı Avrupa'da diriltildi; 867'de
      Makedon hanedanının yükselişi Bizans'ta yeni bir altın çağ açtı.
    anahtar: k2
  - bolge: dogu-asya
  ...
  - bolge: guney-asya
    ...
    satir: >-
      Güney Asya, Basra Körfezi ve Hint Okyanusu üzerinden Abbasi ticaret
      sistemine bağlanan uçlardan biriydi.
    anahtar: k1
  - bolge: afrika
    baslik: Kuzey Afrika'nın dönüşümü
    satir: >-
      Kuzey Afrika, Emevî fetihleriyle Akdeniz'in Roma düzeninden çıkıp İslam
      siyasi coğrafyasının parçası hâline geldi.
    anahtar: k2
  - bolge: amerika
    baslik: Bağımsız çizgi
    satir: >-
      Amerika kıtası bu dönemde Eski Dünya'nın siyasi ve ticari sisteminin
      tamamen dışındaydı.
    anahtar: k4
kaynaklar:
  - anahtar: k1
  ...
  - anahtar: k3
    tur: ansiklopedi
    ad: "TDV Islam Ansiklopedisi - BEYTULHIKME"
    url: https://islamansiklopedisi.org.tr/beytulhikme
    erisim_tarihi: 2026-08-20
    dogrulama_dizesi: "BEYTÜLHİKME"
    not: "Ceviri ve derleme kurumunun kendi maddesi"
  - anahtar: k4
    tur: veri
