...
baslik: Aşoka
ozet: >-
  Fermanlarını kayaya ve sütuna kazdırmış hükümdar; metinleri bugüne kadar
  ulaştı ama yazıldıkları alfabe yüzyıllarca okunamadı ve metinlerdeki ad
  ile hükümdarın adı doğrudan eşleşmiyor.
tarih_baslangic: "-0268"
tarih_bitis: "-0232"
bolge: [guney-asya]
eksen: [siyasi, dini, kulturel]
guven_geneli: yaygin
etiketler: [asoka, ferman, kitabe, brahmi, dhamma]
ilgili:
...
kaynaklar:
  - anahtar: k1
    ...
    dogrulama_dizesi: "Inscriptions of Asoka"
  ...
  - anahtar: k2
    ...
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Edicts of Asoka in Mysore"
    not: "Ayri bir bolgedeki fermanlarin bagimsiz nesri; katalog yazari Rice, Benjamin Lewis"
  - anahtar: k3
    tur: akademik
    ad: "Stanford Encyclopedia of Philosophy - Buddha"
    url: https://plato.stanford.edu/entries/buddha/
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Buddha"
    not: "Fermanlarin dini baglami icin; bagimsiz alan adi"
...
bölgelerine dağıtılmış duyurulardır.[^k1][^k2]
...
Metinler bugüne ulaştı ama yazıldıkları alfabe uzun süre okunamadı.[^k1]
Fermanlar, ancak on dokuzuncu yüzyılda yapılan çözümleme çalışmalarından sonra
anlaşılabilir hâle geldi.

Bu, [İndus Vadisi](/aktor/indus-vadisi/) dosyasındaki durumun tam tersidir ve
ikisi birlikte okunmalıdır. Orada işaretler var, okunamıyor; burada işaretler
vardı, okunamıyordu ve sonra okundu.[^k1]

İki dosyanın yan yana durması bir şeyi görünür kılar: bir uygarlık hakkında
bilinenlerin miktarı, o uygarlığın ne kadar yazdığına değil, yazdıklarının
bugün okunabilir olup olmadığına bağlıdır. Aynı miktarda yazı, çözülmüş bir
alfabede kütüphane, çözülmemiş bir alfabede sessizliktir.[^k1]

## Metindeki ad sorunu

Fermanların büyük bölümünde geçen ad, hükümdarın bugün bilinen adı değil bir
unvan biçimidir.[^k1][^k2] Metinlerin belirli bir hükümdara atfedilmesi, başka
kaynaklarla yapılan eşleştirmeye dayanır.

Bu, ilk bakışta teknik bir ayrıntı gibi görünür ama sonucu büyüktür. Elimizde
...
Fermanların bir kısmı, imparatorluğun batı ucunda yerel dillerde de
kazınmıştır.[^k1] Aynı duyurunun birden fazla dilde verilmesi, muhatabın kim
...
dildeki karşılığı, bilinmeyen dildeki metnin çözülmesine yardım eder;[^k1]
[İndus Vadisi](/aktor/indus-vadisi/) dosyasında böyle bir karşılaştırma
metninin bulunmaması, çözümün önündeki engeller arasında sayılmıştı.
...
aldığına dair bir işarettir.[^k1][^k3]
...
tamamlanmasından doğar ve neşirler bu tamamlamaları ayrı ayrı gösterir.
...
birbirine yakın dönemlerden gelir ama tamamen farklı türdedir — biri kamuya
kazınmış duyuru, öteki yöneticiye yönelik el kitabı.[^k1]

## Duyurunun mekânı

Fermanların nereye kazındığı, ne yazdığı kadar bilgi taşır.[^k1][^k2] Yol
...
yönetimin kendi içinde ne konuştuğunu gösterir.[^k1]

Bu ikisinin farkı, tek bir kaynak türüne dayanan tarih okumasının neyi
kaçıracağını gösterir. Yalnızca fermanlara bakan biri, yönetimi kendi ilan
...
kaynak durumunu gösterir: biri hiç okunamayan, öteki sonradan okunan.[^k1]

Yazının ne olduğu ve nasıl çözüldüğü için [Yazı sistemi](/kavram/yazi-sistemi/),
