...
baslik: Bîrûnî
ozet: >-
  Hârizm'de yetişen, takvimleri ve halkların kayıtlarını karşılaştırarak yazan
  âlim; Hindistan üzerine eserinde neyi okuduğunu neyi duyduğundan ayırarak
  kaydettiği için kaynak eleştirisinin erken örneklerinden sayılır.
tarih_baslangic: "0973"
tarih_bitis: "1048"
bolge: [orta-asya, islam-dunyasi, guney-asya]
eksen: [felsefi, kulturel, dini]
etiketler: [biruni, takvim, kaynak-elestirisi, hindistan, karsilastirma]
guven_geneli: yaygin
ilgili:
  - dusunur-ibn-sina
  - dusunur-farabi
...
kaynaklar:
  - anahtar: k1
    tur: ansiklopedi
    ad: "TDV Islam Ansiklopedisi - BIRUNI"
    url: https://islamansiklopedisi.org.tr/biruni
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "BÎRÛNÎ"
  ...
  - anahtar: k3
    ...
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Alberunis India"
    not: "Tahkiku ma li'l-Hind'in Sachau cevirisi, iki cilt"
...
sarayının çevresinde çalıştı.[^k1] Bu güzergâh, atlasın Orta Asya olarak ayırdığı
...
ölçümler ve halkların kayıtları üzerinde durur.[^k1] Atlasın ikisini ayrı
dosyalarda tutması bu ayrımı görünür kılmak içindir.

## İki eser, iki ayrı yöntem sorusu

Kaynak, eserlerinin çokluğunu ve konu genişliğini öne çıkarır.[^k1] Bu dosya
...
*Âsârü'l-bâkıye*, farklı halkların takvimlerini ve dönemlendirme sistemlerini
yan yana koyar.[^k2] Bir takvimi başka bir takvime çevirmek, o toplulukların
başlangıç saydığı olayları da yan yana koymak demektir; kitap bu yüzden
yalnızca hesap değil, aynı zamanda kayıt karşılaştırmasıdır.[^k2]

Bu, atlasın [Dönemlendirme](/kavram/donemlendirme/) dosyasında ele aldığı
sorunun erken bir örneğidir: dönemin nerede başladığı, kimin saydığına bağlıdır.

## Hindistan eseri ve kaynak eleştirisi

*Tahkīku mâ li'l-Hind*, Hint dinî ve bilimsel geleneklerini doğrudan o
geleneğin metinlerine dayanarak anlatır.[^k3] Eserin atlas açısından en önemli
...
Bu ayrım, atlasın [Kaynak eleştirisi](/kavram/kaynak-elestirisi/) dosyasında
tanımlanan işlemin ta kendisidir. Bir iddianın nereden geldiğini iddianın
yanında taşımak, bugün bu atlasın her makalede uyguladığı kuraldır;
...
ile aktarma arasındaki farkın erken bir biçimde kurulduğunu gösterir.

## Ölçüm ve karşılaştırma

Kaynak, matematik, astronomi ve doğa bilimleri alanlarındaki çalışmalarını da
kaydeder.[^k1] Bu çalışmaların ortak yanı ölçmeye dayanmalarıdır: bir büyüklüğü
tahmin etmek yerine hesaplamak, hesabın hangi varsayımlara dayandığını da
yazmak.

Ölçüm ile kayıt karşılaştırmasının aynı kişide birleşmesi,[^k1][^k2] atlasın
...
Atlasın Orta Asya kapsamı bu dosya yazıldığında dardı; iki dosya birlikte o
...
yoğun üretim yapması neyle açıklanır? Atlas bu soruya burada cevap vermez;
...
Farklı halkların takvimlerini yan yana koymak, önce her birinin başlangıç
saydığı noktayı bulmayı gerektirir.[^k2] Bir topluluk sayımı bir hükümdarın
tahta çıkışından başlatır, bir başkası bir göçten, bir üçüncüsü bir yaratılış
anlatısından. Bu başlangıçlar birbirine çevrilmeden hiçbir olay ortak bir
eksene yerleştirilemez.[^k2]

Eser bu işlemi yaparken yalnızca hesap vermez; hangi topluluğun hangi kaydı
tuttuğunu ve o kaydın nereden geldiğini de yazar.[^k2] Yani karşılaştırmanın
...
Atlasın kendi zaman şeridi aynı sorunla karşılaşır. On altı dönemin sınırları,
...
Bu tutum, atlasın tartışmalı sorularda hüküm vermeme kuralıyla aynı biçime
sahiptir: pozisyonları yan yana koymak, aralarında seçim yapmayı gerektirmez.

## Hindistan eserinin kuruluşu

*Tahkīku mâ li'l-Hind*, konusunu bölümlere ayırarak ilerler: inanç, felsefe,
ölçü birimleri, coğrafya, takvim ve hesap ayrı ayrı ele alınır.[^k3] Bu düzen,
eserin bir seyahat anlatısı değil bir inceleme olduğunu gösterir; bölümler
gözlem sırasına göre değil konu sırasına göre dizilmiştir.

Eserin açılışında yazar, kendinden önce bu konuda yazılmış olanların bir
kısmını yetersiz bulduğunu belirtir ve kendi yönteminin farkını anlatır.[^k3]
Bir metnin kendi yöntemini gerekçelendirerek açılması, yöntem bilincinin metnin
içine yerleştiğini gösterir.

Kaynaklarını nasıl kullandığını da açıkça yazar: doğrudan okuduğu metinlerle,
kendisine anlatılanları ayırır.[^k3] Bu ayrım bugün olağan görünür ama olağan
oluşu yenidir; aktarma ile okuma arasındaki farkın künyede gösterilmesi, uzun
bir süre kural değil istisnaydı.

Atlas bu ayrımı kendi künye şemasında taşır: her kaynağın türü — birincil,
ansiklopedi, akademik, veri — künyede yazılıdır ve okur bir iddianın hangi
türden bir kayda dayandığını görebilir. Bu dosyanın kendi künyesi de aynı
şemayı kullanır.[^k1][^k2][^k3]

## Neden bu dosya bu atlasta

Bîrûnî'nin atlasa girişi iki ayrı boşluğu birden ilgilendirir. Birincisi
coğrafidir: yaşadığı bölgeyi etiket olarak taşıyan makale sayısı, bu dosya
yazıldığında korpusun en dar kümelerinden biriydi.[^k1]

İkincisi yöntemseldir ve daha az görünürdür. Atlasın kendi kuralları —
...
Bu dosya üç kaynağa dayanır: Türkçe akademik literatürden bir madde[^k1] ve
...
bu dosya asgari şartı sağlar, ama ideal bileşim değildir.
...
atıflarda hangi çevirinin kullanıldığı belirtilmelidir.

## Eserlerin ulaşma biçimi

Bu dosyanın bağlandığı iki metin de on dokuzuncu yüzyılda yapılmış çevirilerdir
...
değildir; atlasın künye şeması bu farkı gösterecek bir alan taşımaz ve bu
eksiklik burada beyan edilir.

Aynı sorun atlasın başka dosyalarında da vardır. Kamu malı tam metinlerin
çoğu, telifi düşmüş eski çevirilerdir; güncel çeviriler telifli olduğu için
künyeye giremez. Yani atlasın metne bağlanabildiği her yerde, bağlandığı metin
genellikle bir yüzyıl öncesinin okuma alışkanlıklarını taşır.

Bunun sonucu şudur: atlas eserin kendisine bağlandığını söylediğinde, çoğu
...
dosyaları gerektirir ve bu dosya yazıldığında atlasta o dosyalar
bulunmuyordu.[^k1]

Mineraloji ve eczacılık üzerine yazdıkları da kapsam dışıdır.[^k1] Bir
düşünürün üretiminin tamamını tek dosyada toplamak, atlasın eser düzeyinde
...
özetlenmez.[^k3] Bu dosya eserin ne yaptığını anlatır, ne dediğini değil;
ne dediği için metnin kendisine inilmelidir.

## Okuma yönlendirmesi

Bu dosya bir giriş kapısıdır. Yöntem tarafıyla ilgilenen okuyucu için
