...
id: dusunur-du-bois
tip: dusunur
baslik: W. E. B. Du Bois
ozet: >-
  Bir toplumsal grubun kendini hem kendi gözüyle hem de kendisini
  aşağılayan bir toplumun gözüyle görmesini kavramlaştıran ve bunu saha
  araştırmasıyla birleştiren düşünür; atlasta niceliksel sosyolojinin
  erken örneklerinden birinin de yazarı.
donem: "12"
tarih_baslangic: "1868"
tarih_bitis: "1963"
bolge: [amerika, afrika, kuresel]
eksen: [felsefi, siyasi, kulturel, ekonomik]
guven_geneli: yaygin
etiketler: [du-bois, cifte-bilinc, renk-cizgisi, sosyoloji, esitsizlik, pan-afrikanizm]
ilgili:
  - donem-12
  - dusunur-fanon
...
kaynaklar:
  - anahtar: k1
    tur: akademik
    ad: "Stanford Encyclopedia of Philosophy - W.E.B. Du Bois"
    url: https://plato.stanford.edu/entries/dubois/
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Du Bois"
    not: "Dusunurun akademik cercevesi"
  - anahtar: k2
    tur: birincil
    birincil_tur: eser
    ad: "The Souls of Black Folk (1903) — tam metin"
    url: https://www.gutenberg.org/ebooks/408
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Souls of Black Folk"
    not: "Kamu mali, makine okunur tam metin"
  - anahtar: k3
    tur: ansiklopedi
    ad: "Wikipedia (EN) - W. E. B. Du Bois"
...
Düşünürün en çok atıf alan kavramı, bir toplumsal grubun kendini aynı anda
iki ayrı gözle görmesini tarif eder.[^k1][^k2] Kişi hem kendi deneyiminden
bakar hem de kendisini aşağı gören bir toplumun bakışını içselleştirmiş
olarak kendine bakar; iki bakış birbirini bozar.

Kavramın gücü, ölçülebilir bir dış eşitsizliği içsel bir deneyime
bağlamasındadır.[^k2] Ayrımcılık yalnızca gelir, konut ve eğitim
...
ayrımı çizgisi olarak tanımlar.[^k2] İfade, tek bir ülkeye değil dünya
...
Düşünürün erken çalışmalarından biri, bir şehrin belirli bir mahallesinde
yürütülmüş kapsamlı bir toplumsal araştırmadır.[^k1] Araştırma, hane hane
gelir, meslek, eğitim ve sağlık verisi toplayarak yürütülmüştür.

Bu yöntem, dönemin Amerika'sında yeni sayılır.[^k1][^k3] Toplumsal sorunlar
hakkındaki yaygın tartışma, gözleme değil kanaate dayanıyordu; sayısal veri
toplamak, tartışmanın zeminini kanaatten ölçüme kaydırma girişimidir.

Girişimin sınırı da kaydedilmelidir.[^k1] Veri toplamak, verinin nasıl
yorumlanacağını belirlemez; aynı sayılar, farklı çerçevelerde farklı
sonuçlara bağlanabilir ve düşünürün kendisi de bu sorunu metinlerinde ele
alır.

## Eğitim tartışması

Düşünürün dönemindeki bir başka tartışma, ayrımcılığa karşı hangi stratejinin
izleneceği üzerineydi.[^k1][^k3] Bir görüş mesleki eğitime ve ekonomik
birikime öncelik verirken, düşünür yüksek öğrenime ve siyasi hak talebine
öncelik verilmesini savundu.

Tartışmanın özü, hakların önce mi verileceği yoksa kazanılan konumla birlikte
...
kaydedilmelidir.[^k1][^k3] Erken dönemde bilimsel araştırmanın kendi başına
ayrımcılığı azaltacağı beklentisi taşırken, sonraki dönemde bu beklentiyi
açıkça terk etti.
...
Düşünür, Afrika kökenli toplulukların kıtalar arası örgütlenmesini savunan
...
İki konumun farkı sonuçlara da yansır.[^k1] Bir ülkenin içinden yazan
düşünür, o ülkenin kurumlarına dâhil olmayı bir hedef sayabilir; sömürge
düzeninden yazan düşünür için aynı kurumlar sorunun kendisidir.

## Metnin biçimi

En bilinen kitabı, akademik bölümlerle kişisel anlatıyı ve müzik notalarını
...
Düşünürün saha araştırmaları, akademik sosyolojinin kuruluş
...
verilerden çıkarılabilir ve iki açıklama ayrı kanıtlar gerektirir.
...
bu kısıt burada beyan edilir.

Okur bu sınırı bilerek okumalıdır.[^k3] Buradaki değerlendirmelerin bir
...
## Verinin siyasi kullanımı

Düşünürün topladığı veri, yayımlandığı andan itibaren iki ayrı yönde
kullanıldı.[^k1][^k3] Aynı sayılar, bir tarafça ayrımcılığın etkisinin kanıtı,
...
Dönemin sosyoloji geleneği için [Durkheim](/dusunur/durkheim/), toplumsal
çözümlemede kullanılan araç için [İdeal tip](/kavram/ideal-tip/) dosyaları
uygundur.[^k3]

Anlattığı düzenin tarihsel arka planı için
[Amerikan İç Savaşı](/olay/amerikan-ic-savasi/) dosyası okunabilir.[^k2]

Aynı yılları bütün bölgeler üzerinden okumak için [Dönem 12](/donem/12/)
