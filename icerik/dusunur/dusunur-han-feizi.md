---
id: dusunur-han-feizi
tip: dusunur
baslik: Han Feizi
ozet: >-
  Yönetmenin erdemle değil kural, teknik ve konumla mümkün olduğunu savunan
  metnin adı; Kautilya ve Nizâmülmülk ile birlikte üç ayrı uygarlıktan üç
  devlet yönetme el kitabı oluşturur.
tarih_baslangic: "-0280"
tarih_bitis: "-0233"
bolge: [dogu-asya]
eksen: [siyasi, felsefi]
guven_geneli: yaygin
etiketler: [han-feizi, legalizm, fa, shu, shi]
ilgili:
  - dusunur-konfucyus
  - dusunur-kautilya
  - dusunur-nizamulmulk
...
kaynaklar:
  ...
  - anahtar: k3
    ...
    not: "Gelenegin akademik cercevesi; bagimsiz alan adi"
...
Metnin merkezinde birbirini tamamlayan üç kavram durur: yazılı ve herkese eşit
uygulanan kural; yöneticinin görevlileri denetlemek için kullandığı teknik; ve
makamın kendisinden gelen konumsal güç.[^k1][^k3]

Üçünün birlikte ele alınması, metnin ayırt edici yanıdır. Yalnızca kural,
uygulanmadığında işlemez; yalnızca teknik, kuralsız keyfîliğe döner; yalnızca
konum, kişinin niteliğine bağımlı kalır.[^k1]

Bu çerçevenin sonucu şudur: iyi yönetim, iyi yöneticiye bağlı olmamalıdır.
Metin, sıradan bir yöneticinin de işletebileceği bir düzen arar.[^k1][^k3]

## Konfüçyüs geleneğiyle karşıtlık

Metin, yönetimi ahlaki örnek üzerinden kuran anlayışa açıkça karşı
çıkar.[^k1][^k3] [Konfüçyüs](/dusunur/konfucyus/) dosyasında ele alınan gelenek,
...
Metnin üzerinde durduğu sorunlardan biri, yöneticinin görevlilerini nasıl
denetleyeceğidir.[^k1] Bir yönetici her işi kendisi yapamaz; yetki devretmek
...
Aynı sorun [Nizâmülmülk](/dusunur/nizamulmulk/) dosyasındaki metinde de geniş
yer tutar — orada haber alma düzeni ayrı bir başlıktır.[^k1] İki metnin
...
Metnin en ayırt edici iddiası, iyi yönetimin iyi yöneticiye bağlı
...
bu imkânın kullanılması önerilir.

Aynı geleneğin ikinci metni de bağlanmıştır ve iki metnin birlikte okunması
