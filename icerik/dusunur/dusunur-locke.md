...
baslik: John Locke
ozet: >-
  Siyasal iktidarı rızaya, mülkiyeti emeğe bağlayan İkinci İnceleme, aynı
  kitapta köleliği haklı savaşın sonucu sayan bir bölüm taşır; onu yazan kişi
  Carolina'nın kurucu metnini kaleme alan kurulun kâtibiydi ve köle ticareti
  yapan şirketlerde hissesi vardı.
tarih_baslangic: "1632"
tarih_bitis: "1704"
bolge: [avrupa, amerika]
eksen: [felsefi, siyasi, ekonomik]
guven_geneli: yaygin
etiketler: [locke, riza, mulkiyet, hosgoru, kolelik, somurge, dogal-hukuk]
ilgili:
  - dusunur-hobbes
  - dusunur-montesquieu
  - dusunur-smith
...
kaynaklar:
  - anahtar: k1
    tur: birincil
    birincil_tur: eser
    ad: "John Locke, Second Treatise of Government — tam metin (Project Gutenberg)"
    url: https://www.gutenberg.org/cache/epub/7370/pg7370.txt
    erisim_tarihi: 2026-08-29
    dogrulama_dizesi: "the unquestionable property of the labourer"
    not: "Kamu mali tam metin; bolum ve kisim numaralari 1764 duzenine gore"
  - anahtar: k2
    tur: birincil
    birincil_tur: eser
    ad: "John Locke, Two Treatises of Government (1764), Birinci Inceleme, I. bolum — Wikisource"
    url: https://en.wikisource.org/wiki/Two_Treatises_of_Government_(1764)/Book_I/Chapter_1
    erisim_tarihi: 2026-08-29
    dogrulama_dizesi: "Slavery is so vile and miserable an estate of man"
    not: "Birinci Inceleme'nin acilisi; 1764 baskisinin transkripsiyonu"
  - anahtar: k3
    tur: birincil
    birincil_tur: eser
    ad: "John Locke, A Letter Concerning Toleration (1689) — Wikisource"
    url: https://en.wikisource.org/wiki/A_Letter_Concerning_Toleration
    erisim_tarihi: 2026-08-29
    dogrulama_dizesi: "Lastly, those are not at all to be tolerated who deny the being of a God"
    not: "Popple cevirisinin metni; Locke'un adi ilk baskida yoktu"
  - anahtar: k4
    tur: birincil
    birincil_tur: belge
    ad: "The Fundamental Constitutions of Carolina, 1 Mart 1669 — Avalon Project"
    url: https://avalon.law.yale.edu/17th_century/nc05.asp
    erisim_tarihi: 2026-08-29
    dogrulama_dizesi: "absolute power and authority over his negro slaves"
    not: "Thorpe derlemesinden; sayfanin dipnotlari 19. yuzyil editorunun atif iddialarini tasir"
  - anahtar: k5
    tur: akademik
    ad: "Stanford Encyclopedia of Philosophy — John Locke (William Uzgalis)"
    url: https://plato.stanford.edu/entries/locke/
    erisim_tarihi: 2026-08-29
    dogrulama_dizesi: "There is some controversy about the extent of Locke"
    not: "Yasam kaydi, gorevler ve yayin tarihleri"
  - anahtar: k6
    tur: akademik
    ad: "Stanford Encyclopedia of Philosophy — Notes to John Locke (William Uzgalis)"
    url: https://plato.stanford.edu/entries/locke/notes.html
    erisim_tarihi: 2026-08-29
    dogrulama_dizesi: "Either Lord Ashley or Sir John Colleton are much more likely candidates"
    not: "Carolina Anayasasi'nin 110. maddesinin yazarligi tartismasi"
  - anahtar: k7
    tur: akademik
    ad: "Stanford Encyclopedia of Philosophy — Locke's Political Philosophy (Alex Tuckness)"
    url: https://plato.stanford.edu/entries/locke-political/
    erisim_tarihi: 2026-08-29
    dogrulama_dizesi: "David Armitage (2004) even argues that there is evidence"
    not: "Mulkiyet kuraminin sinirlari, riza tartismasi ve somurge okumalarinin ozeti"
  - anahtar: k8
    tur: akademik
    ad: "David Armitage, 'John Locke, Carolina, and the Two Treatises of Government', Political Theory 32(5), 2004 — Crossref kaydi"
    url: https://api.crossref.org/works/10.1177/0090591704267122
    erisim_tarihi: 2026-08-29
    dogrulama_dizesi: "revising the Fundamental Constitutions of Carolina at just the moment in the summer of 1682"
    not: "Ustveri + yazarin kendi ozeti; makale govdesi acik erisimde degil"
  - anahtar: k9
    tur: akademik
    ad: "James Farr, 'Locke, Natural Law, and New World Slavery', Political Theory 36(4), 2008 — Crossref kaydi"
    url: https://api.crossref.org/works/10.1177/0090591708317899
    erisim_tarihi: 2026-08-29
    dogrulama_dizesi: "Locke followed Grotian natural law in constructing a just-war theory of slavery"
    not: "Ustveri + yazarin kendi ozeti; makale govdesi acik erisimde degil"
  - anahtar: k10
    tur: akademik
    ad: "William Uzgalis, 'John Locke, Racism, Slavery, and Indian Lands', Oxford Handbooks Online, 2017 — Crossref kaydi"
    url: https://api.crossref.org/works/10.1093/oxfordhb/9780190236953.013.41
    erisim_tarihi: 2026-08-29
    dogrulama_dizesi: "Locke owned stock in slave trading companies"
    not: "Ustveri + yazarin kendi ozeti; hisse sahipligi sirket adiyla degil tur olarak veriliyor"
son_denetim: 2026-08-29
denetim_durumu: onaylandi
onarim_turu: 1
---

Ortak bırakılmış bir dünyadan bir parçayı kendi malı yapmanın yolu nedir?
*İkinci İnceleme*'nin beşinci bölümü buna tek bir mekanizmayla cevap verir.
Her insanın önce kendi kişiliği üzerinde bir mülkiyeti vardır; bedeninin
...
yasası için parlamento çoğunluğu örgütledi; yasa Avam Kamarası'ndan geçti,
...
uzlaşmayla, der Locke, insanlar toprağın orantısız ve eşitsiz bir biçimde
...
itirazı buradan çıkar: bir kişiden zımni rıza vermemek için bütün mülkünü
...
*Hoşgörü Üzerine Mektup* aynı mantığı din alanına taşır. Kilise, üyelerinin
kendi istekleriyle bir araya geldiği gönüllü bir topluluktur; kimse bir
kilisenin üyesi olarak doğmaz, yoksa iman da topraklar gibi miras yoluyla
geçerdi.[^k3] Sivil yöneticinin yetkisi de ruhların kurtuluşuna uzanamaz,
çünkü böyle bir yetkiyi ona ne Tanrı vermiştir ne de halkın rızası
verebilir: hiç kimse kendi kurtuluşunun kaygısını bir başkasının seçimine
körü körüne bırakacak kadar terk edemez.[^k3] Locke buradan, günah ile suç
arasındaki ayrımı çıkarır: bir şeyin günah olması onu yöneticinin kılıcına
...
Hristiyanlığa yabancı olmasının onları kovmaya ya da kötü kullanmaya hak
vermediğini söyler ve yedi ya da daha fazla kişinin herhangi bir dinde
birleşerek kilise kurmasına izin verir; Yahudiler, putperestler ve
muhalifler adıyla sayılır.[^k4] Yüz yedinci madde kölelerin de diledikleri
kiliseye girmesini serbest bırakır, ama hiçbir kölenin bununla efendisinin
sivil egemenliğinden muaf tutulmayacağını ekler.[^k4] Yüz onuncu madde ise
şudur: "Carolina'nın her özgür adamı, zenci köleleri üzerinde mutlak güç ve
...
farklı olarak kuramı öyle sıkı sınırladı ki Amerika'ya uygulanamaz hâle
geldi; kuram yalnızca Stuart İngiltere'sinde mutlak güce direnmeye
...
savlardır, dolayısıyla birine karşı yazan öbürüne de karşı yazmış
olur.[^k10]

Metnin sömürgeci sonuçları başka bir yerden de okundu. James Tully ve
Barbara Arneil, emek kuramının kullanışlı bir sonuca vardığını gösterdiler:
yerli Amerikalıların emeği yalnızca avladıkları hayvanlar üzerinde mülkiyet
doğuruyor, avlandıkları toprak üzerinde doğurmuyordu — Locke o toprağı boş
ve alınmaya açık sayıyordu.[^k7] Mark Goldie ise buna bir çekince koyar:
*İkinci İnceleme*'yi yazarken Locke'un başlıca meşguliyeti hâlâ
İngiltere'deki siyasal olaylardı.[^k7] Aynı tartışmanın ikinci ucunda,
mülkiyetin kurulduktan sonraki durumu vardır: Robert Nozick Locke'u
libertaryen okur ve hükümete rıza olmadan mülke el koyma yetkisi tanımaz;
James Tully devlet kurulduğunda toprağın zaten kıtlaştığını ve doğa
durumundaki payların artık hükümeti bağlamadığını savunur; Jeremy Waldron
ikisinin arasında durur.[^k7]

## Nasıl yanlış okunuyor

Locke'un yazdığıyla adına söylenen arasındaki fark birkaç yerde toplanır.
