...
baslik: Mengzi
ozet: >-
  Yönetimin meşruiyetini yönetilenlerin refahına bağlayan ve bu şart
  yitirildiğinde yöneticinin konumunun tartışılabileceğini söyleyen düşünür;
  atlasta direnme hakkının en erken açık formülasyonlarından biri.
donem: "04"
tarih_baslangic: "-0372"
tarih_bitis: "-0289"
bolge: [dogu-asya]
eksen: [felsefi, siyasi]
guven_geneli: yaygin
etiketler: [mengzi, mensiyus, insan-dogasi, mesruiyet, refah, direnme]
ilgili:
  - donem-04
...
kaynaklar:
  ...
  - anahtar: k2
    ...
    not: "Dusunure atfedilen metnin kendisi; Cince ozgun ve Ingilizce ceviri"
  - anahtar: k3
    tur: birincil
    birincil_tur: eser
    ...
    not: "Ayni cizginin onceki metni; farkin olculmesi icin"
...
şart yitirildiğinde yöneticinin konumu tartışılabilir.[^k2]
...
Düşünürün en çok tartışılan iddiası, insanın doğuştan iyiye yatkın
olduğudur.[^k1] Bu iddia, dönemin başka çizgileriyle doğrudan çatışır.

İddianın işlevi ahlaki değil siyasidir.[^k1][^k2] İnsan doğuştan iyiye
yatkınsa, yönetimin işi bu yatkınlığı korumak ve beslemektir; bastırmak
ya da biçimlendirmek değil.
...
İki görüşün ayrımı, soyut bir insan tanımı meselesi değildir.[^k1] Her biri
farklı bir yönetim programı gerektirir ve bu program bütçeye, kuruma ve
hukuka yansır.

İyiye yatkınlık varsayan bir yönetim, eğitime ve refaha yatırım
...
Düşünürün yönetim anlayışında refah bir sonuç değil bir ön şarttır.[^k2]
Halkın geçimi güvence altına alınmadan ahlaki bir düzen beklenemez.

Bu sıralama önemlidir. Ahlak, refahın sonucu sayılır; tersi değil.[^k2]
...
Metin, yönetim şartını yerine getirmeyen bir yöneticinin artık o sıfatı
...
Dönemin siyasi düşüncesinde yönetme yetkisi göksel bir kaynağa
bağlanıyordu.[^k1] Düşünürün katkısı, bu yetkinin nasıl anlaşılacağını
değiştirmesidir.

Metinde göksel onayın halkın tutumundan okunabileceği ileri
...
Metnin biçimi, önceki metinden farklıdır.[^k2][^k3] Önceki metin özlü
sözlerden oluşur; bu metin, hükümdarlarla ve rakip düşünürlerle yapılmış
uzun konuşmalardan.

Biçim farkı bir üslup tercihi değildir.[^k2] Bir çizgi, ilk kurulduğunda
...
Metin, iddialarını çoğunlukla tarım, su ve büyüme benzetmeleriyle
kurar.[^k2] Bu benzetmeler süsleme değil, kanıt yerine geçen araçlardır.
...
Metin, yüzyıllar sonra bir başka düşünürün seçtiği dört temel metinden biri
oldu ve sınav müfredatına girdi.[^k1] Bu, metnin dolaşımını kalıcı olarak
değiştirdi.

Müfredata girmenin sonucu ikili çalışır.[^k1] Metin ülke çapında öğrenilir
...
Düşünür, dönemin başka çizgilerini adıyla anar ve onlara karşı
...
Metnin en çok bilinen bölümlerinden biri, kuyuya düşmek üzere olan bir çocuk
karşısında insanın vereceği ilk tepkiyi tartışır.[^k2] Örneğin işlevi,
doğuştan gelen bir yatkınlığın varlığını gündelik bir sezgiye dayandırmaktır.

Örneğin gücü, okurun kendi tepkisini sınayabilmesindedir.[^k1] Kanıt
...
Metin yalnızca ilkeler sunmaz; somut bir toprak ve vergi düzeni de
önerir.[^k2] Öneri, ekilebilir alanın belirli bir bölümünün ortak
kullanıma ve devlet payına ayrılmasına dayanır.

Bu ayrıntı düzeyi, metni bir ahlak öğretisi olmaktan çıkarıp bir yönetim
...
Karşı çıktığı çizgi için [Legalizm](/kavram/legalizm/) ve
[Han Feizi](/dusunur/han-feizi/) dosyaları uygundur; üçü birlikte
okunduğunda dönemin tartışması bütünüyle görünür.[^k1]

Yönetimin kendini nasıl gerekçelendirdiği için
[Meşruiyet](/kavram/mesruiyet/), yetkinin kaynağı için
[Göksel yetki](/kavram/goksel-yetki/) dosyaları okunabilir.[^k2]

Metne yapılacak atıflarda kitap ve bölüm numarası ile kullanılan çeviri
belirtilmelidir; kaynak özgün metni de sunduğu için çeviri tercihleri
karşılaştırılabilir ve bu metinde terim karşılıkları tartışmalıdır.[^k2][^k3]

Aynı yılları bütün bölgeler üzerinden okumak için [Dönem 04](/donem/04/)
