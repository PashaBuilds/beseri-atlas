...
kaynaklar:
  ...
  - anahtar: k3
    ...
    not: "Ayni doneme ait baska bir iktisadi tarih yaklasimi"
...
Kaynak, eski iktisatlara yaklaşımının Kolomb öncesi Amerika ve eski Mezopotamya
...
## Ana akıma karşıtlık kaynağın kendi ifadesidir

Kaynak, onun iktisatların topluma ve kültüre nasıl gömülü olduğunu vurgulayan
kültürel bir iktisat sürümünün kurucusu olarak hatırlandığını yazar; bu görüşün
...
## Tarihsel zorunluluk reddi de kayıtlıdır

Kaynak, çift hareket kavramının piyasalaşma ile ona karşı toplumsal korunma
talebinin diyalektik sürecine gönderme yaptığını ve onun modern Avrupa'daki
...
Kaynak etkilendiği kişiler arasında Karl Bücher, Ferdinand Tönnies, Adam Smith,
Alfred Radcliffe-Brown, Werner Sombart, Max Weber, György Lukács ve Carl Menger'i
sayar.[^k1]

Etki listesinde hem kendi tezine karşı sayılabilecek hem yakın adların bulunması,
[^k1] etkinin onaylama anlamına gelmediğini gösterir; listede yer alan bir yazar
[Adam Smith](/dusunur/smith/) dosyasında ele alınıyor.[^k2]

## Aynı döneme ait başka bir yaklaşım

Aynı yüzyılda iktisadi tarih yazan bir başka yazar için tutulan kayıt, o yazarın
kapitalistleri tekelciler olarak gördüğünü ve hem liberal hem Marksçı
