...
baslik: Şankara
ozet: >-
  Kendi konumunu yalnızca başkasının metnine yazdığı şerhin içinde kuran
  düşünür; atlasta yazarın sesinin türün kurallarıyla nasıl sınırlandığının
  ve atıf sorununun en açık örneği.
donem: "06"
tarih_baslangic: "700"
tarih_bitis: "750"
bolge: [guney-asya]
...
guven_geneli: yaygin
etiketler: [sankara, advaita, serh, vedanta, atif-sorunu, guney-asya]
ilgili:
  - donem-06
  - dusunur-nagarjuna
...
kaynaklar:
  - anahtar: k1
    tur: akademik
    ad: "Stanford Encyclopedia of Philosophy - Shankara"
    url: https://plato.stanford.edu/entries/shankara/
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Shankara"
    not: "Dusunurun akademik cercevesi; tarihlendirme ve atif sorunlari dahil"
  - anahtar: k2
    tur: birincil
    birincil_tur: eser
    ad: "The Vedanta-sutras with the commentary by Sankaracarya, cev. George Thibaut (1890)"
    url: https://archive.org/details/vedntasutrastr01bdar
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Thibaut"
    not: "Katalogda yaratici alaninda Sankaracarya ve cevirmen Thibaut; 1890, erisim kisiti yok"
  - anahtar: k3
    tur: ansiklopedi
    ad: "Wikipedia (EN) - Adi Shankara"
    url: https://en.wikipedia.org/wiki/Adi_Shankara
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Adi Shankara"
    not: "Giris kapisi; geleneksel anlatilar ve manastir agi icin"
...
Şerh, serbest bir tür değildir.[^k1] Şerh yazan kişi, şerh ettiği metnin
doğru olduğunu baştan kabul etmiş sayılır.

Bu kabul, konumu ifade etme biçimini de belirler.[^k2] Yeni bir iddia, yeni
...
Bu sorun bu düşünürde uç örneğine ulaşır.[^k1] Ona atfedilen metinlerin
önemli bölümünün ona ait olmadığı akademik yazında kabul görür.

## Temel iddia

Şerhin merkezindeki iddia, gerçekliğin nihai düzeyinde ikilik
bulunmadığıdır.[^k1] Görünen çokluk, bu düzeyde ayrı bir varlık sayılmaz.

İddia, gündelik deneyimi yalanlamaz.[^k2] Çokluğun bir düzeyde geçerli,
başka bir düzeyde geçerli olmadığı ileri sürülür.

İki düzeyli yapı, konumun en tartışılan yanıdır.[^k1] Karşı çıkanlara göre
düzey ayrımı, itirazları cevaplamak yerine onlara yer açmaya yarar.

## İki düzeyin işlevi

Düzey ayrımının işlevi bir çelişkiyi yönetmektir.[^k1] Metinlerin bir kısmı
çokluğu, bir kısmı birliği anlatır ve ikisi de kanon içindedir.
...
Şerh yalnızca bir konumu savunmaz; çok sayıda rakip konumu tek tek ele alıp
reddeder.[^k2] Reddedilen konumların bir bölümü başka hiçbir yerde
korunmamıştır.
...
Reddedilen konumlar arasında budist okullar da vardır.[^k1] Bununla
birlikte, düşünürün kendi konumunun budist bir konumdan alındığı suçlaması
kendi geleneği içinden yapılmıştır.
...
Düşünürün yaşadığı yıllar kesin değildir.[^k1] Gelenek bir tarih aralığı
...
çıkarılır ve zincir kopuk olabilir.

## Atfedilen eserlerin sorunu

Bu düşünürün adıyla dolaşan metinlerin sayısı çok fazladır.[^k1] Akademik
yazında bunların küçük bir bölümü ona ait sayılır.

Nedeni bir sahtecilik girişimi olmak zorunda değildir.[^k1] Aynı adı taşıyan
...
Gelenek, düşünürün ülkenin dört yanında öğretim merkezleri kurduğunu
anlatır.[^k3] Anlatı, sonraki yüzyıllarda bu merkezlerin meşruiyet kaynağı
hâline gelir.
...
Konumun bugünkü görünürlüğü, on dokuzuncu ve yirminci yüzyıldaki yeniden
sunumuyla yakından ilgilidir.[^k3] Bu dönemde konum, bölgenin felsefi
geleneğinin özeti olarak dışarıya tanıtıldı.
...
Künyelenen çeviri, şerhin tamamını değil bir bölümünü kapsar ve on
...
Şerh, kendi iddiasını doğrudan sunmaz.[^k2] Önce karşı görüş kendi
gerekçeleriyle kurulur, sonra çürütülür, en sonda savunulan konum
söylenir.

Düzen bir üslup tercihi değil, türün kuralıdır.[^k1] Karşı görüşü zayıf
kurmak, tartışmayı kazanmak sayılmaz.

Bu kural, metnin kaynak değerini yükseltir.[^k2] Rakip konumların
korunmasının nedeni yazarın hoşgörüsü değil, türün onu zorunlu
kılmasıdır.

## Sözlü tartışmanın izleri

Yazılı metnin bu düzeni, arkasında sözlü bir tartışma pratiği
...
Metinlerin kime ait olduğunun nasıl sınanacağı için
[Kaynak eleştirisi](/kavram/kaynak-elestirisi/) ve
[Birincil kaynak](/kavram/birincil-kaynak/) dosyaları uygundur.[^k2]

Elde bulunan kanıt türünün soruları nasıl belirlediği için
[Kanıt türü](/kavram/kanit-turu/), kaydı kimin tuttuğunun neyi değiştirdiği
için [Tarih yazımı](/kavram/tarih-yazimi/) dosyaları okunabilir.[^k1]

Bölgeyi dışarıdan gözlemleyip yazan bir tanık için
[Bîrûnî](/dusunur/biruni/) dosyası okunmalıdır; aynı geleneği bir başka
çerçeveden aktarır.[^k3]
