---
id: dusunur-thukydides
tip: dusunur
baslik: Thukydides
ozet: >-
  Peloponez Savaşı'nı yazarken tarafların ileri sürdüğü şikâyetlerle savaşı
  gerçekten çıkaran nedeni birbirinden ayırdı ve en doğru nedeni Atina'nın
  büyümesiyle bunun Sparta'da yarattığı korkuya bağladı; aynı kitapta
  konuşmaları kendi kurduğunu da yazdı. Bu iki karar hem tarih yazımının en
  erken yöntem beyanlarından biridir hem de metnin bugünkü okumaları
  üzerindeki tartışmanın kaynağıdır.
tarih_baslangic: "-0460"
tarih_bitis: "-0400"
bolge: [avrupa]
eksen: [kulturel, siyasi, askeri]
guven_geneli: tartismali
etiketler: [thukydides, peloponez, prophasis, tarih-yazimi, gercekcilik]
ilgili:
...
kaynaklar:
  - anahtar: k1
    tur: kitap
    birincil_tur: eser
    ad: "Thukydides, History of the Peloponnesian War, Richard Crawley çevirisi, tam metin (Project Gutenberg 7142)"
    ...
    not: >-
      Eserin kendisi; kamu malı. SINIR: getirme aracı metni 400.000 karakterde
      keser, bu pencere I-III. kitapları kapsar. Bu künyeye yalnızca o
      aralıktaki yerler (I.22, I.23, II.48, II.65, III.36-50) dayandırıldı;
      V. kitap k2'den, III.82 k3'ten okundu.
  - anahtar: k2
    tur: kitap
    birincil_tur: eser
    ad: "Thukydides, History of the Peloponnesian War, V. kitap, Crawley çevirisi (Wikisource)"
    url: https://en.wikisource.org/wiki/History_of_the_Peloponnesian_War/Book_5
    erisim_tarihi: 2026-08-29
    dogrulama_dizesi: "the strong do what they can and the weak suffer what they must"
    not: >-
      Melos Diyalogu (V.84-116) ile sürgün beyanının (V.26) bulunduğu kitap.
      Sayfa ayrıca iki editör notu taşır: V.24'te bir kompozisyon kopması
      bulunduğunu birçok araştırmacının düşündüğü, ve Ksenophon'a göre bazı
      Meloslulular'ın sağ kalıp savaşın sonunda geri döndüğü. İkisi de metne
      çekince olarak taşındı.
  - anahtar: k3
    tur: kitap
    birincil_tur: eser
    ad: "Thukydides III.82, Crawley çevirisi (Perseus Digital Library, Dent 1910 basımı)"
    url: https://www.perseus.tufts.edu/hopper/text?doc=Perseus%3Atext%3A1999.01.0200%3Abook%3D3%3Achapter%3D82
    erisim_tarihi: 2026-08-29
    dogrulama_dizesi: "Words had to change their ordinary meaning"
    not: "Kerkyra'daki iç savaşın çözümlemesi; dilin bozulmasına ayrılan bölüm"
  - anahtar: k4
    tur: kitap
    birincil_tur: eser
    ad: "Thukydides I.23, Yunanca metin (Perseus Digital Library, Historiae, Oxford 1942)"
    url: https://www.perseus.tufts.edu/hopper/text?doc=Perseus%3Atext%3A1999.01.0199%3Abook%3D1%3Achapter%3D23
    erisim_tarihi: 2026-08-29
    dogrulama_dizesi: "ἀληθεστάτην πρόφασιν"
    not: >-
      Çeviriler arası farkı ölçmek için Yunanca aslı: prophasis ile aitiai
      ayrımı ve hegoumai fiilinin taşıdığı kanaat kaydı burada okunur.
  - anahtar: k5
    tur: kitap
    ad: "Francis Macdonald Cornford, Thucydides Mythistoricus (Londra: E. Arnold, 1907), tam metin"
    url: https://archive.org/download/thucydidesmythis00cornuoft/thucydidesmythis00cornuoft_djvu.txt
    erisim_tarihi: 2026-08-29
    dogrulama_dizesi: "By Mythistoria I mean history"
    not: >-
      Kamu malı; tarama OCR'ı. 1907 tarihli bir itirazdır ve sonrasında çok
      tartışılmıştır — burada tarihsel bir konum olarak aktarıldı, güncel
      uzlaşı olarak değil.
  - anahtar: k6
    tur: akademik
    ad: "Crossref kaydı ve özeti — Sutton, 'Thucydides' Ambiguous Trap', Classical Antiquity 44/2 (2025), University of California Press"
    url: https://api.crossref.org/works/10.1525/ca.2025.44.2.352
    erisim_tarihi: 2026-08-29
    dogrulama_dizesi: "deliberately enigmatic about the causal effects of his speeches"
    not: >-
      Yazarın kendi özeti savını taşır: konuşmaların nedensel etkisi bilerek
      belirsiz bırakılmıştır ve I.23.6'daki prophasis okuması buna bağlıdır.
      Makalenin gövdesi bu kayıttan okunamaz.
  - anahtar: k7
    tur: akademik
    ad: "Crossref kaydı ve özeti — Laurie M. Johnson, Thucydides, Hobbes, and the Interpretations of Realism (Cornell University Press, 2020 basımı)"
    url: https://api.crossref.org/works/10.7591/cornell/9781501747809.001.0001
    erisim_tarihi: 2026-08-29
    dogrulama_dizesi: "neither thinker fits perfectly within the confines of international relations realism"
    not: "Kitap özeti; iki düşünürün gerçekçilikle ilişkisini derecelendiren sav bu düzeyde doğrulanır"
  - anahtar: k8
    tur: akademik
    ad: "Crossref kaydı ve özeti — Mark Fisher, 'Compelling Justice: Translating Necessity in Thucydides' Melian Dialogue', History of Political Thought 47/2 (2026), 181-211"
    url: https://api.crossref.org/works/10.53765/20512988.47.2.181
    erisim_tarihi: 2026-08-29
    dogrulama_dizesi: "prototypical political realists"
    not: >-
      Özet, yerleşik okumayı adlandırıp ona itiraz eder; itirazın gerekçeleri
      (anankē'nin yorumbilgisel okunuşu, destanla metinlerarası ilişki) özette
      sayılır, ayrıntısı okunamaz.
  - anahtar: k9
    tur: akademik
    ad: "Crossref kaydı ve özeti — Khan ve Zafar, 'Power Transition Theory and the Thucydides Trap', Research Journal for Social Affairs 2/4 (2024)"
    url: https://api.crossref.org/works/10.71317/rjsa.002.04.1107
    erisim_tarihi: 2026-08-29
    dogrulama_dizesi: "bad history and bad theory"
    not: >-
      Küçük bir dergide çıkmış bir çalışmadır; buradan yalnızca özetin kendi
      söylediği alındı. Özet, kötü tarih ve kötü kuram suçlamasını daha önce
...
korku savaşı zorunlu kılmıştı.[^k1] Ayrımın kilidi Yunanca metindedir. En doğru
olan *prophasis*, aynı zamanda sözde en görünmez olandır; tarafların ileri
sürdükleri ise *aitiai*, yani açıkça dile getirilen suçlamalardır.[^k4]

Bu, bir terim tercihi değil bir iş tarifidir. Savaş gerekçeleri kamuya açık
...
olduklarını söylemekle yetinir; kendi çıkarımlarının güvenle dayanak
alınabileceğini söylerken bile araya inanma fiilini koyar.[^k1] Yakın geçmişi
uzak geçmişe yeğlemesinin nedeni budur. Kendi savaşını yazabilir, çünkü
tanıklarına ulaşabilir; Truva'yı yazamaz, çünkü ulaşamaz.
...
başlamadan verir; böylece metnin en edebî bölümlerini kanıt diye kullanacak
herkesi uyarmış olur.[^k1]

## Sürgün, yöntemin bir parçası olarak
...
adalet savı değil, Diodotos'un tartışmayı taşıdığı bu ikinci dildir.[^k1]

Aynı dilin en açık dökümü Melos'tan çok önce, Sparta'daki bir mecliste yapılır.
Orada bulunan Atinalı elçiler, kendilerine sunulan imparatorluğu kabul
etmelerinin ve baskı altında ondan vazgeçmemelerinin şaşılacak ya da insanların
alışılmış davranışına aykırı bir iş olmadığını söyler; üç güçlü saikin adını da
...
dönüştüğünü yazar; ardından gelenlerin birbirine denk ve üstünlük peşinde
olduklarını, devlet işlerini kalabalığın hevesine bıraktıklarını ve bunun
Sicilya seferi de dahil bir dizi yanlışa yol açtığını ekler.[^k1]

## İtirazlar

En eski ve en sert itirazlardan biri 1907'de Francis Cornford'dan geldi.
Cornford'a göre Thukydides'in yapıtı, farkında olmadan, yazıldığından çok önce
...
Uyarı iki yönlüdür. Thukydides'i kendi çağının dışına taşıyıp modern bir
kuramın atası yapmak kadar, adına kurulan kuramın kusurlarını geriye doğru ona
yüklemek de aynı hatanın iki yüzüdür. Metinde bir güç geçişi modeli yoktur;
antlaşmanın neden bozulduğuna dair, yazarının kanaat olarak imzaladığı bir
hüküm vardır ve bu hükmün yanına tarafların kendi gerekçeleri de bütünüyle
yazılmıştır.[^k4]

Metnin kendisi bu kullanımı taşımaz: Thukydides bir yasa değil bir kanaat
yazdı,[^k4] konuşmaları kendisinin kurduğunu okura ilan etti[^k1] ve gücün
dilini konuşanları kazanan olarak değil sonuçlarıyla birlikte gösterdi.[^k2]
Nedenle bahaneyi ayıran cümle bugün hâlâ okunuyorsa, bunun nedeni bir öngörü
formülü vermesi değil, her savaş gerekçesinin ardında sorulmamış bir soru
bıraktığını söylemesidir.
