...
baslik: Zhu Xi
ozet: >-
  Bin yıllık bir metin geleneğini yeniden düzenleyip sınav müfredatı hâline
  getiren düşünür; atlasta bir yorumun resmî doğru sayılmasının sonuçlarının
  en açık örneği.
donem: "07"
tarih_baslangic: "1130"
tarih_bitis: "1200"
bolge: [dogu-asya]
eksen: [felsefi, kulturel, siyasi]
guven_geneli: yaygin
etiketler: [zhu-xi, neo-konfucyusculuk, li, qi, sinav, mufredat]
ilgili:
  - donem-07
...
kaynaklar:
  ...
  - anahtar: k3
    ...
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Confucian"
    not: "Yorumun bolge disina yayilisi; alimlanma tarafi"
...
Düşünürün en somut işi, geleneğin geniş külliyatından dört metni seçip
öne çıkarmasıdır.[^k1] Bu seçim, o zamana kadar merkezde bulunan başka
metinleri ikinci sıraya düşürdü.

Seçimin yanına ayrıntılı bir yorum yazdı ve metinlerin hangi sırayla
okunacağını belirledi.[^k1][^k2] Böylece bir külliyat, bir müfredata
dönüştü.

Müfredat hâline gelen bir metin kümesi, artık yalnızca okunmaz;
sınanır.[^k3] Bu geçiş, dosyanın merkezindeki sonucu doğurur.
...
Resmîleşen bir yorumun en önemli özelliği, zamanla yorum olduğunun
...
yöneltilen eleştirilerin bir bölümü, aslında bu düşünürün yorumuna
yöneliktir.[^k2] İki hedef ayrı ayrı gösterilmelidir.

## Temel ayrım

Düşünürün kuramsal katkısı, iki terim arasındaki ayrım üzerine
kuruludur.[^k1] Biri her şeyin düzenini ve ilkesini, öteki onun somut
maddesini gösterir.
...
## Bölge dışına yayılma

Bu yorum, doğduğu bölgede kalmadı ve komşu ülkelerde de resmî öğreti
konumu kazandı.[^k3] Her ülkede yerel koşullara göre yeniden yorumlandı.

Yayılmanın biçimi kaydedilmelidir. Yorum, fetihle değil metin ve
...
Düşünürün kendi hayatı boyunca devletle ilişkisi düzgün bir çizgi
izlemedi.[^k1] Görev aldığı dönemler de itibarının sorgulandığı dönemler de
kaydedilir.

Yorumun resmî konum kazanması, düşünürün ölümünden sonra
...
bulunamamıştır; bu bir kısıttır.

Okur bu sınırı bilerek okumalıdır.[^k1] Buradaki değerlendirmeler, özgün
metnin kendisinden değil akademik ansiklopedi maddelerinin aktarımından
gelir; özgün metin künyede yalnızca erişim noktası olarak durur.

## Terimlerin çevrilemezliği
...
Bir gelenekten dört metin seçmek, o geleneğin geri kalanını ikinci sıraya
...
Bir yorumun sınav içeriği hâline gelmesi, onu benimseyen kişi sayısını
artırır ama benimseme biçimini de değiştirir.[^k3] Sınava hazırlanan bir
öğrenci, metni anlamak için değil doğru cevabı vermek için okur.

Bu ayrım küçük görünür ama sonucu belirleyicidir.[^k1] Anlamak için okuma
...
Yaşadığı dönemin siyasi düzeni için
[Song Hanedanı](/aktor/song-hanedani/), yorumun taşındığı kurum için
[Bürokrasi](/kavram/burokrasi/) dosyaları uygundur.[^k3]

Bir yorumun metnin kendisi sanılması sorunu için
[Anakronizm](/kavram/anakronizm/), kaydı kimin tuttuğunun neyi değiştirdiği
için [Tarih yazımı](/kavram/tarih-yazimi/) dosyaları okunabilir.[^k2]

Bir metnin resmî yorumu ile metnin kendisini ayırt etmek isteyen okur, bu
dosyayı geleneğin kavram dosyasıyla birlikte okumalıdır; iki dosya arasındaki
fark, bu düşünürün eklediği katmandır.[^k2]
