---
id: kavram-kamusal-alan
tip: kavram
baslik: Kamusal alan
ozet: >-
  Kaynak tanımlara ayrı bir bölüm ayırır ve karşı-kamular ile feminist
  eleştirileri kendi başlığında tutar.
bolge: [avrupa, kuresel]
eksen: [siyasi, kulturel, felsefi]
guven_geneli: tartismali
etiketler: [kamusal-alan, karsi-kamular, feminist-elestiri, medya, tanim]
ilgili:
  - dusunur-arendt
  - kavram-sivil-toplum
...
kaynaklar:
  - anahtar: k1
    tur: ansiklopedi
    ad: "Wikipedia (EN) - Public sphere"
    url: https://en.wikipedia.org/wiki/Public_sphere
    erisim_tarihi: 2026-08-21
    dogrulama_dizesi: "Public sphere"
  - anahtar: k2
    tur: akademik
...
Kaynak medya başlığı altında siyasi kamusal alandaki aktörler, bir video
platformu, medyanın ve internetin sınırları, sanal alan ve aracılı kamusallık alt
başlıklarını tutar.[^k1]

Bir siyaset kavramının maddesinde teknoloji platformlarının ayrı alt başlıklar
taşıması,[^k1] kavramın taşıyıcısının zamanla değiştiğini gösterir; ilgili süreç
