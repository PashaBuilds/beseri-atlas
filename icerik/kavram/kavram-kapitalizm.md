---
id: kavram-kapitalizm
tip: kavram
baslik: Kapitalizm
ozet: >-
  Kaynak tanıma ayrı bir bölüm ayırır; kavramın kendisi tek bir tanımla değil
  sekiz özellik başlığıyla verilir.
bolge: [avrupa, kuresel]
eksen: [ekonomik, siyasi]
guven_geneli: tartismali
etiketler: [kapitalizm, tanim, ozellik-listesi, uretim-tarzi, tartisma]
ilgili:
  - kavram-merkantilizm
  - dusunur-braudel
  - dusunur-marx
...
çıkarılmasında bulunan bir düzen olarak anlatır.[^k2] O gelenek
