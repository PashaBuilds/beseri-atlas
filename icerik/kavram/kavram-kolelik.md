...
baslik: Kölelik
ozet: >-
  Bir kişi üzerinde mülkiyet hakkına bağlı yetkilerin kullanılması; 1926
  Kölelik Sözleşmesi'nde tanımlanan hukuki ölçüt ile toplumsal ölüm gibi
  toplumbilimsel tanımların aynı olguyu farklı ölçtüğü kavram.
bolge: [kuresel]
eksen: [ekonomik, siyasi, kulturel]
guven_geneli: tartismali
etiketler: [kolelik, tanim, borc-koleligi, serflik, zorla-calistirma, toplumsal-olum]
ilgili:
...
kaynaklar:
  - anahtar: k1
    tur: akademik
    ad: "Jean Allain, 'Slavery Convention' giris notu - BM Uluslararasi Hukuk Gorsel-Isitsel Kutuphanesi (Eylul 2017)"
    url: https://legal.un.org/avl/ha/sc/sc.html
    erisim_tarihi: 2026-08-29
    dogrulama_dizesi: "powers attaching to the right of ownership"
    not: "1926 tanimi, 1956 Ek Sozlesme muzakere tarihcesi ve terimin genislemesi; imzali uzman notu"
  - anahtar: k2
    tur: akademik
    ad: "Jenny Bourne, 'Slavery in the United States' - EH.Net Encyclopedia (Economic History Association)"
    url: https://eh.net/encyclopedia/slavery-in-the-united-states/
    erisim_tarihi: 2026-08-29
    dogrulama_dizesi: "Slavery is fundamentally an economic phenomenon"
    not: "Kolelik hukukunun mulkiyet hukukundan turetilmesi ve iktisadi verimlilik tartismasi"
  - anahtar: k3
    tur: ansiklopedi
    ad: "Mehmet Akif Aydin - Muhammed Hamidullah, 'KOLE' - TDV Islam Ansiklopedisi"
    url: https://islamansiklopedisi.org.tr/kole
    erisim_tarihi: 2026-08-29
    dogrulama_dizesi: "ehliyet ârızası"
    not: "Imzali madde; kolelige mulkiyet degil ehliyet uzerinden bakan hukuk gelenegi"
  - anahtar: k4
    tur: birincil
    birincil_tur: eser
    ad: "Frederick Douglass, Narrative of the Life of Frederick Douglass, an American Slave (1845; tam metin)"
    url: https://www.gutenberg.org/cache/epub/23/pg23.txt
    erisim_tarihi: 2026-08-29
    dogrulama_dizesi: "shall in all cases follow the condition of their"
    not: "Birinci agizdan anlati; statunun anneden gecmesi ve cocugun anneden ayrilmasi"
  - anahtar: k5
    tur: akademik
    ad: "Benedetta Rossi, 'Reflections on public slavery and social death', Bulletin of the Institute of Classical Studies 64 (2021) - Crossref kaydi"
    url: https://api.crossref.org/works/10.1093/bics/qbab024
    erisim_tarihi: 2026-08-29
    dogrulama_dizesi: "does not accurately capture the historical diversity"
    not: "Ozet duzeyinde destek: toplumsal olum eğretilemesinin karsilastirmali kullanimindaki sinir"
  - anahtar: k6
    tur: akademik
    ad: "Anne T. Gallagher, 'What's Wrong with the Global Slavery Index?', Anti-Trafficking Review (2017) - Crossref kaydi"
    url: https://api.crossref.org/works/10.14197/atr.20121786
    erisim_tarihi: 2026-08-29
    dogrulama_dizesi: "preliminary findings about the quality of the methodology"
    not: "Ozet duzeyinde destek: modern kolelik yayginlik olcumlerinin yontem elestirisi"
  - anahtar: k7
    tur: birincil
    birincil_tur: eser
    ad: "Karl Marx, Capital Vol. I, Bolum 31 'Genesis of the Industrial Capitalist' - Marxists Internet Archive"
...
serflik de, çocuğun sömürülmek üzere başkasına verilmesi de aynı adla
anılabiliyor. Kavramın işi bu yığını dağıtmaktır: hangi durumun
köleliğin kendisi, hangisinin ona benzeyen ayrı bir bağımlılık biçimi
olduğunu söyleyecek bir ölçüt aramak. Uluslararası hukukun verdiği ölçüt
1926 Kölelik Sözleşmesi'ndeki tanımdır; kölelik, üzerinde "mülkiyet hakkına
bağlı yetkilerin" tamamı ya da bir bölümü kullanılan kişinin statüsü veya
durumudur.[^k1]
...
## Ölçütün ayırdığı şey

Tanımın ilk yarısı olan "statü veya durum" ikilisi, kavramı hukuki
sahiplikle sınırlamayı engeller: statü hukuki bir kategori, durum ise bir
hâldir. Amerikalılar Arası İnsan Hakları Mahkemesi 2016 tarihli Fazenda
Brasil Verde kararında bu ikiliyi hem hukuken hem fiilen var olan durumlara
uygulanır saydı ve mülkiyet yetkilerini 2012 tarihli Bellagio-Harvard
İlkeleri'ne dayanarak açıkladı: bir kişi üzerinde, sömürü kastıyla,
zilyetliğe eş düşen bir denetim kurulmuşsa kölelik vardır.[^k1]

Ölçüt bir şeyi gölgede bırakır: köleleştirilen kişi mal muamelesi görürken
kişi olmayı sürdürür ve hukuk iki niteliği aynı anda taşımak zorunda kalır.
Bir Kentucky mahkemesi 1838'de Turner v. Johnson kararında kölelerin bu
ikili niteliğini açıkça yazar. Kölelik hukuku zaten mülkiyet ve hayvan
hukukundan olduğu kadar hizmetkâr, çalışan ve hür kişilere ilişkin
kurallardan devşirilerek kurulmuştu.[^k2]

Aynı gerilim mülkiyeti merkeze almayan bir hukuk geleneğinde de görülür.
TDV İslâm Ansiklopedisi'nin imzalı KÖLE maddesi, kölenin hukuki işlemlere
konu olması bakımından "mal" sayıldığını söyler; ama klasik fıkıh
kaynaklarındaki tarif köleliği bir "ehliyet ârızası" olarak kurar, üstelik
belirli bir bedel karşılığında hürriyet anlaşması yapılmış mükâteb köle
mülkiyet hakkına sahiptir ve kendi hesabına hukuki işlem yapabilir.[^k3]
...
Sözleşmesi, askerlik ve ceza infazı gibi kamusal istisnalar tanıyan bir tanım
kurdu.[^k1]

Terimin bugünkü sınırları 1956'da çizildi. Şubat 1956'daki taslak hâlâ
*kulluk* sözcüğünü taşırken, nihai metin bu sözcüğü atıp yerine *köleliğe
benzer kurum ve uygulamalar* ifadesini koydu; borç köleliği, serflik, angarya
...
Kölelik aynı zamanda bir iktisadi düzenlemedir; Jenny Bourne'un iktisat
tarihi maddesi bunu doğrudan söyler ve İç Savaş öncesinde Amerika Birleşik
Devletleri'nde yaşayan yaklaşık dört milyon kölenin piyasa değerini 3,1 ile
3,6 milyar dolar arasında tahmin edilen bir aralıkla verir.[^k2] Kârlılık ile
verimlilik ayrı sorulardır ve ikincisinde tartışma sürüyor: Fogel ve
Engerman 1974'te kölelerin ürettiklerinin yaklaşık yüzde doksanını
ellerinde tuttuklarını ileri sürmüş, başkaları yarıdan azını savunmuştu;
kaynağın bugünkü tahminlere dayanarak verdiği orta değer, tipik bir kölenin
ürettiği ek çıktının yaklaşık yarısıdır.[^k2]
...
Biçimleri Çalışma Grubu, başlığı kadın sünneti, namus cinayetleri ve sokak
...
Kavramın en yoğun uygulandığı yer Atlantik'tir: 1501 ile 1866 arasında
Afrika kıtasından zorla götürülüp Amerika kıtasında meta üretimine koşulan
