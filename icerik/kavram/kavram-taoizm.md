...
baslik: Taoizm
ozet: >-
  Doğaya uygunluk ve müdahale etmeme çevresinde kurulan Çin düşünce çizgisi;
  adı da Legalizm gibi sonradan yapılmış bir sınıflandırmadır ve iki ayrı
  olguyu — felsefe metinlerini ve dinî gelenekleri — tek başlığa toplar.
bolge: [dogu-asya]
eksen: [felsefi, dini, kulturel]
guven_geneli: tartismali
etiketler: [taoizm, dao, wuwei, ziran, adlandirma]
ilgili:
  - kavram-legalizm
  - dusunur-konfucyus
  - dusunur-han-feizi
...
kaynaklar:
  - anahtar: k1
    tur: akademik
    ad: "Stanford Encyclopedia of Philosophy - Daoism"
    url: https://plato.stanford.edu/entries/daoism/
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Daoism"
...
yönetim, en az fark edilen yönetimdir.
...
Karşıt yönetim anlayışları için [Han Feizi](/dusunur/han-feizi/) ve
[Konfüçyüs](/dusunur/konfucyus/) dosyaları, ödünç alınmış terimlerin
çarpıtma riski için [Feodalite kavramı](/tartisma/feodalite-kavrami/) dosyası
uygundur.
