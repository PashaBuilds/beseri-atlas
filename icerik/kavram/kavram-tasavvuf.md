...
baslik: Tasavvuf
ozet: >-
  Kaynak kavramı bir öğreti değil bir hayat tarzı olarak tanımlar; tanımda zâhir
  ve bâtın hükümleri birlikte anılır.
bolge: [islam-dunyasi]
eksen: [dini, felsefi, kulturel]
guven_geneli: yaygin
etiketler: [tasavvuf, zahir, batin, hayat-tarzi, tanim]
ilgili:
  - dusunur-gazali
  - kavram-ictihad
...
kaynaklar:
  - anahtar: k1
    tur: ansiklopedi
    ad: "TDV İslâm Ansiklopedisi — TASAVVUF"
    url: https://islamansiklopedisi.org.tr/tasavvuf
    erisim_tarihi: 2026-08-21
    dogrulama_dizesi: "TASAVVUF"
    not: "Muellif: Resat Ongoren; baski tarihi 2011"
  - anahtar: k2
    tur: akademik
    ...
    not: "Kaynagin mutasavvif olarak da kaydettigi dusunur; bagimsiz alan adi"
  - anahtar: k3
    tur: ansiklopedi
...
Tanımın her iki hüküm türünü birlikte içermesi,[^k1] kavramın hukukun dışında
değil onunla birlikte konumlandırıldığını gösterir; hukuk yöntemi tarafı
[İctihad](/kavram/ictihad/) dosyasında ele alınıyor.[^k3]

## Aynı kişi hem fakih hem mutasavvıf sayılabilir
