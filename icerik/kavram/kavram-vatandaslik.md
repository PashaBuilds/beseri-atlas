---
id: kavram-vatandaslik
tip: kavram
baslik: Vatandaşlık
ozet: >-
  Bir düzenin kimi kendi üyesi saydığı; atlasta bir kişinin hangi
  hukukun koruması altında olduğunu belirleyen ve verilebildiği kadar
  alınabilen bağ.
tarih_baslangic: "-500"
bolge: [kuresel, avrupa, afrika, amerika, islam-dunyasi, okyanusya]
eksen: [siyasi, kulturel, ekonomik, demografik]
guven_geneli: yaygin
etiketler: [vatandaslik, uyelik, tabiiyet, haklar, disarida-birakma]
ilgili:
  - kavram-ulus-devlet
  - kavram-egemenlik
  - kavram-apartheid
...
kaynaklar:
  - anahtar: k1
    tur: akademik
    ad: "Stanford Encyclopedia of Philosophy - Citizenship"
    url: https://plato.stanford.edu/entries/citizenship/
    erisim_tarihi: 2026-08-26
    dogrulama_dizesi: "Citizenship"
    not: "Kavramin cozumlemesi"
  - anahtar: k2
    tur: ansiklopedi
    ad: "Wikipedia (EN) - Citizenship"
    url: https://en.wikipedia.org/wiki/Citizenship
    erisim_tarihi: 2026-08-26
    dogrulama_dizesi: "Citizenship"
...
bağdır.[^k1] Üyelik, hem yükümlülük hem koruma doğurur.
...
Üç temel yol vardır.[^k1] Birincisi ana babadan geçen bağ, ikincisi
doğulan yerin belirlediği bağ, üçüncüsü sonradan verilen bağdır.
...
Kavramın en belirleyici özelliği verilebildiği kadar
alınabilmesidir.[^k1] Bir düzen, üyeliğini geri çekebilir.
...
Hiçbir düzenin üyesi sayılmayan kişiler, hiçbir düzenin koruması
altında değildir.[^k3] Bu konum, hakların pratikte nereden geldiğini
gösterir.
...
Üyelik her zaman tek katmanlı değildir.[^k1] Kent üyeliği, eyalet
üyeliği ve devlet üyeliği ayrı ayrı bulunabilir.
...
İki terim aynı şeyi anlatmaz.[^k1] Tebaalık, bir hükümdara tabi
olmayı; vatandaşlık, bir siyasi topluluğun üyesi olmayı belirtir.
...
Üyelik her zaman tam değildir.[^k1] Bir kişi vatandaş sayılırken oy
...
Üyelik pratikte bir belgeyle kanıtlanır.[^k1] Belgesi olmayan kişi,
hukuken üye olsa bile fiilen kullanamaz.

Kayıt düzeninin kapsamı bu yüzden doğrudan bir haklar
...
Sömürge yönetimlerinin çoğu iki katmanlı bir üyelik kurdu.[^k1]
Yerleşimciler ana ülkenin vatandaşı, yerel nüfus ayrı bir hukuki
kategori sayıldı.
...
Bağımsızlık, üyelik sorusunu ortadan kaldırmaz.[^k1] Yeni kurulan
düzenler kimin vatandaş olacağına yeniden karar verdi.

Bazı örneklerde önceki dönemde getirilmiş nüfus bu kararın dışında
...
Üyeliğin geri çekilmesinin en kapsamlı örneği için
[Apartheid düzeni](/kavram/apartheid/), hiçbir tarafın üyesi
sayılmama örneği için
[Yeni Hebridler ortak yönetimi](/aktor/yeni-hebridler-ortak-yonetimi/)
dosyaları uygundur.[^k2]

Farklı hukuka tabi grupların bir arada yönetilmesi için
[Millet sistemi](/kavram/millet-sistemi/) dosyası okunabilir.[^k3]
