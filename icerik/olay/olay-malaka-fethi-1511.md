---
id: olay-malaka-fethi-1511
tip: olay
baslik: Malaka'nın alınması (1511)
ozet: >-
  Bir Avrupa donanmasının Güneydoğu Asya'nın en büyük limanını ele geçirmesi;
  atlasta bir geçidi denetlemenin ticareti denetlemeye yetmediğinin en açık
  ölçüldüğü olay.
donem: "09"
tarih_baslangic: "1511-07-01"
tarih_bitis: "1511-08-24"
bolge: [dogu-asya, islam-dunyasi, avrupa]
eksen: [askeri, ekonomik, siyasi]
guven_geneli: yaygin
etiketler: [malaka, bogaz, portekiz, liman, deniz-gucu, ticaret]
ilgili:
  - donem-09
...
kaynaklar:
  - anahtar: k1
    ...
    not: "Sehrin ve sultanligin tarihi"
  - anahtar: k2
    tur: birincil
    birincil_tur: eser
    ad: "The Malay Annals (Sejarah Melayu) — Raffles MS 18, C. C. Brown cevirisi"
    url: https://archive.org/details/malay-annals-C.-C.-Brown
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Malay Annals"
    not: "Kaybeden tarafin kendi saray anlatisi"
  - anahtar: k3
    tur: ansiklopedi
    ad: "Wikipedia (EN) - Capture of Malacca (1511)"
    url: https://en.wikipedia.org/wiki/Capture_of_Malacca_(1511)
    erisim_tarihi: 2026-08-25
    dogrulama_dizesi: "Malacca"
...
Limanın değeri konumundan geliyordu.[^k1] Mevsim rüzgârlarının belirlediği
...
Kuşatan tarafın gemi ve asker sayısı, savunanınkinin çok altındaydı.[^k3]
Buna rağmen sonuç kısa sürede alındı ve bu, sayı üstünlüğünün tek başına
belirleyici olmadığını gösterir.

Belirleyici olan, gemilerin taşıdığı topların menzili ve limanın deniz
...
Limanın nüfusunun büyük bölümü, sultanlığın kendi tebaası değil yerleşik
yabancı tüccar topluluklarıydı.[^k1][^k2] Bu yapı, barış zamanında bir
üstünlüktü; kuşatmada değil.

Çıkara dayanan bir bağ, çıkar tehdit altına girdiğinde çözülür.[^k1] Kaynaklar
...
sorunları görünmez kılar.

## İki kaydın karşılaştırılması

İki taraf da olayı kaydetmiştir ve iki kayıt farklı şeyleri kayda değer
bulur.[^k2][^k3] Fetheden tarafın kaydı topların ve manevraların
ayrıntısını, kaybeden tarafın kaydı saray içi ilişkileri öne çıkarır.

Bu fark bir bilgidir.[^k3] Bir tarafın neyi ayrıntılandırdığı, o tarafın
...
Limanın el değiştirmesi, bölgedeki ticareti sona erdirmedi.[^k1] Tüccarlar
...
Kuşatmadaki asker ve gemi sayılarına dair rakamlar, büyük ölçüde fetheden
tarafın kayıtlarından gelir.[^k3] Bağımsız bir sayım bulunmamaktadır.

Bu kayıtların yönü bellidir.[^k3] Az sayıda gemiyle büyük bir şehri almak,
...
Limanın düşmesi, bölgedeki öteki liman devletlerinin davranışını da
...
Sefer, ilk temas değildi.[^k3] Aynı devlet birkaç yıl önce limana bir heyet
göndermiş, ticaret izni istemiş ve heyet ile yerel yönetim arasında bir
anlaşmazlık çıkmıştı.

Bu ön tarih, seferin gerekçelendirilmesinde kullanıldı.[^k3] Fetheden tarafın
...
Liman el değiştirdikten sonra eski işlevini tam olarak sürdüremedi.[^k1]
Yeni yönetim, tüccarlara önceki düzenin sunduğu tarafsızlığı sunmadı ve
ayrıcalıklar taraf tutar hâle geldi.

Bu, bir liman devletinin sermayesinin ne olduğunu gösterir.[^k1] Limanın
...
Sefer, aynı devletin Hint Okyanusu'nda kurmaya çalıştığı geniş bir denetim
planının parçasıydı.[^k3] Aynı yıllarda başka geçitlerde de benzer girişimler
yapıldı.

Planın mantığı, okyanusun birkaç dar geçidinin tutulmasıyla bütün ticaretin
...
Limanın bağlı olduğu deniz ağı için
[Hint Okyanusu ticareti](/kavram/hint-okyanusu-ticareti/), limandaki yabancı
topluluklar için [Ticaret diasporası](/kavram/ticaret-diasporasi/) dosyaları
uygundur.[^k2]

Olayın nasıl adlandırılacağı için
[Keşif mi istila mı](/tartisma/kesif-mi-istila-mi/) dosyası okunmalıdır.[^k3]

Aynı düzenin kuzeybatı ucundaki bir başka liman devleti için
[Gucerât Sultanlığı](/aktor/gucerat-sultanligi/) dosyası okunabilir; orada
donanma kurmama tercihinin bedeli ayrıca kaydedilmiştir.[^k1]
