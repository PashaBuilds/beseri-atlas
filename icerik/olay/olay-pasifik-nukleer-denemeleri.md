---
id: olay-pasifik-nukleer-denemeleri
tip: olay
baslik: "Pasifik'te nükleer denemeler (1946–1996)"
ozet: >-
  Vesayet altındaki adalarda, o adaların halkı karar sürecinde
  bulunmadan yürütülen elli yıllık deneme programı; atlasta vesayet
  düzeninin en somut sınandığı yer.
donem: "14"
tarih_baslangic: "1946"
tarih_bitis: "1996"
bolge: [okyanusya, amerika, avrupa]
eksen: [siyasi, askeri, demografik]
guven_geneli: yaygin
etiketler: [nukleer, deneme, vesayet, pasifik, tahliye, okyanusya]
ilgili:
  - donem-14
  - donem-15
...
kaynaklar:
  - anahtar: k1
    tur: ansiklopedi
    ad: "Wikipedia (EN) - Pacific Proving Grounds"
    url: https://en.wikipedia.org/wiki/Pacific_Proving_Grounds
    erisim_tarihi: 2026-08-26
    dogrulama_dizesi: "Pacific Proving Grounds"
    not: "Giris kapisi; havuz kurali geregi makalede en fazla bir tane"
  - anahtar: k2
    tur: birincil
    birincil_tur: belge
    ad: "Partial Test Ban Treaty (1963) — Wikisource"
    url: https://en.wikisource.org/wiki/Partial_Test_Ban_Treaty
    erisim_tarihi: 2026-08-26
    dogrulama_dizesi: "Test Ban"
    not: "Atmosferdeki denemeleri yasaklayan metin; tarafi olmayan devletler icin baglayici degil"
  - anahtar: k3
    tur: birincil
    birincil_tur: belge
    ad: "Covenant of the League of Nations — Wikisource"
    url: https://en.wikisource.org/wiki/Covenant_of_the_League_of_Nations
    erisim_tarihi: 2026-08-26
...
## Denetim mekanizmasının durumu

Vesayet düzeni bir denetim öngörüyordu.[^k3] Emanetçi yıllık rapor
veriyor ve yerel nüfus dilekçe gönderebiliyordu.
...
Deneme alanları belirli özelliklere göre seçildi.[^k1] Nüfus
yoğunluğunun düşük olması, ana karadan uzaklık ve hâkim rüzgâr yönü
sayılan ölçütlerdi.
...
Mesafe yalnızca fiziksel değildir.[^k1] Karar vericinin seçmen tabanı
ile riskin taşıyıcısı arasındaki siyasi mesafe de belirleyicidir.

Vesayet statüsü bu mesafeyi hukuki olarak kurumsallaştırır.[^k3] Emanet
...
Hâkim rüzgâr yönüne göre yapılan hesap, serpintinin nereye
gideceğini öngörmeyi hedefliyordu.[^k1] Hesap bazı denemelerde tuttu,
bazılarında tutmadı.
...
Deneme alanlarındaki topluluklar başka adalara nakledildi.[^k1]
Nakillerin bir bölümü geçici olarak sunuldu.
...
Dönüş, alanın yeniden yaşanabilir sayılmasına bağlıydı.[^k1] Bu
değerlendirmeyi yapan taraf, denemeleri yürüten taraftı.
...
Denemelerin etkileri hakkındaki bilgi, uzun süre tek taraflı
tutuldu.[^k1] Ölçüm verileri sınıflandırılmıştı.
...
Bazı alanlarda topluluk önderlerinden onay alındığı
kayıtlıdır.[^k1] Onay, taşınmanın geçici olduğu ve dönüşün mümkün olacağı
bilgisiyle verildi.
...
1963'te atmosferdeki denemeleri yasaklayan bir antlaşma
imzalandı.[^k2] Antlaşma, yer altı denemelerini kapsam dışında
bıraktı.
...
Antlaşmanın yer altını kapsam dışı bırakması da bir tercihtir.[^k2]
Kapsam, teknik olarak doğrulanabilir olanla sınırlandırıldı.

Doğrulanabilirlik ölçütü, kapsamı belirleyen etkendi.[^k1] Atmosferdeki
...
Yetmişli ve seksenli yıllarda bölgedeki devletler ortak tutum
geliştirdi.[^k1] Bir bölgesel antlaşma, denemeleri ve nükleer atık
boşaltımını yasakladı.

Antlaşma, denemeleri yürüten devletleri doğrudan bağlamıyordu.[^k2]
...
Bölgedeki bağımsızlık süreçleri aynı onyıllara denk gelir.[^k1] Deneme
programı, bağımsızlık taleplerinin gerekçelerinden biri oldu.

Bazı bölgelerde bağımsızlık müzakereleri, deneme alanlarının statüsünü
...
Bazı topluluklar için tazminat fonları kuruldu.[^k1] Fonların
büyüklüğü, hesaplanan zararın altında kaldı.
...
Bazı adalar kalıcı olarak yaşanamaz hâle geldi.[^k1] Bir mercan
adasında, atıkların toplandığı bir beton örtü inşa edildi.
...
Altı Okyanusya dosyasında da aynı yapı görülür.[^k3] Bölgeyi doğrudan
...
Tazminatın yeterli olup olmadığı da değerlendirilmez.[^k3] Mekanizmanın
kurulduğu ve ödemelerin kısmi kaldığı kaydedilir.
...
Aynı okyanustan benzer bir yapı için [Nauru](/aktor/nauru/), bölgedeki
paylaşım masası için
[Samoa Krallığı](/aktor/samoa-kralligi/) dosyaları uygundur.[^k1]

Dönemin nükleer gerilimi için
[Küba füze krizi](/olay/kuba-fuze-krizi/), sürecin genel çerçevesi için
[Sömürgesizleşme](/kavram/somurgesizlesme/) dosyaları okunabilir.[^k2]

Devredilen ve korunan yetkinin ne olduğu için
[Egemenlik](/kavram/egemenlik/) dosyası okunmalıdır.[^k3]
