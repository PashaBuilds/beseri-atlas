---
id: veri-okuryazarlik-1475-2023
tip: veri
baslik: Okuryazarlık oranı, 1820–2024
ozet: >-
  1820'de yüzde 12,05, 2024'te yüzde 87,74 — iki yüz yılda yedi kat; ve serinin
  1820'den önce hiç gözlem içermemesi.
tarih_baslangic: "1820"
tarih_bitis: "2024"
bolge: [kuresel]
eksen: [kulturel, demografik]
guven_geneli: yaygin
etiketler: [okuryazarlik, veri-seti, baslangic-yili, owid, olcut]
ilgili:
  - kavram-yazi-sistemi
...
kaynaklar:
  - anahtar: k1
    ...
    not: "CSV uc noktasindan 2026-08-21'de indirildi; veri-setleri/okuryazarlik.LISANS.md"
  - anahtar: k2
    tur: veri
    ...
    not: "Oranin uzerine uygulanacagi toplam"
  - anahtar: k3
    tur: ansiklopedi
...
Seri 1820'de yüzde 12,046689 ile başlar ve 2024'te yüzde 87,74 ile biter; toplam
61 gözlem vardır.[^k1]

## Başlık ile veri arasındaki fark kayıtlıdır

Bu dosyanın kimliği 1475'ten başlayan bir aralığı adlandırır, ancak veri
kümesinde 1820'den önce dünya toplamı için gözlem yoktur.[^k1]
...
## Ölçütün kendisi tanımlanmalıdır

Okuryazarlık, ölçüm biriminin tanımına bağlıdır: bir kişinin okuryazar sayılması
için hangi yeterliğin arandığı, kullanılan tanım değiştiğinde sonucu da
değiştirir.[^k1]

Atlasın kuralı şudur: bu seriden okunan değerler, hangi tanımın kullanıldığı
belirtilmeden aktarılmaz. Ölçünün konusu için ayrı bir kayıt tutulur; o kayıt
yazı sistemlerini iki ayrı ölçüte göre sınıflandırır.[^k3] Kavram
[Yazı sistemi](/kavram/yazi-sistemi/) dosyasında ele alınıyor.

## İki yüz yılda yedi kat

Serinin ilk ve son değeri arasındaki oran yaklaşık yedi kattır.[^k1]

Atlas bu artışı bir nedene bağlamaz: veri kümesi oranı verir, nedenlerini
vermez.[^k1]
...
[Dünya nüfusu, 1500–2025](/veri/dunya-nufusu-1500-2025/) dosyasında, kaynak
sınıflandırması ise
[Birincil kaynak](/kavram/birincil-kaynak/) dosyasında ele alınıyor.

## Bu dosyanın sınırı

Ülke ülke oranlar, cinsiyete göre dağılım ve tanım farkları burada ayrı
