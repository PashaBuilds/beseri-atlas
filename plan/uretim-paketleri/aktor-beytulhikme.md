# Üretim paketi — Beytülhikme

**Kimlik:** `aktor-beytulhikme`
**Gelecek rota:** `bilgi-nasil-guvenilir-olur` · 2/6
**Bölge / eksen:** islam-dunyasi · kulturel, siyasi, felsefi
**Anlatı biçimi:** `kurum-efsanesi`

## Makalenin çözeceği soru

Abbasi Bağdat'ındaki çeviri ve kitap toplama faaliyetleri tek bir “Bilgelik Evi” kurumunda mı örgütlendi, yoksa sonraki anlatılar dağınık ağları mı birleştirdi?

## Korpusa benzersiz katkısı

Ünlü bir kurumun kesin görünen sınırlarını kaynak düzeyinde sorgular; saray himayesi, özel çevirmen ağları ve kütüphane terimlerini ayırır.
...
Abbasi dönemi biyografi ve bibliyografya metinleri ile ödeme ve çeviri kayıtları.
