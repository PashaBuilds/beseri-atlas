# Üretim paketi — Lapita kültürü

**Kimlik:** `aktor-lapita-kulturu`
**Gelecek rota:** `okyanuslar-dunyayi-nasil-bagladi` · 1/6
**Bölge / eksen:** okyanusya · kulturel, demografik, ekonomik
**Anlatı biçimi:** `nesne-izleme`

## Makalenin çözeceği soru

Benzer çanak çömlek, bitki ve hayvan izleri Pasifik'in ilk büyük yerleşim ağını ne ölçüde tek bir “halk” olarak yorumlamaya izin verir?

## Korpusa benzersiz katkısı

Yazılı kaynak olmadan göç ve bağlantının nasıl kurulduğunu tek bir süsleme üslubuna indirgemeden arkeoloji, dil ve genetik kanıtın farklı ölçekleriyle gösterir.

## Anlatı kararı

Tek bir nesne grubunun coğrafi izini sür; nesneden toplumun tamamına kanıtsız sıçrama yapma.

## Birincil kanıt hedefi

Açık kazı raporları, radyokarbon dizileri ve Lapita seramik katalogları.

## Başlangıç kaynakları — kaynak değil, doğrulanacak araştırma uçları

- [ ] https://press.anu.edu.au/publications/series/terra-australis/oceanic-explorations
- [ ] https://www.ioa.ucla.edu/talepakemalai
- [ ] https://www.archaeopress.com/Archaeopress/Products/9781803270883
- [ ] https://pacificarchaeology.org/index.php/journal/article/view/55
- [ ] https://www.ebi.ac.uk/europepmc/webservices/rest/PMC5515717/fullTextXML
