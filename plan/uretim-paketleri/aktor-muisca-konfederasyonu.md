# Üretim paketi — Muisca Konfederasyonu

**Kimlik:** `aktor-muisca-konfederasyonu`
**Gelecek rota:** `kent-devleti-mi-ag-mi-dogurur` · 2/6
**Bölge / eksen:** amerika · siyasi, ekonomik, kulturel
**Anlatı biçimi:** `fetih-kaynagi-elestirisi`

## Makalenin çözeceği soru

İspanyol kroniklerinin “konfederasyon” diye birleştirdiği Muisca siyasal birimleri gerçekte hangi haraç, akrabalık ve rekabet ilişkileriyle bağlıydı?

## Korpusa benzersiz katkısı

Fetih sonrası bir sınıflandırmayı geçmişe taşımak yerine arkeolojik yerleşim, tuz ve altın dolaşımı ile rakip kronikleri karşılaştırır.
...
Erken İspanyol kronikleri, haraç kayıtları, Muisca arkeolojisi ve yerli adlandırma verileri.
