# Üretim paketi — Mutapa Devleti

**Kimlik:** `aktor-mutapa-devleti`
**Gelecek rota:** `kent-devleti-mi-ag-mi-dogurur` · 4/6
**Bölge / eksen:** afrika · siyasi, ekonomik, askeri
**Anlatı biçimi:** `ticaret-pazarligi`

## Makalenin çözeceği soru

Altın üretimi ile Hint Okyanusu ticareti Mutapa hükümdarlarına nasıl güç verdi ve Portekiz müdahalesi bu aracı ağları neden tamamen denetleyemedi?

## Korpusa benzersiz katkısı

İç Afrika ile kıyı ticaretini iki ayrı dünya gibi sunmaz; maden, tüccar, vergi, diplomasi ve askerî ittifak arasındaki pazarlığı izler.
...
Portekiz yazışmaları, Svahili ticaret kayıtları, maden arkeolojisi ve yerel sözlü gelenek.
