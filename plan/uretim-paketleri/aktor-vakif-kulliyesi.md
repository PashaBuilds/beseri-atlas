# Üretim paketi — Vakıf külliyesi

**Kimlik:** `aktor-vakif-kulliyesi`
**Gelecek rota:** `din-gundelik-duzeni-nasil-kurur` · 3/6
**Bölge / eksen:** islam-dunyasi, bati-asya, avrupa, afrika · dini, ekonomik, siyasi, kulturel
**Anlatı biçimi:** `para-akisi-haritasi`

## Makalenin çözeceği soru

Bir vakıf cami, okul, aşevi ve su yapısını yüzyıllarca finanse ederken dindarlığı mülk geliri, çalışan emeği ve kentsel hizmetle hangi sözleşme içinde birleştirdi?

## Korpusa benzersiz katkısı

Dini hayır kurumunu yalnız niyet üzerinden anlatmaz; gelir getiren dükkândan ücretli göreve ve bedelsiz hizmete uzanan maddi devri izleyerek sürekliliğin koşullarını gösterir.
...
Vakfiye metinleri, muhasebe defterleri, personel listeleri, mahkeme uyuşmazlıkları, kira kayıtları ve yapı kitabeleri.
