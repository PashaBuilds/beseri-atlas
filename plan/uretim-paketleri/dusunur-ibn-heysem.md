# Üretim paketi — İbnü'l-Heysem

**Kimlik:** `dusunur-ibn-heysem`
**Gelecek rota:** `bilgi-nasil-guvenilir-olur` · 1/6
**Bölge / eksen:** islam-dunyasi, afrika · felsefi, kulturel
**Anlatı biçimi:** `deney-yeniden-kurma`

## Makalenin çözeceği soru

İbnü'l-Heysem görmenin gözden çıkan ışınlarla gerçekleştiği fikrini hangi gözlem, geometrik model ve itiraz zinciriyle değiştirdi?

## Korpusa benzersiz katkısı

“Bilimsel yöntemi icat etti” sloganını tekrarlamaz; belirli bir optik problemin metin, deney ve matematik arasında nasıl çözüldüğünü yeniden kurar.

## Anlatı kararı

Bir problemin gözlem, model, itiraz ve sınama adımlarını yeniden kur.

## Birincil kanıt hedefi

Kitâbü'l-Menâzır'ın açık Arapça ya da Latince nüshası ve eleştirel çeviri bölümleri.

## Başlangıç kaynakları — kaynak değil, doğrulanacak araştırma uçları

- [ ] https://mathshistory.st-andrews.ac.uk/DSB/Al-Haytham.pdf
- [ ] https://www.unesco.org/en/articles/ibn-al-haythams-scientific-method
- [ ] https://arxiv.org/abs/1902.03301
