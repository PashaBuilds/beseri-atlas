# Üretim paketi — Mary Wollstonecraft

**Kimlik:** `dusunur-mary-wollstonecraft`
**Gelecek rota:** `kadinlar-yurttasligi-nasil-genisletti` · 2/6
**Bölge / eksen:** avrupa · felsefi, siyasi, kulturel
**Anlatı biçimi:** `kavram-soykutugu`

## Makalenin çözeceği soru

Wollstonecraft eşitliği doğal haklardan türetirken eğitim, sınıf ve bağımlılık arasındaki hangi mekanizmayı görünür kıldı?

## Korpusa benzersiz katkısı

Aydınlanma rotasındaki evrensellik sınırını bir kadın yazarın kendi metni üzerinden açar ve hak dilinin aile içindeki maddi koşullarla ilişkisini gösterir.
...
A Vindication of the Rights of Woman'ın 1792 baskısı ile çağdaş eleştiriler.
