# Üretim paketi — Sojourner Truth

**Kimlik:** `dusunur-sojourner-truth`
**Gelecek rota:** `kadinlar-yurttasligi-nasil-genisletti` · 3/6
**Bölge / eksen:** amerika · siyasi, kulturel
**Anlatı biçimi:** `ses-ve-aktarım`

## Makalenin çözeceği soru

Sojourner Truth'un konuşmasının birbirinden farklı iki kaydı, ırk ve toplumsal cinsiyet hakkındaki tarihsel bir sesi nasıl yeniden kurdu?

## Korpusa benzersiz katkısı

Ünlü bir alıntıyı tekrarlamak yerine konuşmanın 1851 ve 1863 sürümlerini karşılaştırır; belleğin, lehçenin ve siyasal simgeleştirmenin metni nasıl değiştirdiğini öğretir.
...
Marius Robinson'un 1851 kaydı, Frances Gage'in 1863 sürümü ve Truth'un dikte edilmiş anlatısı.
