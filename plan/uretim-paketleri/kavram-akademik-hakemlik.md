# Üretim paketi — Akademik hakemlik

**Kimlik:** `kavram-akademik-hakemlik`
**Gelecek rota:** `bilgi-nasil-guvenilir-olur` · 5/6
**Bölge / eksen:** kuresel, avrupa · kulturel, siyasi
**Anlatı biçimi:** `kurum-soykutugu`

## Makalenin çözeceği soru

Bir iddianın yayımlanmadan önce uzmanlarca okunması ne zaman standartlaştı ve hakemlik hatayı azaltırken hangi önyargıları yeniden üretebilir?

## Korpusa benzersiz katkısı

Hakemliği zamansız bilim kuralı gibi sunmaz; editör denetiminden dış rapora, tek körden açık hakemliğe uzanan kurumsal değişimi karşılaştırır.
...
Erken bilim dergilerinin editör kayıtları, hakem raporları ve modern yayın etiği belgeleri.
