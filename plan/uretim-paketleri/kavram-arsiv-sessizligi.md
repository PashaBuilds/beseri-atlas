# Üretim paketi — Arşiv sessizliği

**Kimlik:** `kavram-arsiv-sessizligi`
**Gelecek rota:** `gecmis-kimin-hatirasidir` · 5/6
**Bölge / eksen:** kuresel · kulturel, siyasi
**Anlatı biçimi:** `kayip-belge-sorusturmasi`

## Makalenin çözeceği soru

Bir kişinin ya da topluluğun arşivde görünmemesi yaşamadığı veya etkisiz olduğu anlamına mı gelir; kaydetme, saklama, sınıflandırma ve erişim kararları sessizliği nasıl üretir?

## Korpusa benzersiz katkısı

“Kaynak yok” cümlesini araştırmanın sonu olmaktan çıkarır; sessizliğin olay sırasında, arşiv kurarken, kataloglarken ve tarih yazarken oluşan ayrı mekanizmalarını gösterir.
...
Arşiv edinim politikaları, katalog değişimleri, imha çizelgeleri, erişim kararları ve alternatif sözlü-nesnel kanıtla yeniden kurulan vaka dosyaları.
