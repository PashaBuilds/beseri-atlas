# Üretim paketi — Çevre adaleti

**Kimlik:** `kavram-cevre-adaleti`
**Gelecek rota:** `cevre-felaketi-kimin-kararidir` · 5/6
**Bölge / eksen:** kuresel, amerika, afrika, okyanusya · siyasi, ekonomik, demografik
**Anlatı biçimi:** `kavramdan-olcume`

## Makalenin çözeceği soru

Çevresel zararın miktarı kadar kimlere yüklendiğini sormak politika değerlendirmesini nasıl değiştirir ve adalet hangi ölçütlerle ölçülebilir?

## Korpusa benzersiz katkısı

Kavramı bir slogan olarak bırakmaz; dağıtım, karar sürecine katılım, tanınma ve onarım boyutlarını tarihsel vakalarda ayrı ayrı sınar.
...
Çevre adaleti hareketi bildirileri, dava dosyaları, mekânsal maruziyet verileri ve politika metinleri.
