# Üretim paketi — Epidemiyolojik geçiş

**Kimlik:** `kavram-epidemiyolojik-gecis`
**Gelecek rota:** `salgin-toplumu-nasil-degistirir` · 5/6
**Bölge / eksen:** kuresel, afrika, guney-asya, amerika · demografik, ekonomik, siyasi
**Anlatı biçimi:** `model-ve-aykiri-vaka`

## Makalenin çözeceği soru

Toplumlar bulaşıcı hastalıktan kronik hastalığa doğru tek yönlü bir geçiş mi yaşar; ikisinin aynı anda yüksek olduğu ülkeler ve geri dönen salgınlar modeli nasıl değiştirir?

## Korpusa benzersiz katkısı

Demografik modeli evrensel basamaklar dizisi olarak ezberletmez; ölüm nedeni sınıflandırması, yaş yapısı, eşitsizlik ve çift hastalık yükü üzerinden modelin kullanım sınırlarını öğretir.
...
Özgün geçiş makalesi, uzun dönem ölüm nedeni serileri, yaşa göre ölüm tabloları, hastalık sınıflandırma değişimleri ve aykırı ülke verileri.
