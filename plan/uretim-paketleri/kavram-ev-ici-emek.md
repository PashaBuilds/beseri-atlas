# Üretim paketi — Ev içi emek

**Kimlik:** `kavram-ev-ici-emek`
**Gelecek rota:** `emek-neden-ozgur-gorunur` · 5/6
**Bölge / eksen:** kuresel · ekonomik, demografik, kulturel
**Anlatı biçimi:** `gorunmeyen-zaman-hesabi`

## Makalenin çözeceği soru

Yemek, bakım, temizlik ve çocuk yetiştirme piyasa fiyatına sahip olmadığında ekonominin dışında mı kalır; zaman kullanımı ölçümleri bu görünmezliği nasıl değiştirir?

## Korpusa benzersiz katkısı

Ücretsiz emeği yalnız ahlaki takdir konusu yapmaz; milli gelir hesabı, ücret ikamesi, fırsat maliyeti ve bakım ilişkisi ölçülerinin neyi gösterip gizlediğini karşılaştırır.
...
Erken hane bütçeleri, zaman kullanım günlükleri, nüfus sayımı talimatları, feminist kampanya metinleri ve ulusal hesap yöntemleri.
