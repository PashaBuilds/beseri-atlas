# Üretim paketi — Sözlü hukuk

**Kimlik:** `kavram-sozlu-hukuk`
**Gelecek rota:** `hukuk-kimin-sozunu-gecerli-kilar` · 5/6
**Bölge / eksen:** afrika, okyanusya, kuresel · siyasi, kulturel
**Anlatı biçimi:** `durusma-karsilastirmasi`

## Makalenin çözeceği soru

Bir kural yazılı değilse daha mı değişkendir; topluluk hafızası, arabulucu otoritesi ve tekrar eden kararlar hukuki sürekliliği hangi araçlarla kurar?

## Korpusa benzersiz katkısı

Yazıyı hukukla eş anlamlı sayan varsayımı farklı uyuşmazlık kayıtlarıyla sınar; esneklik ile keyfîlik, süreklilik ile donmuşluk arasındaki farkı somutlaştırır.
...
Kaydedilmiş yerel duruşmalar, sözlü hukuk anlatıları, arabuluculuk tutanakları ve sömürge kodifikasyonundan önce-sonra karşılaştırmaları.
