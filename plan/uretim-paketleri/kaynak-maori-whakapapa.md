# Üretim paketi — Māori whakapapa kayıtları

**Kimlik:** `kaynak-maori-whakapapa`
**Gelecek rota:** `gecmis-kimin-hatirasidir` · 3/6
**Bölge / eksen:** okyanusya · kulturel, siyasi, dini
**Anlatı biçimi:** `soy-ve-yer-haritasi`

## Makalenin çözeceği soru

Whakapapa soy dizileri insanları yalnız atalara değil toprağa, canlılara ve yükümlülüklere bağladığında bir geçmiş kaydı ile siyasal hak iddiası nasıl aynı biçimde birleşir?

## Korpusa benzersiz katkısı

Soy listesini kronoloji çıkarmaya yarayan ham veri olarak kullanmaz; bilginin kim tarafından, hangi bağlamda ve hangi erişim kuralıyla aktarılmasının anlamın parçası olduğunu öğretir.
...
İwi tarafından erişime açılmış whakapapa kayıtları, Waitangi Mahkemesi tanıklıkları, sözlü anlatılar, yer adları ve topluluk onaylı arşiv açıklamaları.
