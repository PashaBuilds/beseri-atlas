# Üretim paketi — Hint sözleşmeli emek göçü

**Kimlik:** `olay-hint-sozlesmeli-emek-gocu`
**Gelecek rota:** `emek-neden-ozgur-gorunur` · 3/6
**Bölge / eksen:** guney-asya, afrika, amerika, okyanusya · ekonomik, demografik, siyasi
**Anlatı biçimi:** `sozlesme-rotasi`

## Makalenin çözeceği soru

Köleliğin kaldırılmasından sonra milyonlarca Hintli işçiyi plantasyonlara taşıyan sözleşme sistemi rıza, borç, hareket ve ceza koşullarını nasıl yeniden düzenledi?

## Korpusa benzersiz katkısı

Kölelik ile özgür emek arasında keskin bir kopuş varsaymaz; işe alım köyü, gemi, plantasyon ve dönüş seçeneğini tek bir sözleşmenin farklı güç ilişkileri olarak okur.
...
İşçi sözleşmeleri, göçmen listeleri, koruyucu raporları, plantasyon ceza kayıtları, mektuplar ve sözlü tarih arşivleri.
