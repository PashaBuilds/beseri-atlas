# Üretim paketi — Küreselleşme ne zaman başladı?

**Kimlik:** `tartisma-kuresellesme-ne-zaman-basladi`
**Gelecek rota:** `okyanuslar-dunyayi-nasil-bagladi` · 6/6
**Bölge / eksen:** kuresel · ekonomik, kulturel, siyasi, demografik
**Anlatı biçimi:** `olcek-catismasi`

## Makalenin çözeceği soru

Küreselleşmenin başlangıcı 1492, 1571, 1820, 1956 ya da 1990 olarak seçildiğinde hangi bağlantı türü ölçülmüş, hangisi dışarıda bırakılmış olur?

## Korpusa benzersiz katkısı

Tek başlangıç tarihi vermek yerine ticaret hacmi, fiyat yakınsaması, biyolojik değişim, iletişim ve siyasal kurumlar için ayrı eşikler kurar.
...
Uzun dönem ticaret ve fiyat serileri, gemi kayıtları ve küresel kurum belgeleri.
